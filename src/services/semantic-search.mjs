...
const SYNONYMES = {
  ...
  'augmenté': [{ terme: 'augmentation', poids: 4 }, { terme: 'hausse', poids: 3 }],
  ...
  'pas payé': [{ terme: 'salaire impayé', poids: 5 }, { terme: 'retard', poids: 2 }],
  ...
  'prescription': [{ terme: 'prescription', poids: 5 }, { terme: 'délai', poids: 2 }],
