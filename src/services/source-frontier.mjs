...
const SOURCE_CATALOG = {
  ...
  entscheidsuche: {
    id: 'entscheidsuche',
    name: 'entscheidsuche.ch — agrégateur libre de jurisprudence suisse',
    type: 'jurisprudence_agregateur',
    tier: 2,
    url: 'https://entscheidsuche.ch',
    api_doc: 'https://entscheidsuche.ch/pdf/EntscheidsucheAPI.pdf',
    format: 'JSON API (Elasticsearch-like)',
    coverage: 'national + cantonal',
    total_estimated: 800000,
    domaines: ['bail', 'travail', 'dettes', 'famille', 'etrangers'],
    freshness: 'quasi temps réel',
    ingestion_strategy: 'adaptateur caselaw/provider-entscheidsuche.mjs (mode mock+live)',
    our_status: 'adapter_ready_mock_tested_live_pending_credentials',
    priority: 'stratégique',
    notes: 'Projet open source à but non lucratif, partenariat upstream souhaitable.'
  },
  opencaselaw: {
    id: 'opencaselaw',
    name: 'OpenCaseLaw (opencaselaw.ch)',
    type: 'jurisprudence_agregateur',
    tier: 2,
    url: 'https://opencaselaw.ch',
    github: 'https://github.com/jonashertner/caselaw-repo-1',
    format: 'REST API + MCP',
    coverage: '26 cantons + fédéral',
    total_claimed: 965000,
    freshness: 'daily updates',
    domaines: ['tous'],
    ingestion_strategy: 'adaptateur caselaw/provider-opencaselaw.mjs (mode mock+live)',
    our_status: 'adapter_ready_mock_tested_live_pending_credentials',
    priority: 'stratégique — source majeure pour complétude cantonale',
    notes: 'Corpus annoncé le plus exhaustif. À confirmer API + partenariat.'
  },
  justitia_swiss: {
    id: 'justitia_swiss',
    name: 'Justitia.swiss (transition numérique judiciaire)',
    type: 'plateforme_institutionnelle',
    tier: 1,
    url: 'https://justitia.swiss',
    format: 'à venir — structure nationale',
    coverage: 'national (visé)',
    freshness: 'à venir',
    domaines: ['tous'],
    ingestion_strategy: 'partenariat institutionnel dès disponibilité',
    our_status: 'monitoring',
    priority: 'long terme — potentielle source canonique officielle'
  },
  geneve_digital_justice: {
    id: 'geneve_digital_justice',
    name: 'Genève — transition numérique de la justice',
    type: 'plateforme_cantonale',
    tier: 1,
    url: 'https://justice.ge.ch/en/content/digital-transition-justice-system',
    format: 'à venir',
    coverage: 'cantonal GE',
    freshness: 'à venir',
    domaines: ['tous'],
    ingestion_strategy: 'partenariat cantonal direct',
    our_status: 'watch',
    priority: 'moyen terme — pilote cantonal de référence'
  },
  directives_ofas: {
    id: 'directives_ofas',
  ...
  csp_vaud_sejour: {
    id: 'csp_vaud_sejour',
    name: 'CSP Vaud — Autorisations de séjour (guide détaillé)',
    type: 'vulgarisation_service_social',
    tier: 3,
    ...
    domaines: ['etrangers'],
    freshness: 'mise à jour annuelle',
    ingestion_strategy: 'Guide détaillé autorisations de séjour, regroupement familial, procédures.',
    our_status: 'not_mapped',
    acces: 'mixte',
    public_cible: 'personnes migrantes',
    type_source: 'service spécialisé',
    gap: 'guide détaillé séjour non indexé',
    note_acces: 'Guide plus détaillé, partiellement payant',
  },
  f_information: {
    id: 'f_information',
  ...
  procap: {
    id: 'procap',
    name: 'Procap — Conseil juridique handicap',
    type: 'vulgarisation_faitiere',
    tier: 3,
    url: 'https://www.procap.ch/fr/prestations/conseil-juridique.html',
    format: 'HTML + PDF',
    coverage: 'national',
    domaines: ['assurances', 'famille'],
    freshness: 'mise à jour annuelle',
    ingestion_strategy: 'Guides: AI, enfants avec handicap, retraite, curatelle, vie à domicile.',
    our_status: 'not_mapped',
    acces: 'public',
    public_cible: 'personnes handicapées',
    type_source: 'faîtière',
    gap: 'AI et curatelle non couverts en détail',
  },
