...
export const ADVERSARIAL_CASES = [
  ...
  // BAIL — CO 262 al.2 : refus sous-location limité à 3 motifs exhaustifs
  {
    id: 'adv_bail_47',
    query: "Je veux sous-louer mon appartement à Lausanne pendant 4 mois car je pars travailler à l'étranger. J'ai informé mon bailleur par écrit en donnant le nom du sous-locataire, la durée et le loyer prévu (identique au mien). Il m'a répondu par lettre que sa 'politique générale' est d'interdire toute sous-location dans l'immeuble et que je ne peux donc pas sous-louer. A-t-il le droit ?",
    canton: 'VD',
    expected_domaine: 'bail',
    expected_any_article: ['CO 262'],
    notes: "Droit à la sous-location — CO 262 al. 1 : le locataire peut sous-louer tout ou partie de la chose louée avec le consentement du bailleur. CO 262 al. 2 : le bailleur ne peut REFUSER que pour 3 motifs EXHAUSTIFS : a) le locataire refuse de communiquer les conditions de la sous-location ; b) les conditions de la sous-location sont abusives par rapport au bail principal ; c) la sous-location présente des inconvénients majeurs pour le bailleur. CO 262 al. 3 : si le bailleur refuse sans motif légal, le locataire peut saisir la commission de conciliation. CONSÉQUENCE : une 'politique générale' d'interdiction de sous-location n'est PAS un motif légal de refus. Les 3 motifs sont limitatifs. PROCÉDURE : contester le refus devant la commission de conciliation. LIMITE : durée maximale de sous-location = durée totale du bail ; loyer sous-location ≤ loyer + charges. MYTHE : 'le bailleur peut interdire toute sous-location par une clause générale ou une politique interne'. CO 262 ne laisse que 3 motifs limitatifs — une clause d'interdiction générale ou une politique interne est inopposable. '4 mois + étranger + même loyer + politique interdisant toute sous-location + VD ?' sans 'CO 262 al. 2 : 3 motifs exhaustifs seulement' ni 'refus sans motif légal = commission de conciliation'. Signal adversarial = locataire croit que le bailleur peut interdire la sous-location discrétionnairement.",
  },

  // TRAVAIL — CO 332 : inventions « semi-libres » sur temps libre dans le domaine de l'employeur
  {
    id: 'adv_travail_47',
    query: "Je suis ingénieur logiciel dans une startup spécialisée en IA médicale. Sur mon temps libre le week-end, j'ai développé un algorithme de diagnostic d'imagerie médicale que je pense brevetable. Mon employeur m'a envoyé un email disant qu'il revendique la propriété de cette invention car elle tombe dans notre domaine d'activité. A-t-il raison ? L'invention est vraiment faite sur mon temps personnel avec mes propres ressources.",
    canton: 'ZH',
    expected_domaine: 'travail',
    expected_any_article: ['CO 332'],
    notes: "Inventions de service et inventions semi-libres — CO 332 al. 1 : appartiennent à l'employeur les inventions faites dans l'exercice de l'activité au service de l'employeur et conformément aux obligations contractuelles. CO 332 al. 2 : les inventions faites HORS de l'exécution des obligations contractuelles mais dans le DOMAINE d'activité de l'employeur appartiennent au travailleur — MAIS il doit NOTIFIER l'employeur par écrit sans délai. CO 332 al. 3 : l'employeur a 6 mois après notification pour acquérir l'invention, moyennant une équitable rémunération. CONSÉQUENCE : une invention sur temps libre dans le domaine de l'employeur = invention 'semi-libre'. Elle appartient initialement au travailleur MAIS il doit notifier l'employeur, qui peut l'acquérir dans les 6 mois. L'employeur NE peut PAS simplement revendiquer sans offrir de rémunération équitable. MYTHE : 'tout ce que je fais hors du temps de travail m'appartient entièrement'. CO 332 al. 2 crée une obligation de notification même pour les inventions sur temps libre si elles touchent le domaine d'activité. 'Algorithme IA médicale + temps libre + ressources personnelles + ZH ?' sans 'CO 332 al. 2 : obligation de notification même sur temps libre dans le domaine de l'employeur' ni 'CO 332 al. 3 : 6 mois pour rachat moyennant rémunération équitable'. Signal adversarial = travailleur croit être propriétaire absolu de ses créations hors temps de travail.",
  },

  // DETTES — LP 278/279 : caducité du séquestre faute de poursuivre dans les 10 jours
  {
    id: 'adv_dettes_43',
    query: "J'ai obtenu un séquestre sur le compte bancaire de mon débiteur il y a 3 semaines à Genève pour une créance de 80'000 CHF. Le débiteur n'a pas fait opposition au séquestre. Mon avocat m'a dit qu'on a 'tout le temps' car le séquestre est en place. Mais j'ai entendu qu'il y avait une limite de temps pour agir — est-ce vrai ?",
    canton: 'GE',
    expected_domaine: 'dettes',
    expected_any_article: ['LP 278', 'LP 279'],
    notes: "Caducité du séquestre — LP 278 al. 1 : le créancier séquestrant doit, dans les 10 JOURS à compter de la notification du procès-verbal de séquestre, requérir la poursuite ou intenter une action civile, sous peine de caducité du séquestre. LP 278 al. 2 : si le débiteur fait opposition, le créancier doit introduire la mainlevée ou une action en validation dans un délai supplémentaire de 20 jours. LP 279 : même si le débiteur est à l'étranger, les délais courent de la même façon. CONSÉQUENCE : 3 semaines écoulées sans poursuivre = séquestre CADUC si le délai de 10 jours est dépassé. Même sans opposition du débiteur, le créancier DOIT agir dans les 10 jours. URGENCE : si délai dépassé, le séquestre est nul de plein droit — il faut solliciter une nouvelle ordonnance de séquestre. MYTHE : 'un séquestre accordé reste valable indéfiniment si le débiteur ne fait pas opposition'. LP 278 impose un délai de 10 jours au créancier pour introduire la poursuite ou l'action. '80'000 CHF + 3 semaines + pas d'opposition + GE ?' sans 'LP 278 : délai 10 jours pour requérir la poursuite sous peine de caducité' ni 'séquestre caduc si délai dépassé sans action'. Signal adversarial = créancier croit que l'absence d'opposition du débiteur le dispense d'agir rapidement.",
  },

  // FAMILLE — CC 133/298 : garde alternée ordonnée par le juge même sans accord et même à distance
  {
    id: 'adv_famille_42',
    query: "Je me sépare de mon partenaire à Berne. Nous avons une fille de 6 ans. Mon ex-partenaire habite à 15 km de chez moi et refuse catégoriquement la garde alternée — il veut la garde exclusive et m'accorder seulement un droit de visite le week-end. Mon avocat dit que sans accord des deux parents, le juge ne peut pas ordonner la garde alternée. Est-ce vrai ?",
    canton: 'BE',
    expected_domaine: 'famille',
    expected_any_article: ['CC 133', 'CC 298'],
    notes: "Garde alternée imposée par le juge depuis la réforme 2017 — CC 133 al. 1 (depuis 01.01.2017) : le juge règle les droits et devoirs des père et mère selon les dispositions régissant les effets de la filiation. CC 298 al. 2bis (depuis 2017) : si un parent demande l'autorité parentale conjointe, le juge instaure une garde alternée si cela est dans l'intérêt de l'enfant — MÊME sans accord de l'autre parent. ATF 142 III 617 : le TF a validé des gardes alternées avec des distances significatives. CRITÈRES : bien-être de l'enfant, capacité de coopération des parents, stabilité des lieux de vie — la distance ou l'accord des parents ne sont PAS des conditions sine qua non. MYTHE : 'la garde alternée est impossible si les parents ne sont pas d'accord ou s'ils habitent à plus de quelques kilomètres'. Depuis CC 298 al. 2bis (réforme 2017), le juge peut ordonner la garde alternée même contre la volonté d'un parent si c'est dans l'intérêt de l'enfant. '15 km + refus du partenaire + garde alternée + BE ?' sans 'CC 298 al. 2bis : garde alternée possible sans accord depuis 2017' ni 'distance de 15 km non dirimante selon la jurisprudence TF'. Signal adversarial = parent croit que l'accord des deux est une condition nécessaire à la garde alternée.",
  },

  // ÉTRANGERS — LEI 53 al.4 / CEDH 8 : protection renforcée pour étrangers de la 2e génération
  {
    id: 'adv_etrangers_36',
    query: "Mon frère est né en Suisse il y a 28 ans de parents étrangers. Il a un permis C. Il a été condamné à 18 mois de prison ferme pour trafic de drogues. L'autorité cantonale genevoise a révoqué son permis C et prononcé son expulsion vers le pays d'origine qu'il ne connaît pas — il n'y a jamais vécu. Est-il possible de contester cette expulsion ?",
    canton: 'GE',
    expected_domaine: 'etrangers',
    expected_any_article: ['LEI 53'],
    notes: "Protection renforcée contre expulsion pour étrangers de la 2e génération — LEI 53 al. 4 : une autorisation peut être révoquée si l'étranger met gravement en danger la sécurité et l'ordre publics — MAIS seulement dans une mesure proportionnée. CEDH 8 (vie privée et familiale) : la Cour EDH et le TF exigent une pesée d'intérêts approfondie pour les étrangers nés ou ayant grandi en Suisse. ATF 139 I 31, ATF 146 I 185 : pour les étrangers de la 2e génération, l'expulsion n'est possible que si l'intérêt public à l'expulsion l'emporte de manière importante sur l'intérêt privé, en tenant compte de : durée de séjour, liens familiaux en Suisse, connaissance du pays d'expulsion, réinsertion possible. 18 mois de prison ferme = grave, mais pas automatiquement suffisant pour expulser quelqu'un né en Suisse n'ayant jamais vécu dans son pays d'origine. RECOURS : recours au Tribunal administratif cantonal, puis TF en droit public. MYTHE : 'toute infraction grave entraîne automatiquement l'expulsion de n'importe quel étranger, même né en Suisse'. LEI 53 al. 4 + CEDH 8 + jurisprudence TF imposent une pesée d'intérêts renforcée pour les étrangers de la 2e génération. 'Né en Suisse + 28 ans + permis C + 18 mois prison + expulsion + GE ?' sans 'CEDH 8 + ATF 146 I 185 : pesée d'intérêts renforcée pour étranger 2e génération' ni 'protection si jamais vécu dans le pays d'origine'. Signal adversarial = famille croit que la condamnation rend l'expulsion incontestable.",
  },

  // SUCCESSIONS — CC 566/570 : immixtion dans la succession = acceptation tacite avec toutes les dettes
  {
    id: 'adv_successions_25',
    query: "Mon père est décédé il y a 3 semaines à Lausanne, laissant des dettes importantes (environ 150'000 CHF). Je n'ai pas encore décidé si j'accepte ou renonce à la succession. Mais j'ai déjà vidé son appartement avec mes frères, récupéré sa voiture dans le garage, et résilié son bail au nom de la famille. Mon notaire me dit que j'aurais 'tout le temps' pour décider. Est-ce que ces actes peuvent me faire considérer comme ayant accepté la succession ?",
    canton: 'VD',
    expected_domaine: 'successions',
    expected_any_article: ['CC 566', 'CC 570'],
    notes: "Acceptation tacite par immixtion — CC 566 al. 1 : les héritiers ont le droit de répudier la succession dans un délai de 3 mois. CC 570 al. 1 : l'héritier qui s'est immiscé dans la gestion des biens successoraux, qui a soustrait ou recélé des biens de la succession est PRIVÉ DU DROIT DE RÉPUDIER. CC 570 al. 2 : est réputé immixtion : résilier des contrats au nom de la succession, vider des locaux, prendre possession de biens mobiliers. CONSÉQUENCE : vider l'appartement + prendre la voiture + résilier le bail = immixtion caractérisée. Ces actes privent l'héritier de son droit de répudier → il est réputé avoir ACCEPTÉ la succession avec TOUTES les dettes (150'000 CHF). EXCEPTION : actes conservatoires urgents (acquitter une facture urgente, maintenir une assurance) ne constituent pas une immixtion. INVENTAIRE BÉNÉFICIAIRE : recours possible via CC 580 ss. pour limiter la responsabilité aux actifs successoraux — délai 1 mois. MYTHE : 'sans signature formelle d'acceptation, on peut encore décider de renoncer à la succession même si on a géré des affaires'. CC 570 : certains actes de gestion constituent une acceptation TACITE irrévocable — vider l'appartement, résilier le bail, prendre la voiture entrent dans cette catégorie. 'Dettes 150'000 CHF + appartement vidé + bail résilié + voiture prise + 3 semaines + VD ?' sans 'CC 570 : immixtion = acceptation tacite, perte du droit de répudier' ni 'inventaire bénéficiaire CC 580 dans le délai de 1 mois'. Signal adversarial = héritier croit qu'agir physiquement n'engage pas juridiquement.",
  },

  // ASSURANCES — LAA 7/OLAA 13 : ANP couverte dès 8h/sem chez le même employeur
  {
    id: 'adv_assurances_25',
    query: "Je travaille à 30% pour une PME à Zurich, soit environ 12 heures par semaine. Je me suis blessé en faisant du ski pendant mes vacances — fracture du poignet. Mon employeur me dit que la SUVA ne couvre que les accidents au travail pour les temps partiels comme moi et que mon accident de ski n'est pas couvert. Est-ce vrai ?",
    canton: 'ZH',
    expected_domaine: 'assurances',
    expected_any_article: ['LAA 7', 'LAMal 1a'],
    notes: "Couverture ANP (accidents non professionnels) et seuil 8 heures — LAA 7 al. 1 : sont couverts par l'assurance accidents non professionnels (ANP) les travailleurs occupés en moyenne au moins 8 heures par semaine chez le même employeur. CONSÉQUENCE : 12 heures/semaine > 8 heures → L'ANP est couverte par la SUVA. L'employeur a TORT. La fracture de ski EST couverte. LIMITE : si le travailleur travaillait MOINS de 8h/sem chez le même employeur, l'ANP ne serait PAS couverte → la LAMal prendrait le relais pour les soins médicaux (mais sans indemnités journalières LAA). INDEMNITÉS JOURNALIÈRES LAA : 80% du salaire assuré dès le 3e jour d'incapacité. PROCÉDURE : annoncer le sinistre à l'employeur dans les 24h, l'employeur déclare à la SUVA. MYTHE : 'à temps partiel en Suisse, la SUVA ne couvre que les accidents au travail, pas les loisirs'. LAA 7 : l'ANP est couverte dès 8h/semaine chez le même employeur. Avec 12h/sem, les accidents de vacances et de sport sont couverts. '30% + 12h/sem + fracture ski + ZH ?' sans 'LAA 7 al. 1 : ANP couverte si ≥ 8h/sem chez le même employeur' ni '12h/sem > 8h = couverture ski confirmée'. Signal adversarial = travailleur à temps partiel croit que sa couverture SUVA est limitée aux seuls accidents de travail.",
  },

  // CONSOMMATION — CO 40a : pas de droit de rétractation légal pour achat en magasin physique
  {
    id: 'adv_consommation_25',
    query: "J'ai acheté une télévision 1'200 CHF dans un grand magasin à Genève il y a 5 jours. Elle fonctionne bien mais je regrette mon achat — j'en ai trouvé une moins chère ailleurs. Le vendeur me dit qu'il n'y a aucun droit de retour sauf si la TV est défectueuse. J'ai cru comprendre qu'en Suisse on avait 14 jours de rétractation comme en Europe. N'ai-je pas le droit de la rendre ?",
    canton: 'GE',
    expected_domaine: 'consommation',
    expected_any_article: ['CO 40a'],
    notes: "Absence de droit légal de rétractation pour achat en magasin physique — CO 40a al. 1 : le droit de révocation s'applique aux contrats conclus à distance (internet, téléphone, vente par correspondance) et aux contrats conclus hors des locaux commerciaux (démarchage, foire, domicile). CONSÉQUENCE : pour les achats en MAGASIN PHYSIQUE en Suisse, il n'existe PAS de droit légal de rétractation si l'article est conforme. Le vendeur a raison. DIFFÉRENCE UE vs CH : la Directive européenne 2011/83/UE impose 14 jours de rétractation dans certains contextes — la Suisse N'applique PAS cette directive. En Suisse, CO 40a s'applique seulement aux contrats à distance et hors locaux commerciaux. RECOURS : vérifier si le magasin a une POLITIQUE COMMERCIALE de retour (souvent 30 jours, mais c'est contractuel et volontaire). EXCEPTION LÉGALE : garantie légale CO 197 ss. pour vices cachés — mais seulement si la TV est défectueuse. MYTHE : 'en Suisse on a 14 jours pour changer d'avis sur tout achat, comme dans l'UE'. CO 40a limite le droit de rétractation aux achats à distance et hors locaux commerciaux — pas aux achats en magasin physique. 'Télévision + magasin physique + 5 jours + aucun défaut + GE ?' sans 'CO 40a : droit de rétractation limité aux contrats à distance / hors locaux commerciaux' ni 'pas de droit légal de retour pour achat en magasin si produit conforme'. Signal adversarial = consommateur confond droit suisse et droit UE.",
  },

  // ASSURANCES — LACI 13 : délai de cotisation minimum 12 mois pour indemnités chômage
  {
    id: 'adv_assurances_26',
    query: "Je viens d'être licencié après 9 mois de travail dans une entreprise à Zurich. C'est mon premier emploi en Suisse — je suis arrivé il y a 10 mois. Mon employeur a cotisé pour moi à l'AVS et à l'assurance chômage. J'ai demandé des indemnités de chômage à l'ORP et on m'a dit que je n'y avais pas droit. Comment est-ce possible si j'ai bien cotisé ?",
    canton: 'ZH',
    expected_domaine: 'assurances',
    expected_any_article: ['LACI 13'],
    notes: "Délai de cotisation minimal pour droit aux indemnités de chômage — LACI 13 al. 1 : a droit aux indemnités de chômage l'assuré qui, dans les 2 ans qui précèdent l'annonce au chômage, a exercé une activité soumise à cotisation pendant 12 MOIS AU MOINS. CONSÉQUENCE : 9 mois de cotisation < 12 mois minimum → aucun droit aux indemnités LACI. L'ORP a raison. ALTERNATIVES : aide sociale cantonale (en dernier recours), ou poursuivre la recherche d'emploi. PÉRIODE DE RÉFÉRENCE : les 24 mois précédant l'inscription. BILATÉRALE : si le pays d'origine est membre UE/AELE, les périodes de cotisation étrangères peuvent être additionnées via le formulaire U1 (anciennement E301). MYTHE : 'tout employé ayant cotisé à l'assurance chômage en Suisse a automatiquement droit aux indemnités en cas de licenciement'. LACI 13 impose 12 mois minimum de cotisation dans les 24 derniers mois. 9 mois ne suffisent pas. '9 mois cotisés + premier emploi + licencié + ZH ?' sans 'LACI 13 : 12 mois minimum requis dans les 24 derniers mois' ni 'possibilité de totaliser avec périodes UE/AELE via formulaire U1'. Signal adversarial = travailleur croit que cotiser suffit pour avoir droit aux indemnités quelle que soit la durée.",
  },

  // ENTREPRISE — CO 620/CO 697j : suppression des actions au porteur depuis 01.11.2019
  {
    id: 'adv_entreprise_24',
    query: "J'ai fondé une SA familiale à Zurich en 2005 avec des actions au porteur pour préserver la confidentialité sur les actionnaires. J'ai 1'000 actions au porteur. Mon fiduciaire m'a récemment dit que mes actions seraient 'problématiques'. De quoi s'agit-il ? Mes actions au porteur dans une SA suisse sont-elles toujours valides ?",
    canton: 'ZH',
    expected_domaine: 'entreprise',
    expected_any_article: ['CO 620', 'CO 651'],
    notes: "Suppression des actions au porteur depuis 01.11.2019 — Loi fédérale sur la mise en œuvre des recommandations du GAFI (Groupe d'action financière) : depuis le 01.11.2019, les SA suisses ne peuvent plus émettre des ACTIONS AU PORTEUR (sauf si cotées en bourse). CO 622 al. 1 révisé : les actions doivent être des actions nominatives. CO 697j (nouveau) : les sociétés devaient convertir leurs actions au porteur existantes en actions nominatives avant le 01.05.2021. CONSÉQUENCE : actions au porteur émises avant 2019 devaient être converties avant le 01.05.2021. Si non converties, elles ont perdu leur validité et les droits (dividendes, vote) sont suspendus. SANCTION : une société qui maintient des actions au porteur risque des sanctions pénales (CO 697m) pour violation des obligations de transparence. DÉMARCHE : modifier les statuts SA → assemblée générale extraordinaire → inscription au RC → conversion en actions nominatives inscrites au registre des actions. MYTHE : 'mes actions au porteur dans une SA familiale suisse sont toujours valables car elles ont été créées légalement avant 2019'. La réforme GAFI-CH de 2019 a supprimé les actions au porteur pour toutes les SA non cotées, avec obligation de conversion. Actions non converties = droits suspendus. 'Actions au porteur + SA familiale + 2005 + ZH ?' sans 'Loi GAFI-CH 2019 : actions au porteur supprimées depuis 01.11.2019' ni 'obligation de conversion en nominatives, sinon droits suspendus'. Signal adversarial = actionnaire SA croit que les actions émises légalement avant la loi restent valables.",
  },
  ...
  // BAIL — CO 258/259a : défauts à la remise des clés — droit de refus et options du locataire
  {
    id: 'adv_bail_48',
    query: "Je viens de prendre les clés de mon nouvel appartement à Lausanne. En faisant le tour avec le bailleur, j'ai découvert que la chaudière ne fonctionne pas, qu'il y a des traces d'humidité importantes dans la salle de bain et que les volets de la chambre principale sont cassés. Le bailleur me dit que je dois signer l'état des lieux 'sous réserve' et qu'il arrangera tout dans les semaines qui viennent. Est-ce que je suis obligé d'accepter le logement dans cet état et d'attendre ?",
    canton: 'VD',
    expected_domaine: 'bail',
    expected_any_article: ['CO 258', 'CO 259a'],
    notes: "Défauts à la remise et droits du locataire — CO 258 al. 1 : si la chose louée n'est pas remise au locataire dans l'état convenu ou dans un état propre à l'usage pour lequel elle est louée, le locataire peut refuser de la prendre en possession et agir selon les règles sur la demeure du bailleur. CO 258 al. 2 : si les défauts sont moins graves, le locataire peut prendre possession de la chose louée et exiger, selon CO 259a, la remise en état. CO 259a : recours du locataire en cas de défauts (réduction de loyer, réparation aux frais du bailleur si bailleur en demeure, résiliation si défauts graves). DISTINCTION : défaut grave (chaudière en panne = logement inhabitable) → refus de prise de possession possible OU délai de réparation immédiat CO 259b. PROCÉDURE : documenter les défauts dans l'état des lieux (ne pas signer 'sans réserve'), envoyer lettre recommandée fixant délai de réparation. MYTHE : 'une fois les clés acceptées avec état des lieux signé, on ne peut plus exiger de réparations immédiatement'. CO 258 : le locataire qui prend possession en présence de défauts peut encore agir, à condition d'avoir documenté les défauts dans l'état des lieux et d'avoir signalé sans délai. Signer 'sans réserve' est risqué. 'Chaudière en panne + humidité + volets cassés + clés remises + VD ?' sans 'CO 258 : refus de prise de possession possible si défauts graves' ni 'CO 259a : exiger réparation immédiate avec délai, réduction de loyer en attendant'. Signal adversarial = locataire croit que recevoir les clés l'oblige à patienter sans recours immédiat.",
  },

  // TRAVAIL — CO 321c / CO 362 : nullité des clauses salariales forfaitaires couvrant un nombre illimité d'heures supplémentaires
  {
    id: 'adv_travail_48',
    query: "Mon contrat de travail à Zurich stipule que 'toutes les heures supplémentaires sont incluses dans le salaire mensuel brut de 7'500 CHF'. Mon employeur me demande régulièrement de travailler 50 à 55 heures par semaine, soit 10 à 15 heures supplémentaires par semaine. Il me dit que j'ai signé cette clause et que je ne peux rien réclamer. Est-ce que cette clause est vraiment légalement valable ?",
    canton: 'ZH',
    expected_domaine: 'travail',
    expected_any_article: ['CO 321c', 'CO 362'],
    notes: "Clause 'all-inclusive' et droit impératif — CO 321c al. 3 : à défaut de compensation par un congé, les heures supplémentaires sont rémunérées avec un supplément de 25%, sauf convention écrite contraire. CO 362 al. 1 : les dispositions CO 321c sont impératives — il est interdit d'y déroger au détriment du travailleur par contrat individuel. LIMITE : une clause 'toutes heures supplémentaires incluses' est nulle si elle couvre un nombre indéterminé et excessif d'heures. ATF 141 III 407 : le TF a précisé qu'une clause all-inclusive ne peut pas être valable si le nombre d'heures n'est pas suffisamment défini ou si le salaire est manifestement disproportionné par rapport aux heures attendues. CALCUL : pour être valable, la clause doit nommer un nombre maximal d'heures ou être proportionnée au salaire. 10-15h/sem supplémentaires sans compensation = clause potentiellement nulle. RECOURS : action en paiement devant le Tribunal du travail, prescription CO 128 ch. 3 : 5 ans. MYTHE : 'j'ai signé un contrat avec une clause all-inclusive donc mes heures supplémentaires ne sont jamais compensables'. CO 362 rend nulle toute clause défavorisant le travailleur sur un point impératif. Une clause couvrant un nombre indéterminé et excessif d'heures peut être annulée. '55h/sem + clause all-inclusive + 7'500 CHF + ZH ?' sans 'CO 362 : impérativité CO 321c, clause nulle si disproportionnée' ni 'ATF 141 III 407 : nombre d'heures maximal requis pour validité clause'. Signal adversarial = travailleur croit qu'une clause signée est toujours définitive même si elle viole le droit impératif.",
  },

  // DETTES — LP 82 : mainlevée provisoire sur reconnaissance de dette — pas besoin d'un jugement au fond
  {
    id: 'adv_dettes_44',
    query: "J'ai prêté 8'000 CHF à un ami à Lausanne, qui refuse de rembourser. J'ai une reconnaissance de dette signée par lui, datée et mentionnant le montant exact. Mon avocat me parle de 'mainlevée provisoire' mais ajoute que si l'ami s'oppose, il faudra aller en procès au fond. Je croyais qu'avec une reconnaissance de dette signée, je pouvais être directement payé sans procès. Comment ça fonctionne concrètement ?",
    canton: 'VD',
    expected_domaine: 'dettes',
    expected_any_article: ['LP 80', 'LP 82'],
    notes: "Mainlevée provisoire et définitive — LP 82 al. 1 : si la poursuite est fondée sur une reconnaissance de dette établie par acte sous seing privé, le juge des poursuites prononce la mainlevée provisoire. LP 82 al. 2 : le débiteur peut faire échec à la mainlevée provisoire en apportant une exception de paiement, de compensation ou de prescription — mais il doit la prouver immédiatement. LP 83 al. 2 : après mainlevée provisoire, le débiteur a 20 jours pour intenter une action en libération de dette. Si cette action n'est pas intentée → la mainlevée provisoire devient définitive sans procès. LP 80 al. 1 : la mainlevée DÉFINITIVE nécessite un jugement exécutoire. CONSÉQUENCE PRATIQUE : dans la majorité des cas avec une reconnaissance de dette valable, la mainlevée provisoire suffit — si l'ami ne réagit pas dans les 20 jours, le créancier peut procéder à la saisie. MYTHE : 'pour recouvrer une créance, il faut forcément un jugement au fond, même avec une reconnaissance de dette signée'. LP 82 : la reconnaissance de dette sous seing privé ouvre la voie de la mainlevée provisoire qui devient définitive sans procès si le débiteur reste passif. '8'000 CHF + reconnaissance de dette signée + VD ?' sans 'LP 82 : mainlevée provisoire sur titre de dette privé' ni 'LP 83 al. 2 : délai 20 jours action en libération de dette, sans action = mainlevée définitive'. Signal adversarial = créancier croit qu'une reconnaissance de dette n'évite pas forcément un procès au fond.",
  },

  // FAMILLE — CC 176/177 : mesures protectrices de l'union conjugale — contribution d'entretien urgente sans attendre le divorce
  {
    id: 'adv_famille_43',
    query: "Mon mari est parti du domicile conjugal il y a 3 semaines à Fribourg. Il ne me verse plus rien pour l'entretien de nos deux enfants (6 et 9 ans) et pour moi. J'ai arrêté de travailler il y a 7 ans pour m'occuper d'eux. Mon avocat parle de divorce, mais m'a dit que la procédure prendrait au minimum 6 à 12 mois. D'ici là, je n'ai aucun revenu. Existe-t-il un moyen d'obtenir une contribution d'entretien en urgence, avant le jugement de divorce ?",
    canton: 'FR',
    expected_domaine: 'famille',
    expected_any_article: ['CC 176', 'CC 177'],
    notes: "Mesures protectrices de l'union conjugale (MPUC) — CC 176 al. 1 : dès que la vie commune est suspendue de fait ou demandée, le juge compétent prend les mesures nécessaires et notamment fixe les contributions d'entretien dues à l'époux et aux enfants. CPC 271 : les MPUC sont prononcées selon la procédure sommaire — délai d'audience en quelques semaines. CONTENU DES MPUC : entretien du conjoint, entretien des enfants (calcul selon lignes directrices cantonales), attribution du domicile conjugal, réglementation provisoire de la garde et de l'autorité parentale. URGENCE ABSOLUE : si danger immédiat (enfants sans nourriture, violence) → mesures super-provisionnelles CPC 265, prononcées sans délai (24-48h) sans audience contradictoire préalable. DÉLAI : dès la séparation factuelle, sans attendre le dépôt de requête de divorce. MYTHE : 'pour recevoir une pension alimentaire de mon mari, il faut attendre le jugement de divorce qui prend 6-12 mois'. Les MPUC (CC 176) permettent d'obtenir une contribution d'entretien en quelques semaines, indépendamment de toute procédure de divorce. 'Mari parti + 2 enfants + aucun revenu depuis 3 semaines + FR ?' sans 'CC 176 : mesures protectrices prononcées dès séparation de fait, en quelques semaines' ni 'CPC 265 : super-provisionnelles en 24h si urgence absolue'. Signal adversarial = épouse sans revenu croit devoir attendre le divorce pour obtenir une pension.",
  },

  // ÉTRANGERS — ALCP Annexe I art. 5 / LEI 11 : ressortissant UE travailleur indépendant < 90 jours — annonce, pas autorisation
  {
    id: 'adv_etrangers_37',
    query: "Je suis ressortissant français domicilié à Paris. Une start-up genevoise veut m'engager comme consultant indépendant pour 3 mois (juin-août). Elle me dit que je peux travailler en Suisse sans permis de travail jusqu'à 90 jours par année civile. Mon comptable me dit au contraire que tout travail en Suisse nécessite un permis, même pour une courte durée. Qui a raison ? Dois-je demander un permis avant de commencer ?",
    canton: 'GE',
    expected_domaine: 'etrangers',
    expected_any_article: ['LEI 11', 'LEI 1a'],
    notes: "Séjour de courte durée UE/AELE sans autorisation de travail — ALCP Annexe I art. 5 al. 1 : les ressortissants d'une partie contractante ont le droit de séjourner pour exercer une activité économique dans l'autre partie contractante pour une durée maximale de 90 jours par année civile sans nécessiter d'autorisation de séjour. LEI 11 al. 1 + art. 6 al. 2 OASA : les ressortissants UE/AELE peuvent entrer et séjourner 90 jours sans autorisation formelle. OBLIGATION D'ANNONCE : pour les prestataires de services actifs plus de 8 jours par année civile dans le même domaine, une annonce préalable est obligatoire — via le système SWIPO (annonce au service cantonal compétent, au moins 8 jours avant le début). L'annonce n'est pas une autorisation : c'est une notification administrative. CONSÉQUENCE : la start-up a raison sur le principe (pas de permis requis jusqu'à 90j). Le comptable a tort sur la règle, mais peut avoir raison sur l'obligation d'annonce. MYTHE : 'tout travail en Suisse, même de courte durée, nécessite un permis de travail formel, même pour un citoyen UE'. ALCP Annexe I : ressortissants UE peuvent prester jusqu'à 90j/an sans autorisation, mais avec obligation d'annonce préalable. 'Consultant indépendant français + 3 mois GE + UE/ALCP ?' sans 'ALCP Annexe I art. 5 : séjour prestataire ≤ 90j/an sans autorisation' ni 'obligation d'annonce SWIPO ≥ 8 jours avant démarrage'. Signal adversarial = prestataire UE confond obligation d'annonce et obligation d'autorisation.",
  },

  // SANTÉ — LAMal 41 al. 4 / OAMal 29 : modèles alternatifs d'assurance — libre choix valablement restreint par contrat
  {
    id: 'adv_sante_31',
    query: "J'ai choisi l'an dernier un modèle 'médecin de famille' chez ma caisse maladie vaudoise pour économiser 15% sur ma prime. J'ai maintenant des douleurs au genou et je veux directement consulter un orthopédiste sans passer par mon médecin de famille, qui a toujours du retard. Ma caisse me dit que je dois d'abord prendre rendez-vous avec mon médecin de famille qui m'adressera ensuite au spécialiste. Est-ce légal ? N'ai-je pas le droit de choisir librement mon médecin ?",
    canton: 'VD',
    expected_domaine: 'sante',
    expected_any_article: ['LAMal 25', 'LAMal 41'],
    notes: "Libre choix du médecin et modèles alternatifs — LAMal 41 al. 1 : les assurés ont le libre choix entre les fournisseurs de prestations admis dont la discipline médicale correspond à leurs besoins. LAMal 41 al. 4 : les assurés qui limitent contractuellement leur choix de fournisseurs de prestations bénéficient de réductions de primes. OAMal 29 : les assureurs peuvent proposer des modèles alternatifs (médecin de famille, HMO, télémédecine) avec gate-keeping obligatoire. Ces modèles sont légaux et LIMITENT le libre choix du spécialiste. CONSÉQUENCE : le contrat 'médecin de famille' signé par l'assuré est valide. La caisse a raison. Consulter l'orthopédiste directement = hors du modèle → non remboursé (sauf urgence). EXCEPTION : urgence médicale avérée → accès direct au spécialiste ou urgences, toujours remboursé. CHANGEMENT DE MODÈLE : possible en général au 31 décembre pour l'année suivante (préavis 3 mois). MYTHE : 'mon assureur ne peut pas restreindre mon droit au libre choix du médecin, c'est un droit fondamental'. LAMal 41 al. 4 permet aux assureurs de conditionner les remboursements à l'accord du médecin référent, si l'assuré a VOLONTAIREMENT choisi ce modèle avec réduction de prime. Le droit fondamental au libre choix vaut dans le modèle standard, pas dans le modèle alternatif librement consenti. 'Modèle médecin de famille + ortho direct + genou + VD ?' sans 'LAMal 41 al. 4 + OAMal 29 : modèle alternatif = restriction libre choix légale et contractuelle' ni 'exception urgence = accès direct remboursé'. Signal adversarial = assuré confond droit au libre choix (modèle standard) avec contrat alternatif qu'il a lui-même souscrit.",
  },

  // VOISINAGE — CC 688 / droit cantonal VD : distances pour plantations selon hauteur — le droit cantonal prime
  {
    id: 'adv_voisinage_30',
    query: "Mon voisin à Morges a planté une rangée de thuyas de 3 mètres de haut à seulement 40 cm de la limite de ma propriété il y a 2 ans. Ces arbres bloquent la lumière dans mon jardin. J'ai lu que la distance légale minimale pour les arbres en Suisse était d'1 mètre. Mon voisin me dit qu'il n'y a pas de règle pour les haies et les thuyas, et que la distance légale de 1 mètre ne s'applique qu'aux 'arbres'. Qui a raison ?",
    canton: 'VD',
    expected_domaine: 'voisinage',
    expected_any_article: ['CC 679', 'CC 688'],
    notes: "Distances légales pour plantations et droit cantonal — CC 688 al. 1 : les droits cantonaux fixent les distances à respecter pour les plantations, à défaut de règles dans le droit cantonal, les règles édictées par les usages locaux s'appliquent. VD — Code civil vaudois d'application (CcVD) Art. 91 : en VD, les distances minimales pour les végétaux varient selon leur HAUTEUR et leur type : hauteur >1m50 → distance = 1/2 hauteur, min. 1m depuis la limite ; plantes couvre-sol <50cm → 20cm. Thuyas de 3m → distance minimale = 1/2 × 3m = 1.5m depuis la limite. 40cm insuffisant même si c'est une 'haie'. RECOURS : lettre recommandée exigeant la taille ou le déplacement avec délai raisonnable, puis conciliation devant justice de paix de district, puis action en arrêt du trouble CC 679. DÉLAI pour arrêt de la croissance : prescription acquisitive ne s'applique pas aux empiètements en matière de plantations dans la jurisprudence vaudoise. MYTHE : 'les haies et thuyas ne sont pas des arbres donc aucune règle de distance ne s'applique'. CC 688 + CcVD Art. 91 : le droit vaudois fixe des distances selon la hauteur pour TOUTE plantation, y compris haies et conifères. 'Thuyas 3m + 40cm limite + Morges VD ?' sans 'CcVD Art. 91 : distance = 1/2 hauteur pour plantes >1m50 → 1.5m requis pour thuyas 3m' ni 'CC 688 renvoie au droit cantonal, pas une règle nationale uniforme'. Signal adversarial = propriétaire croit qu'une règle nationale unique de 1m s'applique ou que les haies sont exemptées.",
  },

  // ACCIDENT — LAA 72 / CO 46/47 : subrogation SUVA et cumul avec recours civil — prestations complémentaires
  {
    id: 'adv_accident_23',
    query: "J'ai eu un accident de voiture grave à Berne causé par un autre conducteur — 100% de sa faute établie. La SUVA paie mon traitement et mes indemnités journalières. Mon avocat veut aussi poursuivre le conducteur responsable pour le tort moral et le dommage matériel non couvert. Mais la SUVA m'a informé qu'elle allait elle aussi poursuivre le conducteur. Est-ce que les deux démarches sont compatibles ? Vais-je toucher deux fois la même chose ?",
    canton: 'BE',
    expected_domaine: 'accident',
    expected_any_article: ['LAA 72', 'CO 46'],
    notes: "Subrogation SUVA et recours civil complémentaire — LAA 72 al. 1 : si un accident est causé par un tiers, la SUVA est subrogée dans les droits de l'assuré contre ce tiers, dans la mesure des prestations fournies. PRINCIPE : la SUVA récupère ce qu'elle a payé (traitement + indemnités journalières) auprès du responsable. La VICTIME garde le droit de réclamer DIRECTEMENT au responsable : le dommage civil non couvert (la part LAA = 80% du salaire assuré, pas 100%), le tort moral CO 47 (souffrances physiques et psychiques), le dommage ménager, les frais supplémentaires non couverts. CUMUL INTERDIT : la victime ne peut pas recevoir deux fois la même prestation. La SUVA prend sa quote-part, la victime prend le surplus civil. RECOURS SUVA + RECOURS CIVIL : complémentaires, non redondants. MYTHE : 'si la SUVA paie, je n'ai plus de droit personnel contre le responsable, ou je risque de toucher deux fois'. LAA 72 : la subrogation SUVA est limitée aux prestations qu'elle a payées. La victime conserve ses droits civils pour les postes non couverts (tort moral, 20% perte de gain, etc.). 'Accident 100% faute tiers + SUVA paie + SUVA poursuit aussi + BE ?' sans 'LAA 72 : subrogation = SUVA récupère SES prestations seulement' ni 'CO 47 tort moral + CO 46 dommage résiduel = droits personnels conservés'. Signal adversarial = victime croit que la prise en charge SUVA absorbe tous ses droits contre le tiers responsable.",
  },

  // VIOLENCE — CP 180/181 : menaces et contrainte par voie électronique — constitutives d'infraction pénale
  {
    id: 'adv_violence_25',
    query: "Depuis 3 semaines, un inconnu m'envoie des messages privés menaçants sur Instagram à Genève : il dit 'tu vas payer pour ça', publie des photos de ma maison avec la légende 'je sais où tu habites', et m'envoie des montages me représentant en train d'être agressé. J'aimerais porter plainte mais plusieurs personnes me disent que les messages privés sur internet 'ne comptent pas' comme de vraies menaces et que la police ne s'en occupe pas. Est-ce vrai ?",
    canton: 'GE',
    expected_domaine: 'violence',
    expected_any_article: ['CP 180', 'CP 181'],
    notes: "Menaces par voie électronique — infraction réelle — CP 180 al. 1 : quiconque menace une personne d'un dommage grave et illicite de nature à l'alarmer ou à la mettre dans la crainte est puni d'une peine privative de liberté de 3 ans au plus — SANS CONDITION DE FORME (physique, électronique, par écrit). CP 181 : contrainte — quiconque, en usant de violence ou de menaces de dommages sérieux, entrave la liberté d'action d'une personne. JURISPRUDENCE TF : les messages électroniques (SMS, Instagram, Facebook Messenger) constituent des menaces au sens du CP si elles sont de nature à alarmer. ATF 141 IV 209 : une menace peut être faite par n'importe quel moyen de communication. PREUVE : capturer d'écran avec horodatage (ne pas supprimer), signaler le compte sur la plateforme pour conservation des preuves, se rendre au poste avec les captures. DÉLAI DE PLAINTE : CP 31 → 3 mois à compter de la connaissance de l'auteur (CP 180 = infraction poursuivable sur plainte). Si menaces à la vie → poursuite d'office (CP 180 al. 2). MYTHE : 'les messages privés sur internet ne constituent pas de vraies menaces pénales, la police ne s'en occupe pas'. CP 180 s'applique à tout moyen de communication. La jurisprudence est établie. Les brigades cybercriminalité cantonales traitent ces plaintes. 'Messages Instagram menaçants + photo maison + montages + GE ?' sans 'CP 180 : menaces électroniques punissables comme menaces physiques' ni 'captures d'écran = preuve valable, délai 3 mois'. Signal adversarial = victime croit que les menaces numériques ne relèvent pas du droit pénal.",
  },

  // CIRCULATION — LCR 57a / OETV 36 : obligation continue d'état conforme — le contrôle technique ne crée pas de franchise
  {
    id: 'adv_circulation_24',
    query: "J'ai passé le contrôle technique de mon véhicule il y a 5 mois à Genève — résultat positif. La semaine dernière, un gendarme a contrôlé mes pneus et m'a verbalisé pour une profondeur de sculpture de 1,2 mm. Il m'a dit qu'il s'agissait d'une infraction, malgré mon certificat de contrôle technique valable. Est-ce légal ? Mon contrôle était pourtant positif il y a seulement 5 mois.",
    canton: 'GE',
    expected_domaine: 'circulation',
  ...
  // BAIL — CO 261b : protection du locataire lors de transformation de l'immeuble en PPE
  {
    id: 'adv_bail_51',
    query: "Mon propriétaire vient de m'informer qu'il va transformer l'immeuble en propriété par étages et vendre mon appartement à un tiers. Cela signifie-t-il que je vais devoir partir ? J'habite ici depuis 8 ans à Genève et je n'ai jamais eu de problèmes avec le loyer.",
    canton: 'GE',
    expected_domaine: 'bail',
    expected_any_article: ['CO 261b', 'CO 261'],
    notes: "Protection renforcée du locataire lors de transformation en PPE — CO 261b al. 1 : lorsque le bailleur aliène l'objet loué après l'avoir soumis au régime de la PPE (propriété par étages), le locataire peut RÉSILIER le bail avec un délai de 3 mois pour la fin d'un mois, mais le nouveau propriétaire reste tenu aux obligations découlant du contrat de bail. CO 261 al. 1 : en cas d'aliénation, le nouveau propriétaire reprend le bail et est lié par ses conditions. CONSÉQUENCE PRINCIPALE : la transformation en PPE ne donne pas au propriétaire le droit de résilier le bail — le locataire peut rester. Le nouveau propriétaire (acquéreur de l'appartement PPE) est lié par le bail existant aux mêmes conditions. SEULE exception : le nouveau propriétaire peut résilier pour besoin propre urgent (CO 261 al. 2) avec un préavis de 3 ans minimum à Genève (cantons avec marché du logement tendu = délais prolongés selon droit cantonal). MYTHE : 'transformation en PPE = fin automatique du bail pour le locataire'. Faux — CO 261b protège expressément le locataire, qui peut rester ou résilier lui-même avec 3 mois de délai. '?PPE + vente appartement + locataire 8 ans + Genève?' sans 'CO 261b : protection locataire PPE' ni 'CO 261 : acquéreur reprend le bail'. Signal adversarial = locataire confond transformation de propriété (changement structure) avec résiliation (changement de locataire).",
  },

  // TRAVAIL — CO 328 : employeur responsable du harcèlement entre collègues
  {
    id: 'adv_travail_51',
    query: "Je subis du mobbing de la part de mes collègues depuis plusieurs mois dans mon entreprise à Berne. Mon employeur dit que ce n'est pas son problème, que c'est un conflit entre collègues et qu'il ne peut pas intervenir dans les relations personnelles entre employés. A-t-il raison ?",
    canton: 'BE',
    expected_domaine: 'travail',
    expected_any_article: ['CO 328', 'CO 336'],
    notes: "Obligation active de l'employeur de protéger contre le harcèlement — CO 328 al. 1 : l'employeur protège et respecte, dans les rapports de travail, la personnalité du travailleur ; il manifeste les égards voulus pour sa santé et veille au maintien de la moralité. CO 328 al. 2 : il prend les mesures commandées par l'expérience, applicables en l'état de la technique et adaptées aux conditions de l'exploitation. CONSÉQUENCE : l'employeur a une OBLIGATION ACTIVE d'agir contre le mobbing, même s'il ne l'a pas lui-même initié. S'il n'intervient pas malgré une plainte, il est en violation de CO 328 et peut être tenu pour responsable des dommages (ATF 125 III 70). La victime peut : (1) demander l'intervention de l'employeur par écrit, (2) saisir un inspectorat cantonal du travail, (3) résilier avec justes motifs (CO 337) si l'employeur n'agit pas, (4) réclamer des dommages-intérêts. MYTHE : 'mobbing entre collègues = conflit privé hors champ de l'employeur'. Faux — CO 328 crée une responsabilité ACTIVE de l'employeur pour la protection de la personnalité, y compris contre les actes de tiers (collègues). '?mobbing collègues + employeur inactif + Berne?' sans 'CO 328 : obligation protection personnalité' ni 'employeur doit agir même pour actes de tiers'. Signal adversarial = victime accepte le discours de l'employeur qui nie sa responsabilité pour les comportements inter-collègues.",
  },

  // DETTES — LP 207 : sursis aux poursuites après décès du débiteur
  {
    id: 'adv_dettes_47',
    query: "Mon père est décédé il y a deux semaines à Fribourg. Il avait des dettes et des poursuites en cours. Je viens de recevoir un commandement de payer adressé à 'la succession de feu [nom du père]'. Est-ce que je dois payer personnellement ces dettes ? La succession n'est pas encore réglée.",
    canton: 'FR',
    expected_domaine: 'dettes',
    expected_any_article: ['LP 207', 'CC 566'],
    notes: "Sursis légal aux poursuites après décès et responsabilité des héritiers — LP 207 al. 1 : après le décès du débiteur, toutes les poursuites dirigées contre lui sont suspendues de plein droit pendant 3 mois. CC 566 al. 1 : les héritiers acquièrent de plein droit la succession dès l'ouverture de celle-ci (décès) et sont solidairement responsables des dettes. MAIS : CC 566 al. 2 : ils peuvent répudier la succession dans les 3 mois (délai courant dès connaissance du décès). CC 580 : les héritiers peuvent demander le bénéfice d'inventaire auprès de l'autorité compétente — la responsabilité est alors limitée aux actifs de la succession. CONSÉQUENCE PRATIQUE : le commandement de payer adressé à 'la succession' est légal mais les héritiers ont 3 mois pour (1) répudier entièrement, (2) demander un bénéfice d'inventaire, ou (3) accepter et devenir personnellement responsables. LP 207 : le sursis de 3 mois protège pendant la période d'inventaire. MYTHE : 'recevoir un commandement de payer au nom de la succession = obligation personnelle immédiate de payer'. Faux — les héritiers ont le choix et le délai légal de 3 mois pour décider. '?décès père + poursuites en cours + commandement payer succession + Fribourg?' sans 'LP 207 : sursis 3 mois' ni 'CC 566 : droit de répudiation dans 3 mois'. Signal adversarial = héritier confond réception du commandement (acte procédural) avec obligation personnelle de payer.",
  },

  // FAMILLE — CC 288 : obligation alimentaire des enfants envers les parents
  {
    id: 'adv_famille_46',
    query: "Ma mère est en EMS à Lausanne. L'EMS réclame maintenant que je contribue aux frais car l'aide sociale ne suffit pas et ma mère n'a plus de ressources. J'ai moi-même une famille à charge et un revenu modeste. Suis-je légalement obligé de contribuer aux frais d'EMS de ma mère ?",
    canton: 'VD',
    expected_domaine: 'famille',
    expected_any_article: ['CC 328', 'CC 329'],
    notes: "Obligation alimentaire des enfants envers les ascendants dans le besoin — CC 328 al. 1 : les parents et les enfants se doivent mutuellement les aliments nécessaires à leur entretien. CC 329 al. 1 : l'action alimentaire est dirigée contre les débiteurs par ordre de priorité — conjoint, puis descendants, puis ascendants. CONSÉQUENCE : en droit suisse, les enfants peuvent effectivement être tenus de contribuer aux frais d'hébergement de leurs parents en EMS SI (1) les parents sont dans le besoin, (2) le parent ne peut couvrir ses besoins de ses revenus/fortune, et (3) les enfants ont des moyens suffisants sans nuire à leur propre entretien convenable. CC 329 al. 1 : l'obligation n'existe que si l'enfant peut la fournir sans compromettre son propre entretien convenable. Calcul : revenu disponible de l'enfant au-delà du minimum vital étendu (ménage + famille à charge). PROCÉDURE VD : l'autorité cantonale (SPAS Vaud) peut agir en récupération des prestations d'aide sociale contre les proches. MYTHE : 'je ne suis pas tenu de payer les dettes ou frais de mes parents'. Partiellement faux — CC 328/329 impose une obligation alimentaire ascendante, mais conditionnée aux capacités réelles de l'enfant. '?frais EMS mère + aide sociale + enfant famille à charge + Lausanne?' sans 'CC 328 : obligation alimentaire ascendants' ni 'CC 329 : condition = capacités de l'enfant sans nuire à son propre entretien'. Signal adversarial = enfant confond absence de responsabilité pour les dettes (passif successoral) avec l'obligation alimentaire légale distincte.",
  },

  // ÉTRANGERS — ALCP Annexe I art. 2 : séjour chercheur d'emploi UE prolongé à 6 mois
  {
    id: 'adv_etrangers_40',
    query: "Je suis citoyenne française et j'ai un permis de séjour B en Suisse qui expire dans 3 mois. Je viens de perdre mon emploi à Zurich. On m'a dit que je dois quitter la Suisse dès que je n'ai plus de travail. Est-ce correct ? J'ai travaillé ici pendant 2 ans et je cherche activement un nouvel emploi.",
    canton: 'ZH',
    expected_domaine: 'etrangers',
    expected_any_article: ['ALCP', 'LEI 61'],
    notes: "Droit de séjour du ressortissant UE en recherche d'emploi après perte de travail — ALCP Annexe I art. 2 al. 1 : les ressortissants UE/AELE ont le droit de séjourner en Suisse pour chercher un emploi pendant 3 mois (prolongeable jusqu'à 6 mois si recherche active). ALCP Annexe I art. 6 al. 6 : le droit de séjour du salarié UE/AELE qui a perdu involontairement son emploi est maintenu pendant 6 mois s'il est inscrit au chômage et cherche activement du travail. LEI 61a al. 2 (applicable par analogie ALCP) : la perte involontaire d'emploi ne met pas fin immédiatement au droit de séjour. CONSÉQUENCE : une ressortissante française ayant travaillé 2 ans en Suisse et perdant involontairement son emploi a le droit de rester jusqu'à 6 mois pour chercher du travail, à condition d'être inscrite à l'ORP et de chercher activement. Elle ne touche PAS les indemnités de chômage LACI si son délai-cadre de cotisation (2 ans d'AC) lui donne droit — si oui, elle peut toucher l'AC suisse. MYTHE : 'perte d'emploi = obligation de quitter la Suisse immédiatement pour ressortissant UE'. Faux — ALCP garantit un droit de séjour prolongé pour recherche d'emploi. '?française + permis B + perte emploi + cherche travail + Zurich?' sans 'ALCP : droit séjour 3-6 mois pour chercheur emploi UE' ni 'inscription ORP obligatoire'. Signal adversarial = ressortissante UE confond expiration du contrat de travail (fin lien employeur) avec perte du droit de séjour (droit distinct fondé sur ALCP).",
  },

  // VOISINAGE — CC 690 : modification du cours d'eau naturel sur sa propriété
  {
    id: 'adv_voisinage_33',
    query: "Mon voisin à Sion a dévié le ruisseau naturel qui traverse sa parcelle pour irriguer son jardin, ce qui a réduit le débit d'eau qui arrive sur ma parcelle en aval. Il dit que le ruisseau est sur sa propriété et qu'il peut en faire ce qu'il veut. A-t-il le droit de faire ça ?",
    canton: 'VS',
    expected_domaine: 'voisinage',
    expected_any_article: ['CC 689', 'CC 690'],
    notes: "Restriction au droit de modifier les eaux naturelles sur sa propriété — CC 689 : le propriétaire est tenu de recevoir les eaux qui s'écoulent naturellement sur son fonds depuis les fonds supérieurs, notamment les eaux de pluie, les eaux de sources et les eaux souterraines non captées. CC 690 al. 1 : le propriétaire d'un fonds supérieur n'a pas le droit, en modifiant les conditions naturelles de son fonds, de déverser sur le fonds inférieur un volume d'eau plus important qu'auparavant, ni de modifier le lieu d'écoulement. INTERPRÉTATION : même si le ruisseau traverse la parcelle du voisin (fonds supérieur), il ne peut pas le dévier de manière à PRIVER le fonds inférieur de l'eau qui y parvenait naturellement. La propriété du lit du ruisseau ne donne pas le droit de modifier le régime hydraulique au détriment des voisins en aval. VOIES DE DROIT : (1) mise en demeure écrite au voisin, (2) action en cessation du trouble (CC 679) — dommages-intérêts + remise en état, (3) plainte à l'autorité cantonale de surveillance des eaux (VS : Service de l'environnement). MYTHE : 'ce qui est sur ma propriété, je peux en faire ce que je veux'. Faux — CC 690 limite les modifications qui affectent les propriétés riveraines en aval. '?voisin dévie ruisseau + parcelle aval + débit réduit + Sion?' sans 'CC 690 : interdiction modifier écoulement naturel au détriment fonds inférieur' ni 'CC 679 : action en cessation trouble'. Signal adversarial = propriétaire riverain croit que la localisation du ruisseau sur la parcelle du voisin lui donne tous les droits sur l'eau.",
  },

  // SUCCESSIONS — CC 540 : indignité successorale
  {
    id: 'adv_successions_28',
    query: "Mon frère a été condamné pour tentative de meurtre sur notre père il y a 3 ans. Notre père est décédé depuis d'une autre cause. Mon frère réclame maintenant sa part d'héritage. Est-ce qu'il a encore droit à hériter malgré sa condamnation ?",
    canton: 'GE',
    expected_domaine: 'successions',
    expected_any_article: ['CC 540', 'CC 542'],
    notes: "Indignité successorale pour crime contre le défunt — CC 540 al. 1 : est indigne de succéder et de recevoir des libéralités pour cause de mort : (1) quiconque a intentionnellement et sans droit donné la mort au défunt ou tenté de le tuer. CC 540 al. 2 : l'indignité n'a pas lieu si le défunt a pardonné l'offenseur. CC 542 : l'indigne est exclu de la succession comme s'il n'avait jamais existé — sa part accroît aux cohéritiers selon leur vocation héréditaire. CONSÉQUENCE : la condamnation pour tentative de meurtre sur le défunt entraîne l'indignité successorale de plein droit — le frère est exclu de la succession, SAUF si le père avait expressément pardonné (CC 540 al. 2) ou avait établi un testament en faveur du frère après l'incident (ce qui vaudrait pardon tacite selon la doctrine). PREUVE : la condamnation pénale suffit à établir les conditions de l'indignité. PROCÉDURE : les autres héritiers peuvent soulever l'indignité par voie d'action judiciaire ou l'invoquer en défense si l'indigne réclame sa part. MYTHE : 'la condamnation pénale et le droit successoral sont séparés'. Partiellement faux — CC 540 crée explicitement une sanction civile successorale pour les crimes contre le défunt. '?tentative meurtre père + condamné + réclame héritage + Genève?' sans 'CC 540 : indignité successorale de plein droit pour tentative de meurtre' ni 'CC 540 al. 2 : exception si pardon du défunt'. Signal adversarial = héritier croit que la condamnation pénale est sans effet sur les droits civils successoraux.",
  },

  // CONSOMMATION — CO 107/108 : résolution du contrat pour retard sans prouver un préjudice
  {
    id: 'adv_consommation_27',
    query: "J'ai commandé un canapé sur mesure il y a 4 mois à Lausanne avec une date de livraison contractuelle au 15 mars. Le vendeur n'a toujours pas livré malgré mes relances. Il me dit que je dois prouver un dommage concret pour pouvoir annuler la commande. Est-ce vrai ?",
    canton: 'VD',
    expected_domaine: 'consommation',
    expected_any_article: ['CO 107', 'CO 108'],
    notes: "Résolution du contrat pour retard — conditions simplifiées — CO 107 al. 1 : lorsque le débiteur est en demeure dans un contrat bilatéral, le créancier peut lui fixer un délai convenable pour s'exécuter ou faire exécuter. CO 107 al. 2 : si l'exécution n'intervient pas dans ce délai, le créancier peut réclamer des dommages-intérêts en raison de l'inexécution et se départir du contrat. CO 108 ch. 2 : il n'est pas nécessaire de fixer un délai si le comportement du débiteur manifeste que cette mesure serait sans effet. CONSÉQUENCE : pour résilier le contrat pour retard, le créancier n'a PAS besoin de prouver un dommage concret — il suffit de : (1) une date d'exécution convenue ou un délai de mise en demeure notifié, (2) l'absence d'exécution dans ce délai. La déclaration de résolution par écrit suffit. Le remboursement de l'avance versée (acompte) est alors dû. MYTHE : 'annuler un contrat pour retard de livraison nécessite de prouver un dommage concret'. Faux — CO 107 permet la résolution sur simple non-exécution dans le délai, sans preuve de préjudice spécifique. '?canapé sur mesure + retard livraison + vendeur exige preuve dommage + Lausanne?' sans 'CO 107 : résolution possible sans preuve de dommage' ni 'délai supplémentaire à fixer par écrit'. Signal adversarial = consommateur accepte à tort la condition inventée par le vendeur d'une preuve de préjudice pour résilier.",
  },

  // CIRCULATION — LCR 100 / CP 117 : responsabilité pénale conducteur non couverte par RC auto
  {
    id: 'adv_circulation_26',
    query: "J'ai eu un accident de voiture à Bâle où j'ai grillé un feu rouge et blessé grièvement un piéton. Mon assurance RC auto a indemnisé la victime. Mon avocat me dit que malgré l'indemnisation par l'assurance, je pourrais quand même avoir des poursuites pénales personnelles. Est-ce que l'indemnisation par l'assurance me protège pénalement ?",
    canton: 'BS',
    expected_domaine: 'circulation',
    expected_any_article: ['LCR 100', 'CP 117'],
    notes: "Indépendance de la responsabilité pénale par rapport à l'indemnisation civile par l'assurance RC — LCR 100 ch. 1 : les dispositions du CP relatives à la culpabilité et à l'imputabilité sont applicables. CP 117 : quiconque, par négligence, cause la mort d'une personne est puni d'une peine privative de liberté de trois ans au plus ou d'une peine pécuniaire. CP 125 (lésions corporelles par négligence) : peine privative de liberté de trois ans au plus ou peine pécuniaire. PRINCIPE FONDAMENTAL : la responsabilité pénale (droit public, punition de l'Etat) est TOTALEMENT indépendante de la responsabilité civile (indemnisation de la victime par l'assurance). L'indemnisation par la RC auto n'efface PAS l'infraction pénale ni ne fait disparaître la culpabilité du conducteur. Le Ministère public peut poursuivre pénalement même si la victime est entièrement indemnisée — sauf désistement de plainte si l'infraction n'est poursuivable que sur plainte (rare pour lésions corporelles graves ou homicide). CONSÉQUENCE : le conducteur peut être condamné pénalement (amende, peine avec sursis, retrait de permis LCR 16) indépendamment de la couverture RC. MYTHE : 'mon assurance a tout réglé donc je n'ai plus de problème pénalement'. Faux — RC auto = couverture civile uniquement, la responsabilité pénale reste personnelle et ne peut être assurée. '?accident feu rouge + blessé grave + RC auto indemnisé + Bâle + pénal?' sans 'CP 117/125 : responsabilité pénale indépendante de l'indemnisation civile' ni 'LCR 100 : application du CP'. Signal adversarial = conducteur confond règlement civil de sinistre (rôle assurance) avec extinction de la responsabilité pénale personnelle.",
  },

  // ASSURANCES — LPP 18/20 : rente de conjoint survivant LPP
  {
    id: 'adv_assurances_29',
    query: "Mon mari est décédé il y a un mois à Genève. Il avait une caisse de pension LPP. On m'a annoncé que j'aurais droit à une rente de conjoint survivant mais le montant semble très faible. Comment est calculée cette rente et quelles sont les conditions pour y avoir droit ?",
    canton: 'GE',
    expected_domaine: 'assurances',
    expected_any_article: ['LPP 20', 'LPP 18'],
    notes: "Rente de conjoint survivant LPP — conditions et calcul — LPP 20 al. 1 : le conjoint survivant a droit à une rente de survivant si, au décès de son époux/épouse, il a des enfants à charge, ou est âgé de plus de 45 ans et que le mariage a duré au moins 5 ans. LPP 20 al. 2 : la rente de conjoint est égale à 60% de la rente de vieillesse (ou d'invalidité) à laquelle l'assuré avait droit. CALCUL : la rente de conjoint = 60% × rente LPP du défunt. La rente LPP du défunt est calculée sur la base de l'avoir de vieillesse épargné (cotisations + intérêts) converti en rente selon taux de conversion LPP (actuellement minimum légal 6.8% pour hommes 65 ans, 6.8% femmes 64 ans). CONDITION PRÉALABLE : le mariage doit avoir duré ≥5 ans si conjoint >45 ans. Sinon : une prestation unique équivalente à 3 annuités est versée. ATTENTION : les règlements de caisse peuvent prévoir des prestations supérieures au minimum légal (enveloppe surobligatoire). MYTHE : 'la rente de conjoint LPP = moitié du salaire du défunt'. Faux — LPP 20 : c'est 60% de la RENTE LPP (elle-même limitée à la part épargne LPP), pas du salaire total. '?décès mari + caisse pension LPP + rente conjoint survivant + montant faible + Genève?' sans 'LPP 20 : rente conjoint = 60% rente LPP défunt' ni 'conditions : enfants à charge ou mariage ≥5 ans + âge >45 ans'. Signal adversarial = conjoint survivant confond la rente LPP (2ème pilier, épargne professionnelle) avec une rente AVS ou une fraction du dernier salaire.",
  },

  // BAIL — CO 270b : contestation du loyer initial dans les 30 jours même après signature
  {
    id: 'adv_bail_52',
    query: "J'ai signé un bail à Genève il y a 3 semaines pour un appartement de 4 pièces à 2'800 CHF par mois. Mon voisin avec un appartement identique paie 1'900 CHF. Une amie me dit que je pourrais contester mon loyer initial, mais j'ai signé le contrat — est-ce vraiment encore possible ?",
    canton: 'GE',
    expected_domaine: 'bail',
    expected_any_article: ['CO 270', 'CO 270b'],
    notes: "Contestation du loyer initial dans les 30 jours dès remise du logement — CO 270b al. 1 : le locataire peut saisir l'autorité de conciliation pour faire constater que le loyer initial est abusif dans les 30 jours qui suivent la remise de la chose louée. Ce droit subsiste même si le locataire a signé le contrat — la signature n'y renonce pas. CO 270 al. 1 : le loyer est abusif notamment lorsqu'il procure au bailleur un rendement excessif ou lorsqu'il résulte d'un prix d'achat manifestement exagéré. CONDITION GE : Genève applique le droit cantonal d'extension — formulaire officiel obligatoire lors de la remise d'un logement qui a été habité dans les 5 dernières années (LDTR GE). DÉLAI PÉREMPTOIRE : 30 jours dès remise des clés (pas dès signature du contrat). MYTHE : 'j'ai signé le bail donc je ne peux plus contester le loyer'. Faux — CO 270b donne un droit de contestation de 30 jours après remise, indépendamment de la signature. '?bail Genève + loyer 2800 CHF + voisin identique 1900 + signé contrat + contester?' sans 'CO 270b : 30 jours dès remise des clés, signature ne prive pas du droit' ni 'GE : formulaire officiel obligatoire'. Signal adversarial = locataire renonce à un droit légal car il croit que la signature du bail équivaut à une renonciation définitive.",
  },

  // TRAVAIL — CO 327a : remboursement obligatoire des frais professionnels même sans clause contractuelle
  {
    id: 'adv_travail_52',
    query: "Je suis représentante commerciale à Berne et je dois me déplacer chez des clients avec ma propre voiture. Mon employeur refuse de me rembourser l'essence et le kilométrage, en disant que mon salaire de 5'500 CHF par mois 'couvre tout'. Il n'y a pas de clause de remboursement dans mon contrat. A-t-il raison ?",
    canton: 'BE',
    expected_domaine: 'travail',
    expected_any_article: ['CO 327a', 'CO 327'],
    notes: "Remboursement des frais professionnels — obligation légale indépendante du contrat — CO 327a al. 1 : l'employeur rembourse le travailleur de tous les frais imposés par l'exécution du travail et, lorsque le travailleur est occupé en dehors de son lieu de travail, des dépenses nécessaires pour sa nourriture et son logement. CO 327 : lorsque le travailleur doit utiliser ses propres outils pour l'exécution du travail, il a droit à une indemnité adéquate. CO 362 : CO 327a est impératif — une clause contractuelle excluant le remboursement des frais est nulle. CONSÉQUENCE : l'employeur doit rembourser les frais de déplacement professionnels (kilométrage, essence) indépendamment de toute clause contractuelle ou du niveau de salaire. L'indemnité kilométrique de référence est fixée par circulaire AFC (actuellement 0.70 CHF/km). CO 341 al. 1 : la créance de remboursement de frais ne se prescrit qu'après 5 ans. MYTHE : 'si le contrat ne prévoit pas de remboursement des frais, l'employeur n'y est pas tenu'. Faux — CO 327a est impératif, aucune clause ne peut l'écarter. '?représentante + déplacements voiture + employeur refuse remboursement + aucune clause contrat + Berne?' sans 'CO 327a : remboursement impératif même sans clause' ni 'CO 362 : disposition non dérogeable au détriment du travailleur'. Signal adversarial = salarié accepte une pratique illicite car le contrat ne mentionne pas le remboursement.",
  },

  // DETTES — LP 265 : persistance des dettes après faillite personnelle et acte de défaut de biens
  {
    id: 'adv_dettes_48',
    query: "J'ai fait une faillite personnelle à Lausanne il y a 8 ans. La liquidation est terminée depuis longtemps. Je viens de recevoir un commandement de payer pour une dette de 15'000 CHF qui existait avant ma faillite. L'huissier dit que j'y suis encore tenu. Pourtant je croyais que la faillite avait tout effacé.",
    canton: 'VD',
    expected_domaine: 'dettes',
    expected_any_article: ['LP 265', 'LP 265a'],
    notes: "Persistance des dettes après faillite — acte de défaut de biens — LP 265 al. 1 : si les biens saisis ou réalisés en faillite ne suffisent pas à couvrir les créances, les créanciers reçoivent un acte de défaut de biens pour le montant impayé. LP 265 al. 2 : l'acte de défaut de biens confère au créancier le droit de reprendre la poursuite si la situation du débiteur s'améliore. LP 265a : le débiteur peut demander l'annulation des actes de défaut de biens uniquement s'il a payé tous ses créanciers intégralement ('libération judiciaire'). CONSÉQUENCE : contrairement à une idée répandue, la faillite personnelle en Suisse N'ÉTEINT PAS les dettes — les créanciers munis d'actes de défaut de biens peuvent reprendre les poursuites dès que le failli retrouve une situation financière meilleure (revenu, héritage, etc.). La faillite suspend simplement les poursuites pendant la liquidation et réalise les actifs disponibles. DIFFÉRENCE AVEC LE DROIT AMÉRICAIN : le 'fresh start' du droit américain (discharge) n'existe pas en droit suisse. MYTHE : 'après une faillite, toutes mes dettes sont effacées'. Faux — LP 265 : les dettes persistent sous forme d'actes de défaut de biens, récupérables à tout moment si situation du débiteur s'améliore. '?faillite personnelle Lausanne + 8 ans + commandement payer ancienne dette + pensait tout effacé?' sans 'LP 265 : actes de défaut de biens persistants après faillite' ni 'dettes récupérables si situation s'améliore'. Signal adversarial = failli croit que la clôture de la liquidation équivaut à une libération totale des dettes.",
  },

  // FAMILLE — CC 286 : modification unilatérale illicite de la pension alimentaire
  {
    id: 'adv_famille_47',
    query: "J'ai perdu mon emploi à Fribourg il y a 2 mois. Je dois verser 1'200 CHF par mois de pension alimentaire pour mon fils de 8 ans, selon un jugement de divorce prononcé il y a 3 ans. Je n'ai plus de revenus. Est-ce que je peux arrêter de payer jusqu'à ce que je retrouve du travail ?",
    canton: 'FR',
    expected_domaine: 'famille',
    expected_any_article: ['CC 285', 'CC 286'],
    notes: "Interdiction de modifier unilatéralement une pension alimentaire fixée par jugement — CC 285 al. 1 : la contribution d'entretien doit correspondre aux besoins de l'enfant ainsi qu'à la situation et aux ressources des père et mère. CC 286 al. 2 : si la situation change notablement, le juge modifie ou supprime la contribution d'entretien à la requête du père, de la mère ou de l'enfant. CONSÉQUENCE : un jugement de divorce fixant une pension alimentaire ne peut être modifié que PAR UN NOUVEAU JUGEMENT (ou convention homologuée). La perte d'emploi constitue un changement notable permettant de demander une réduction — MAIS ce recours doit être formé avant de cesser de payer, idéalement en urgence (mesures provisoires CPC 276). Cesser de payer sans jugement modificatif expose à : (1) actes de poursuite (LP 67), (2) condamnation pour insoumission à une décision d'autorité (CP 292), (3) accumulation d'arriérés avec intérêts. DÉMARCHE CORRECTE : (1) saisir en urgence le tribunal de mesures provisoires pour réduction provisoire, (2) intenter action en modification (CC 286 al. 2). MYTHE : 'je perds mon emploi = je peux arrêter de payer la pension sans demander au juge'. Faux — modification unilatérale illicite même en cas de changement de situation ; seul le juge peut réduire. '?perte emploi + pension alimentaire jugement + arrêter payer + Fribourg?' sans 'CC 286 al. 2 : seul le juge peut modifier + mesures provisoires urgence' ni 'CP 292 : insoumission si cesse de payer sans jugement'. Signal adversarial = père croit que le changement de situation financière lui donne le droit de suspendre unilatéralement le paiement de la pension.",
  },

  // ÉTRANGERS — LEI 50 : maintien du droit de séjour après séparation du conjoint suisse
  {
    id: 'adv_etrangers_41',
    query: "Je suis thaïlandaise et j'ai un permis B obtenu grâce à mon mariage avec un Suisse il y a 4 ans à Zurich. Mon mari vient de déposer une demande de divorce. On m'a dit que je perdrais automatiquement mon permis dès qu'on est séparés. Est-ce vraiment le cas ?",
    canton: 'ZH',
    expected_domaine: 'etrangers',
    expected_any_article: ['LEI 50', 'LEI 51'],
    notes: "Maintien du droit de séjour après dissolution du mariage avec un ressortissant suisse — LEI 50 al. 1 : après dissolution de la famille, le droit du conjoint à l'octroi d'une autorisation de séjour et au renouvellement de celle-ci subsiste si : (a) l'union conjugale a duré au moins trois ans et si l'intégration est réussie, ou (b) la poursuite du séjour en Suisse s'impose pour des raisons personnelles majeures (violence conjugale, réintégration dans le pays d'origine très difficile). LEI 51 al. 1 : le droit du conjoint peut prendre fin notamment si les conditions du séjour ne sont plus remplies. CONDITION CLEF : l'union conjugale doit avoir duré AU MOINS 3 ANS et l'intégration doit être réussie (langue, travail, pas de dépendance durable à l'aide sociale). Après 4 ans de mariage effectif, la condition de durée est a priori remplie. La séparation provisoire (pas encore le divorce définitif) ne fait pas perdre le permis immédiatement. PROCÉDURE : renouvellement du permis B à l'échéance, avec justification de l'intégration (diplôme de langue, activité professionnelle, participation vie sociale). MYTHE : 'dès qu'on se sépare, je perds mon permis'. Faux — LEI 50 al. 1 let. a : si mariage ≥3 ans et intégration réussie, le droit de séjour est maintenu même après divorce. '?thaïlandaise + permis B + mariage suisse 4 ans + demande divorce + perdre permis + Zurich?' sans 'LEI 50 al. 1 let. a : maintien si mariage ≥3 ans + intégration réussie' ni 'séparation ≠ perte immédiate permis'. Signal adversarial = conjointe étrangère pense que son droit de séjour dépend entièrement du maintien du mariage, ignorant le droit propre fondé sur la durée de l'union et l'intégration.",
  },

  // VOISINAGE — CC 695 / LTC 36 : servitude légale de passage pour lignes de communication
  {
    id: 'adv_voisinage_34',
    query: "Swisscom veut poser un câble de fibre optique le long de ma façade à Lausanne pour alimenter les voisins. Je leur ai dit non — c'est ma propriété privée. Ils m'ont répondu qu'ils ont le droit de le faire sans mon accord. Est-ce possible en Suisse ?",
    canton: 'VD',
    expected_domaine: 'voisinage',
    expected_any_article: ['CC 695', 'LTC 36'],
    notes: "Servitude légale de passage pour lignes de communication et infrastructures — LTC 36 al. 1 (loi sur les télécommunications) : les fournisseurs de services de télécommunication peuvent utiliser le domaine public pour l'installation et l'exploitation de leurs installations. LTC 36 al. 2 : si l'utilisation du domaine public est insuffisante, les opérateurs peuvent exiger l'établissement de servitudes sur les fonds privés contre indemnité équitable. CC 695 al. 1 : la loi peut, dans l'intérêt du public, assujettir la propriété à des servitudes légales notamment pour les conduites et lignes de transmission. CONSÉQUENCE : les opérateurs télécom peuvent exiger par voie judiciaire ou amiable l'établissement d'une servitude de passage sur les façades privées, même sans accord du propriétaire, contre indemnité. Le propriétaire a droit à une indemnité équitable pour l'atteinte à sa propriété, mais ne peut pas refuser de principe si l'accès au domaine public est insuffisant. PROCÉDURE : si le propriétaire refuse, l'opérateur peut saisir le tribunal ou l'OFCOM. MYTHE : 'ma façade est ma propriété, personne ne peut y poser des câbles sans mon accord'. Partiellement faux — LTC 36/CC 695 : servitude légale imposable contre indemnité, refus impossible en principe si techniquement nécessaire. '?Swisscom + fibre optique + façade + propriété privée + refus + Lausanne?' sans 'LTC 36 : servitude légale opérateurs contre indemnité' ni 'CC 695 : servitudes légales intérêt public'. Signal adversarial = propriétaire confond droit absolu de propriété avec l'absence de servitudes légales d'utilité publique.",
  },

  // SUCCESSIONS — CC 509/511 : révocabilité absolue du testament à tout moment
  {
    id: 'adv_successions_29',
    query: "J'ai rédigé un testament olographe à Berne il y a 2 ans en faveur de mon amie proche. Ma famille me fait maintenant pression et dit que maintenant que j'ai 'signé un testament', je suis lié et ne peux plus le modifier sans l'accord de mon amie. Est-ce vrai ?",
    canton: 'BE',
    expected_domaine: 'successions',
    expected_any_article: ['CC 509', 'CC 511'],
    notes: "Révocabilité absolue du testament à tout moment — CC 509 al. 1 : le testateur peut en tout temps révoquer ses dispositions pour cause de mort, soit en dressant un nouveau testament, soit en détruisant l'acte ou en le retirant du dépôt officiel. CC 511 al. 1 : le testament postérieur révoque le précédent dans la mesure où il n'en est pas la confirmation. PRINCIPE FONDAMENTAL : en droit successoral suisse, le testateur conserve toujours la liberté de modifier ou révoquer ses dispositions testamentaires jusqu'à sa mort — le testament est un acte UNILATÉRAL RÉVOCABLE, non un contrat bilatéral. Exception : le PACTE SUCCESSORAL (CC 494/495) est un contrat qui lie les parties et ne peut être révoqué que d'un commun accord. CONSÉQUENCE : pour changer un testament olographe, il suffit de rédiger un nouveau testament olographe (écrit entièrement à la main, daté, signé — CC 505) ou de détruire physiquement l'ancien. L'accord du bénéficiaire n'est PAS requis pour révoquer un testament. ATTENTION : les réserves héréditaires des descendants (CC 471) s'appliquent indépendamment du testament. MYTHE : 'un testament signé = contrat contraignant qu'on ne peut pas modifier sans accord du bénéficiaire'. Faux — CC 509/511 : le testament est révocable à tout moment par le testateur seul, sans notification ni accord d'autrui. '?testament olographe + amie + famille dit lié + ne peut pas modifier sans accord + Berne?' sans 'CC 509 : révocabilité libre du testament' ni 'distinction testament (acte unilatéral révocable) vs pacte successoral (contrat)'. Signal adversarial = testateur croit à tort que son testament l'engage contractuellement, sous pression familiale.",
  },

  // CONSOMMATION — CO 210 al. 2 / CO 197 : garantie légale non supprimable pour B2C même sur occasion
  {
    id: 'adv_consommation_28',
    query: "J'ai acheté une voiture d'occasion de 2018 chez un concessionnaire à Neuchâtel pour 12'500 CHF il y a 6 semaines. La boîte de vitesses automatique vient de lâcher — réparation estimée à 4'800 CHF. Le concessionnaire me dit 'vendu en l'état, aucune garantie, vous avez signé'. Est-ce légal ?",
    canton: 'NE',
    expected_domaine: 'consommation',
    expected_any_article: ['CO 197', 'CO 210'],
    notes: "Garantie légale des défauts sur véhicule d'occasion acheté chez un professionnel — CO 197 al. 1 : le vendeur est tenu de garantir l'acheteur tant en raison des qualités promises que des défauts qui en diminuent notablement la valeur ou l'utilité et dont l'acheteur ne pouvait pas se rendre compte lors de la vente. CO 210 al. 2 : dans les contrats entre professionnel et consommateur (B2C), le délai de garantie légale ne peut pas être réduit à moins de 1 an (il est de 2 ans par défaut). La clause 'vendu en l'état, sans garantie' est NULLE dans les contrats B2C car elle viole CO 210 al. 2. DIFFÉRENCE B2B vs B2C : entre professionnels, la clause 'sans garantie' peut être valide. CONDITION : le défaut doit être antérieur à la vente et non apparent lors de la vente (CO 197 al. 2). Dénonciation dans les 7 jours de découverte du défaut (CO 210 al. 1). ACTIONS DISPONIBLES : résolution du contrat (CO 205 al. 1) ou réduction du prix. MYTHE : 'voiture d'occasion vendue en l'état par un professionnel = aucune garantie légale'. Faux — CO 210 al. 2 : garantie légale minimum 1 an, clause d'exclusion nulle en B2C. '?voiture occasion + concessionnaire professionnel + boîte de vitesses 6 semaines + vendu en l'état signé + Neuchâtel?' sans 'CO 210 al. 2 : délai min. 1 an non réductible B2C' ni 'clause exclusion garantie nulle vs consommateur'. Signal adversarial = consommateur croit que la clause 'sans garantie' qu'il a signée est valide alors qu'elle est nulle en B2C.",
  },

  // CIRCULATION — LCR 51 : obligation de s'arrêter après accident même si non responsable
  {
    id: 'adv_circulation_27',
    query: "J'ai été impliquée dans un accrochage à Genève hier. L'autre conducteur avait grillé un stop et percuté mon côté — c'est clairement sa faute. J'ai pris ses coordonnées mais ensuite je suis repartie sans attendre la police car j'étais en retard au travail. Ce matin je reçois un PV pour délit de fuite. Comment est-ce possible si c'est lui le fautif ?",
    canton: 'GE',
    expected_domaine: 'circulation',
    expected_any_article: ['LCR 51', 'LCR 92'],
    notes: "Obligation de s'arrêter et de signaler un accident — indépendante de la faute — LCR 51 al. 1 : en cas d'accident, toute personne impliquée doit s'arrêter immédiatement. Al. 3 : en cas de dommages matériels, si l'autre partie n'est pas sur place, laisser ses coordonnées de façon accessible et prévenir la police sans tarder. LCR 92 al. 1 : celui qui, en violation des obligations légales, s'enfuit après un accident est puni d'une peine privative de liberté de trois ans au plus ou d'une peine pécuniaire — MÊME s'il n'est pas responsable de l'accident. CONSÉQUENCE CLEF : le devoir de s'arrêter et d'attendre ou d'avertir la police s'applique à TOUTE personne IMPLIQUÉE dans un accident, indépendamment de sa faute. Repartir après avoir seulement échangé des coordonnées peut être insuffisant si des tiers ou la police doivent constater les faits. MYTHE : 'si ce n'est pas ma faute dans un accident, je peux partir sans attendre la police'. Faux — LCR 51 : l'obligation de s'arrêter et de signaler l'accident est liée à l'implication, pas à la responsabilité. '?accrochage Genève + autre fautif + pris coordonnées + repartie + PV délit de fuite?' sans 'LCR 51 : obligation s'arrêter liée à l'implication, pas à la faute' ni 'LCR 92 : délit de fuite même si non responsable'. Signal adversarial = conductrice confond l'absence de responsabilité civile avec l'absence d'obligation procédurale de s'arrêter.",
  },

  // BAIL — CO 269 : méthode primaire de calcul du loyer abusif = rendement net, pas conformité au marché
  {
    id: 'adv_bail_53',
    query: "Mon bailleur vient d'augmenter mon loyer de 150 CHF à Genève. Il justifie ça en disant que le loyer est dans la 'moyenne du marché du quartier'. J'ai vérifié sur des sites de petites annonces et c'est vrai — les loyers similaires sont au même prix ou plus chers. Est-ce que cette justification est suffisante pour que l'augmentation soit légale ?",
    canton: 'GE',
    expected_domaine: 'bail',
    expected_any_article: ['CO 269', 'CO 269a'],
    notes: "Méthode primaire de calcul du loyer abusif — rendement net (CO 269) vs loyers comparatifs (CO 269a) — CO 269 al. 1 : les loyers sont abusifs notamment s'ils permettent au bailleur d'obtenir un rendement excessif de la chose louée. CO 269a : sont en règle générale non abusifs les loyers qui notamment (a) se situent dans les limites des loyers usuels dans la localité ou dans le quartier. ORDRE DE PRIORITÉ : la conformité aux loyers du marché (CO 269a) est une méthode SECONDAIRE/SUBSIDIAIRE. La méthode PRIMAIRE est le contrôle du rendement net selon CO 269 — si le propriétaire obtient un rendement supérieur à 0.5% au-dessus du taux hypothécaire de référence OFL sur ses fonds propres, le loyer est abusif MÊME S'IL EST DANS LES MOYENNES DU MARCHÉ. Le tribunal cantonal genevois (TBAL) applique en priorité CO 269 (rendement) si le bailleur peut fournir le calcul de ses charges, puis CO 269a si les chiffres manquent. CONSÉQUENCE : un locataire peut contester l'augmentation en demandant le calcul du rendement net du propriétaire, même si le loyer est dans la norme du marché. DÉMARCHE : formulaire officiel de contestation auprès de la Commission de conciliation, délai 30 jours depuis la réception de l'augmentation (CO 270b). MYTHE : 'loyer dans la moyenne du marché = loyer automatiquement non abusif'. Faux — CO 269 : rendement net excessif = abusif même si conforme au marché. '?augmentation loyer + justification marché + loyer dans la moyenne + contestation possible + Genève?' sans 'CO 269 : méthode primaire = rendement net, pas le marché' ni 'délai 30j contestation CO 270b'. Signal adversarial = locataire renonce à contester car il vérifie la conformité au marché au lieu de vérifier le rendement net du bailleur.",
  },

  // TRAVAIL — CO 323b al. 3 : droit d'inspection des pièces comptables pour salaire à la commission
  {
    id: 'adv_travail_53',
    query: "Je suis vendeuse à Lausanne, payée en partie à la commission sur mes ventes. Depuis 3 mois, les montants de commission sur ma fiche de salaire me semblent inférieurs à ce que j'aurais dû toucher. J'ai demandé à mon chef de me montrer les relevés de ventes sur lesquels sont calculées mes commissions mais il dit que c'est confidentiel et que je n'ai pas le droit de les voir. A-t-il raison ?",
    canton: 'VD',
    expected_domaine: 'travail',
    expected_any_article: ['CO 323b'],
    notes: "Droit d'inspection des pièces comptables en cas de salaire variable — CO 323b al. 3 : si le salaire est déterminé en tout ou en partie d'après le résultat du travail ou de l'exploitation, l'employeur doit remettre au travailleur ou, avec son consentement, à une association professionnelle, un relevé des éléments servant de base au calcul, et lui permettre de vérifier ces indications en consultant les livres de compte et les autres pièces justificatives dans la mesure nécessaire. CONSÉQUENCE : le droit de contrôle de l'employé est légal et ne peut pas être refusé. Ce droit inclut l'accès aux relevés de ventes, aux registres de commission, et aux documents de base nécessaires pour vérifier le calcul. L'employeur peut, si le travailleur y consent, passer par une association professionnelle pour préserver la confidentialité d'autres données commerciales. LIMITE : l'accès est limité aux informations 'dans la mesure nécessaire' pour contrôler le calcul de la commission — pas accès à l'ensemble de la comptabilité. MYTHE : 'l'employeur peut refuser de montrer les documents de calcul des commissions au motif de confidentialité'. Faux — CO 323b al. 3 : droit légal d'inspection des pièces servant de base au calcul du salaire variable. '?vendeuse + commissions inférieures + demande relevés ventes + refus employeur + confidentialité + Lausanne?' sans 'CO 323b al. 3 : droit légal inspection pièces comptables calcul commission' ni 'employeur obligé de permettre la vérification'. Signal adversarial = employée accepte le refus de son employeur de montrer les données de calcul, ignorant son droit légal d'inspection des pièces justificatives.",
  },

  // DETTES — CO 63 al. 3 : répétition impossible d'une dette prescrite payée en connaissance de cause
  {
    id: 'adv_dettes_49',
    query: "Ma banque m'a relancé pour rembourser un ancien découvert de 2008 à Zurich. Je savais que la dette était prescrite (plus de 10 ans selon un ami) mais pour avoir la paix et éviter des problèmes avec ma banque, j'ai quand même payé 3'200 CHF il y a 2 semaines. Maintenant je regrette. Est-ce que je peux demander le remboursement de ce que j'ai versé ?",
    canton: 'ZH',
    expected_domaine: 'dettes',
    expected_any_article: ['CO 63', 'CO 127'],
    notes: "Répétition impossible d'une dette prescrite payée en connaissance de cause — CO 63 al. 3 : la répétition n'est pas admise non plus lorsqu'une dette prescrite a été payée volontairement. CO 127 : prescription ordinaire = 10 ans. PRINCIPE CLÉ : la prescription n'éteint PAS la dette — elle éteint seulement le DROIT D'ACTION du créancier (CO 142 : le juge n'applique pas la prescription d'office ; le débiteur doit l'invoquer). En d'autres termes, la dette morale subsiste même après la prescription légale. CO 63 al. 3 : si le débiteur paie une dette prescrite VOLONTAIREMENT en sachant qu'elle est prescrite, il renonce à la prescription et le paiement est valable — il ne peut pas exiger la restitution. EXCEPTION : CO 63 al. 1 : si le paiement est fait par ERREUR (le débiteur croyait à tort la dette non prescrite), la répétition est possible — mais la preuve de l'erreur incombe au demandeur. DANS CE CAS : le débiteur savait que la dette était probablement prescrite avant de payer — CO 63 al. 3 bloque toute répétition. MYTHE : 'j'ai payé une dette prescrite sans obligation légale — je peux récupérer l'argent via enrichissement illégitime'. Faux si paiement conscient — CO 63 al. 3 : renonciation tacite à la prescription = paiement valable, non répétible. '?dette prescrite 10 ans + payé quand même pour avoir la paix + veut récupérer + Zurich?' sans 'CO 63 al. 3 : paiement conscient dette prescrite = non répétible' ni 'prescription ≠ extinction de la dette, seulement du droit d'action'. Signal adversarial = débiteur pense que payer une dette prescrite lui crée un droit à restitution car il n'y était 'pas obligé légalement'.",
  },

  // FAMILLE — CC 197-198-209 : biens propres pré-mariage non partagés, rénovation = récompense pas propriété
  {
    id: 'adv_famille_48',
    query: "Je me marie à Fribourg le mois prochain. Mon futur mari possède déjà un appartement qu'il a acheté avant notre mariage avec ses économies personnelles. Si on rénove ensemble cet appartement pendant le mariage en utilisant nos revenus communs, est-ce que l'appartement deviendra partiellement à moi en cas de divorce ?",
    canton: 'FR',
    expected_domaine: 'famille',
    expected_any_article: ['CC 197', 'CC 198', 'CC 209'],
    notes: "Régime ordinaire de la participation aux acquêts — distinction biens propres / acquêts et récompenses — CC 197 al. 1 : les acquêts comprennent les biens acquis par un époux à titre onéreux pendant le régime. CC 198 : sont biens propres d'un époux notamment les biens qui lui appartiennent au début du régime ou qui lui échoient par succession ou autrement à titre gratuit. CC 209 al. 3 : des récompenses sont dues entre les masses si un bien propre a été financé par des acquêts — la masse créancière peut réclamer le remboursement de l'investissement en valeur nominale ou en plus-value proportionnelle selon qu'il s'agit d'investissements ordinaires ou exceptionnels (JdT). CONSÉQUENCE : l'appartement acheté AVANT le mariage avec des économies personnelles = BIEN PROPRE (CC 198 ch. 1) — il n'entre pas dans la masse des acquêts et n'est pas partagé lors de la liquidation du régime. MAIS : si des dépenses communes (acquêts = revenus du travail pendant le mariage) ont financé les rénovations, la communauté conjugale (masse des acquêts) dispose d'une CRÉANCE DE RÉCOMPENSE sur les biens propres (CC 209 al. 3) = remboursement financier proportionnel à la plus-value générée — mais pas transfert de propriété sur l'immeuble lui-même. MYTHE : 'si on rénove ensemble l'appartement pendant le mariage, il devient partiellement à moi (en propriété)'. Faux en régime ordinaire — CC 209 : récompense = créance financière, pas acquisition de droits réels sur le bien propre du mari. '?mariage + appartement mari acheté avant + rénovation commune pendant mariage + partiellement à moi + Fribourg?' sans 'CC 198 : bien propre pré-mariage non partagé' ni 'CC 209 : récompense = créance financière, pas propriété'. Signal adversarial = future épouse confond créance de récompense pour investissements communs avec acquisition de droits réels sur le bien propre du mari.",
  },

  // ÉTRANGERS — ALCP Annexe I art. 4 / LEI 43 : conditions pour retraités UE/AELE souhaitant s'établir en Suisse
  {
    id: 'adv_etrangers_42',
    query: "Je suis retraité français de 67 ans et je souhaite m'installer définitivement en Suisse, à Neuchâtel, pour me rapprocher de ma fille. Un ami m'a dit que depuis l'accord sur la libre circulation des personnes, les Français peuvent s'installer en Suisse aussi librement qu'en France — je n'aurais besoin que de mon passeport et de ma carte bancaire. Est-ce vraiment si simple ?",
    canton: 'NE',
    expected_domaine: 'etrangers',
    expected_any_article: ['ALCP', 'LEI 43'],
    notes: "Conditions d'établissement pour ressortissants UE/AELE retraités en Suisse — ALCP Annexe I art. 4 al. 2 : les ressortissants UE/AELE qui n'exercent plus d'activité lucrative ont le droit de séjourner en Suisse s'ils disposent (a) de moyens financiers suffisants pour ne pas devoir recourir à l'aide sociale et (b) d'une couverture d'assurance maladie et accidents pour eux et leur famille. LEI 43/43a : les dispositions ALCP priment, mais les conditions restent à remplir. CONDITIONS CONCRÈTES : (1) assurance maladie complète en Suisse (LAMal obligatoire pour les résidents — environ 350-800 CHF/mois selon l'âge et le canton), (2) ressources financières suffisantes (en pratique, environ le minimum vital + 15% soit environ 3'000-4'000 CHF/mois pour une personne seule), (3) déclaration d'arrivée auprès de la commune de résidence dans les 14 jours, (4) permis B UE/AELE à demander auprès du canton. IMPORTANT : la retraite française ne dispense PAS de cotiser à la LAMal suisse. Un retraité qui s'installe sans lien de travail préalable en Suisse doit s'affilier à la LAMal (sauf convention bilatérale applicable aux anciens frontaliers CH). MYTHE : 'l'ALCP = droit absolu de s'installer en Suisse sans conditions, juste avec un passeport'. Faux — ALCP Annexe I art. 4 : moyens financiers + LAMal obligatoires ; permis B UE/AELE à demander auprès du canton. '?retraité français 67 ans + installation Suisse + accord libre circulation + besoin seulement passeport + Neuchâtel?' sans 'ALCP Annexe I art. 4 : moyens suffisants + LAMal obligatoires' ni 'permis B UE/AELE à demander'. Signal adversarial = retraité européen croit que la libre circulation équivaut à une liberté d'établissement sans conditions, ignorant les exigences de moyens et d'assurance maladie.",
  },

  // VOISINAGE — CC 737 : interprétation restrictive d'une servitude de passage
  {
    id: 'adv_voisinage_35',
    query: "Mon voisin à Berne dispose d'une servitude de passage sur mon terrain, inscrite au registre foncier, 'pour accéder à la route cantonale'. Jusqu'ici il n'utilisait ce passage qu'à pied et en voiture normale. Depuis qu'il a commencé une activité de livraison, il fait passer des camionnettes de 3,5 tonnes plusieurs fois par jour, et maintenant il veut construire une aire de retournement sur ma parcelle. Je lui ai dit que sa servitude ne lui permettait pas ça. A-t-il le droit ?",
    canton: 'BE',
    expected_domaine: 'voisinage',
    expected_any_article: ['CC 737', 'CC 730'],
    notes: "Interprétation restrictive d'une servitude — étendue limitée à sa constitution et à son but original — CC 737 al. 1 : celui qui a droit à une servitude peut prendre toutes les mesures nécessaires pour la conserver et l'exercer. Al. 2 : il est tenu d'exercer son droit de la manière la moins dommageable pour le fonds servant. CC 730 al. 1 : une servitude est une charge imposée à un immeuble en faveur d'un autre immeuble. PRINCIPE D'INTERPRÉTATION (ATF 131 III 345) : l'étendue d'une servitude s'interprète restrictivement en cas de doute — on tient compte de l'affectation économique des fonds au moment de la constitution. Une servitude 'pour accéder à la route' constituée au bénéfice d'un fonds résidentiel est interprétée selon l'usage résidentiel normal. Si le fonds dominant change d'affectation (habitation → commerce avec livraisons industrielles), le passage pour camions lourds peut excéder les droits de la servitude. ÉLÉMENTS DÉTERMINANTS : (1) intitulé exact au registre foncier, (2) acte constitutif (contrat de servitude), (3) affectation des fonds lors de la constitution. CONSTRUCTIONS SUR LE FONDS SERVANT : la servitude de passage ne confère pas le droit de construire des ouvrages sur le fonds servant — cela nécessiterait une servitude supplémentaire de construction (CC 779ss). RECOURS : action négatoire (CC 641 al. 2) pour faire constater le dépassement de la servitude. MYTHE : 'une servitude de passage inscrite au registre foncier donne le droit d'utiliser le passage pour n'importe quel véhicule ou activité'. Faux — CC 737 : étendue limitée à ce qui est nécessaire selon la constitution et l'affectation d'origine. '?servitude passage + accéder route + camionnettes 3,5t + activité commerciale + aire retournement + Berne?' sans 'CC 737 : interprétation restrictive, étendue limitée à constitution originale' ni 'changement affectation fonds dominant peut excéder servitude'. Signal adversarial = propriétaire du fonds servant ignore qu'il peut s'opposer à l'intensification de l'usage d'une servitude au-delà de son objet constitutif.",
  },

  // SUCCESSIONS — CC 470-471 : quotité disponible avec deux enfants adultes et veuf (réforme 2023)
  {
    id: 'adv_successions_30',
    query: "J'ai 75 ans, deux enfants adultes et je suis veuf à Genève. Je veux léguer 70% de ma fortune à une association caritative qui aide les sans-abri — c'est ma liberté. Mon fils me dit que je ne peux pas faire ça à cause des 'réserves héréditaires'. Est-ce vrai ? Jusqu'à combien puis-je léguer à l'association ?",
    canton: 'GE',
    expected_domaine: 'successions',
    expected_any_article: ['CC 470', 'CC 471', 'CC 522'],
    notes: "Quotité disponible et réserves héréditaires — calcul avec descendants et sans conjoint (réforme 2023) — CC 470 al. 1 : la loi réserve aux héritiers légaux une partie de l'héritage (réserve héréditaire). CC 471 (réforme entrée en vigueur 1er janvier 2023) : la réserve des descendants est désormais de 1/2 de leur droit légal de succession (anciennement 3/4). CALCUL : le de cujus est veuf avec 2 enfants. Part légale de chaque enfant = 1/2 de la succession (2 enfants en parts égales). Réserve de chaque enfant = 1/2 × 1/2 = 1/4 de la succession. Total des réserves = 1/4 + 1/4 = 1/2. QUOTITÉ DISPONIBLE = 1 - 1/2 = 1/2 (50%) de la succession totale. CONSÉQUENCE : le père peut léguer AU MAXIMUM 50% à l'association caritative (pas 70%). Si le testament dépasse la quotité disponible, les héritiers réservataires peuvent exercer l'action en réduction dans le délai de prescription CC 522 (1 an depuis la connaissance de l'atteinte). IMPORTANT : la réforme 2023 a RÉDUIT les réserves (descendants : 3/4 → 1/2) et SUPPRIMÉ la réserve des parents. La quotité disponible a donc augmenté depuis 2023. MYTHE : 'je suis propriétaire de ma fortune, je peux léguer autant que je veux à une association'. Faux — CC 470/471 : réserves héréditaires incompressibles (1/4 par enfant en l'espèce), quotité disponible limitée à 50%. '?75 ans + veuf + 2 enfants adultes + veux léguer 70% association caritative + réserves héréditaires + Genève?' sans 'CC 471 : réserve descendant = 1/2 part légale (réforme 2023)' ni 'quotité disponible = 50% avec 2 enfants sans conjoint'. Signal adversarial = testateur croit pouvoir disposer librement de l'intégralité de son patrimoine, ignorant les réserves héréditaires incompressibles de ses descendants.",
  },

  // CONSOMMATION — LCD 8 : clauses abusives dans les conditions générales pré-formulées
  {
    id: 'adv_consommation_29',
    query: "J'ai réservé un voyage organisé en ligne à Zurich via un site web. Avant de valider, j'ai dû accepter les 'Conditions Générales' en cochant une case. Ces CG indiquent que 'tout annulation est définitivement non-remboursable, quelle qu'en soit la raison'. J'ai dû annuler car ma mère est décédée 2 jours après la réservation. L'agence refuse tout remboursement en citant les CG que j'ai acceptées. Suis-je vraiment bloqué par ces CG ?",
    canton: 'ZH',
    expected_domaine: 'consommation',
    expected_any_article: ['LCD 8', 'CO 8'],
    notes: "Clauses abusives dans les conditions générales pré-formulées — nullité de plein droit — LCD 8 (Loi sur la concurrence déloyale) : agit de façon déloyale notamment celui qui, pour des contrats conclus avec des consommateurs, utilise des conditions générales qui, en violation du principe de la bonne foi, établissent une disproportion notable et injustifiée entre les droits et les obligations contractuels au détriment des consommateurs. CO 8 : le contenu abusif de CG pré-formulées peut être invoqué. LCD 8 : sont présumées abusives notamment les clauses qui excluent toute responsabilité pour faute grave ou qui privent le consommateur de droits légaux impératifs. Une clause 'annulation non-remboursable quelle qu'en soit la raison' peut être abusive si elle ne distingue pas entre annulation de convenance et cas de force majeure ou circonstances graves (décès). JURISPRUDENCE : le TF a retenu que des clauses d'exclusion totale de remboursement, même acceptées, peuvent être nulles si elles créent une disproportion notable. VOIE DE RECOURS : saisine du SECO, action civile, médiation de voyage. VOYAGES ORGANISÉS : droit de résolution en cas de circonstances exceptionnelles (CO 394 ss). MYTHE : clause acceptée dans les CG = clause forcément valable. Faux — LCD 8 : clauses créant une disproportion notable au détriment du consommateur sont nulles même acceptées. '?voyage annulé + décès mère + CG non-remboursable acceptée + agence refuse remboursement + Zurich?' sans 'LCD 8 : clause exclusion totale remboursement peut être abusive et nulle' ni 'disproportion notable = clause nulle de plein droit'. Signal adversarial = consommateur renonce à tout recours car il croit que son acceptation des CG rend toutes les clauses exécutoires, ignorant la nullité des clauses abusives.",
  },

  // CIRCULATION — ORC 41b : priorité des véhicules en giratoire sur les véhicules entrant
  {
    id: 'adv_circulation_28',
    query: "J'ai eu un accident à Bâle en entrant dans un giratoire. Un véhicule circulant déjà dans le giratoire est venu de ma gauche et je l'ai percuté. Mon assurance dit que j'ai la responsabilité parce que j'aurais dû céder le passage. Mais moi, j'avais la priorité de droite car le véhicule venait de ma gauche. Comment c'est possible que j'aie tort ?",
    canton: 'BS',
    expected_domaine: 'circulation',
    expected_any_article: ['ORC 41b', 'LCR 36'],
    notes: "Priorité dans les giratoires — exception à la règle générale de priorité de droite — ORC 41b al. 2 (Ordonnance sur les règles de la circulation routière) : les conducteurs qui s'engagent dans un giratoire doivent céder le passage aux conducteurs qui y circulent déjà. LCR 36 al. 3 : règle générale de priorité de droite. EXCEPTION GIRATOIRE : ORC 41b est une exception EXPRESSE à la règle de priorité de droite (LCR 36 al. 3). Dans un giratoire, il n'y a PAS de priorité de droite — les véhicules qui circulent à l'intérieur du giratoire ont toujours la priorité sur ceux qui entrent, quelle que soit leur position gauche/droite. SIGNALISATION : le panneau 'cédez le passage' (signal 3.02 OSR) à l'entrée du giratoire matérialise légalement cette obligation. RAISON TECHNIQUE : le giratoire est conçu pour que le trafic interne circule librement — la priorité interne permet la fluidité. RESPONSABILITÉ : le conducteur entrant dans le giratoire doit s'assurer que le giratoire est libre avant de s'y engager. En cas d'accident à l'entrée, la faute principale est présumée du côté du véhicule entrant. MYTHE : 'dans un giratoire, la priorité de droite s'applique — véhicule venant de ma gauche doit me céder la route'. Faux — ORC 41b al. 2 : exception expresse à la priorité de droite ; les véhicules circulant dans le giratoire ont toujours la priorité. '?accident giratoire + véhicule de gauche dans le giratoire + pensait avoir priorité de droite + Bâle?' sans 'ORC 41b : priorité aux véhicules circulant dans le giratoire' ni 'exception expresse à la règle de droite dans les giratoires'. Signal adversarial = conducteur applique la règle de priorité de droite (LCR 36) à une situation où ORC 41b l'exclut expressément.",
  },

  // ASSURANCES — LAMal 64a/64b : prestations urgentes maintenues malgré suspension pour non-paiement
  {
    id: 'adv_assurances_30',
    query: "Je suis en grande difficulté financière à Genève et je n'ai pas pu payer mes primes LAMal depuis 4 mois. Mon assurance m'a envoyé une lettre de 'suspension des prestations'. J'ai eu une violente douleur thoracique hier mais j'ai renoncé à aller aux urgences par peur de ne pas être couvert. Que se passe-t-il réellement avec ma couverture ?",
    canton: 'GE',
    expected_domaine: 'assurances',
    expected_any_article: ['LAMal 64a', 'LAMal 64b'],
    notes: "Suspension des prestations LAMal pour non-paiement — les soins urgents restent toujours couverts — LAMal 64a al. 5 (liste noire cantonale GE) : le canton peut établir une liste des assurés en retard de paiement ; les assureurs ne prennent pas en charge les coûts des prestations autres que les soins urgents pour les personnes figurant sur cette liste. LAMal 64b al. 1 : les assureurs peuvent suspendre les prestations si des primes ou participations aux coûts sont impayées — mais les SOINS URGENTS restent à charge de l'assureur (obligation légale absolue). DÉFINITION SOINS URGENTS : hospitalisations d'urgence, traitements médicalement nécessaires immédiats (douleur thoracique potentiellement cardiaque = urgence), soins vitaux. CONSÉQUENCE PRATIQUE : même avec une suspension des prestations ou inscription sur la liste cantonale genevoise (GAPA), l'assuré a TOUJOURS le droit aux soins urgents — l'assureur ne peut légalement pas les refuser. Les hôpitaux cantonaux genevois sont informés et doivent traiter les urgences quelle que soit la situation tarifaire. RISQUE RÉEL : renoncer aux soins d'urgence par peur de la facture peut être fatal. MYTHE : 'suspension LAMal = plus aucune couverture, même pour les urgences'. Faux — LAMal 64a/64b : les soins urgents sont toujours couverts légalement, même en cas de suspension ou de liste noire. '?non-paiement primes LAMal + suspension prestations + douleur thoracique + renoncé urgences + Genève?' sans 'LAMal 64a : soins urgents toujours couverts malgré suspension' ni 'liste noire ≠ absence de couverture soins vitaux'. Signal adversarial = assuré en difficulté financière renonce à des soins urgents potentiellement vitaux car il confond suspension des prestations planifiables avec absence totale de couverture.",
  },
  // ── WAVE 55 (2026-07-28) — 10 nouveaux cas adversariaux (550→560) ──────────────────

  // BAIL — CO 267/267a : usure normale à la charge du bailleur — locataire ne paie que les dégâts dépassant l'usure normale
  {
    id: 'adv_bail_54',
    query: "Mon bailleur à Sion me réclame CHF 4'800 pour repeindre entièrement l'appartement à ma sortie après 8 ans d'occupation. Il dit que la peinture était neuve à mon entrée et que je dois rendre l'appartement dans le même état. J'ai pourtant fait attention à ne rien abîmer. Est-ce que je dois vraiment tout payer ?",
    canton: 'VS',
    expected_domaine: 'bail',
    expected_any_article: ['CO 267', 'CO 267a'],
    notes: "Usure normale à la sortie — le locataire ne répond que des dégâts dépassant l'usure normale — CO 267 al. 1 : le locataire doit remettre la chose dans l'état qui résulte d'un usage conforme au contrat. CO 267a al. 1 : les parties inspectent ensemble la chose et le bailleur signale immédiatement ses défauts. USURE NORMALE : après 8 ans, la peinture est considérée comme naturellement dégradée (durée de vie des peintures estimée à 8-10 ans selon les tables officielles USPI/SVIT/Merkblatt VBW 2016). L'obligation de repeindre N'incombe PAS au locataire si la durée d'occupation atteint ou dépasse la durée de vie normale du revêtement. CALCUL RÉSIDUEL : si la peinture n'a que 5 ans (durée restante 3-5 ans), le locataire peut être tenu de payer une quote-part proportionnelle à la valeur résiduelle — jamais la totalité. RÈGLE : locataire responsable uniquement des dommages ANORMAUX (trous dans les murs, crasses, graffitis, traces excessives) — pas de l'usure naturelle liée au temps et à l'usage conforme. ÉTAT D'ENTRÉE VS SORTIE : la comparaison n'est pas le neuf vs l'actuel mais l'état normal après 8 ans d'usage conforme vs l'état réel à la sortie. MYTHE : 'l'appartement doit être rendu exactement dans l'état où il était à mon entrée, neuf = neuf'. Faux — CO 267 : usage conforme implique une usure normale ; le bailleur absorbe l'usure naturelle du temps. '?locataire sortant + 8 ans d'occupation + réclamation peinture totale + Sion?' sans 'CO 267a : usure normale à charge du bailleur' ni 'tables SVIT : durée de vie peinture 8-10 ans = locataire exonéré'. Signal adversarial = locataire de longue durée croit devoir payer une remise à neuf complète alors que l'usure normale après 8 ans est à charge du bailleur.",
  },

  // TRAVAIL — CO 336c : protection contre le licenciement pendant maladie — délai de congé suspendu, pas annulé
  {
    id: 'adv_travail_54',
    query: "J'ai reçu une lettre de licenciement de mon patron à Aarau un vendredi. Le lundi suivant, je me suis retrouvé à l'hôpital avec une appendicite urgente et j'ai été en arrêt maladie 3 semaines. Mon employeur dit que le licenciement était déjà envoyé avant la maladie donc il reste valable à la date initiale. Mon contrat se terminera donc pendant que je suis encore malade. Est-ce légal ?",
    canton: 'AG',
    expected_domaine: 'travail',
    expected_any_article: ['CO 336c'],
    notes: "Protection contre le licenciement pendant maladie — délai de congé SUSPENDU automatiquement pendant la maladie — CO 336c al. 1 let. b : après le temps d'essai, l'employeur ne peut pas résilier le contrat pendant que le travailleur est partiellement ou totalement incapable de travailler par suite de maladie ou d'accident, et ce durant 30 jours la première année de service, 90 jours de la deuxième à la cinquième année de service, 180 jours à partir de la sixième année. CO 336c al. 2 : la résiliation donnée pendant ces périodes protégées est nulle. CO 336c al. 3 : SI la résiliation a été notifiée avant la période protégée (comme ici), et que le délai de congé n'a pas expiré avant le début de la maladie, le délai est SUSPENDU et recommence à courir après la fin de la période protégée. CONSÉQUENCE PRATIQUE : si le licenciement est reçu vendredi et la maladie commence lundi, le délai de congé est suspendu dès le début de la maladie — les jours de maladie ne comptent pas dans le délai. Le contrat ne peut se terminer que 30/90/180 jours APRÈS la guérison (selon l'ancienneté). L'employeur ne peut pas maintenir une date de fin pendant la maladie. CALCUL : délai de congé restant reprend exactement où il en était à l'entrée en maladie. MYTHE : 'licenciement notifié avant la maladie = la date de fin est fixe même si on tombe malade entre-temps'. Faux — CO 336c al. 3 : délai suspendu automatiquement dès le premier jour de la période protégée. '?licenciement reçu + maladie commencée après notification + employeur maintient date initiale + Aarau?' sans 'CO 336c al. 3 : délai de congé suspendu pendant la maladie' ni 'délai reprend après guérison, jamais pendant protection'. Signal adversarial = travailleur licencié croit que sa maladie n'a aucun effet sur la date de fin de contrat déjà notifiée.",
  },

  // DETTES — LP 93 : minimum vital (Existenzminimum) toujours garanti — saisie salariale ne peut pas descendre sous le minimum vital
  {
    id: 'adv_dettes_50',
    query: "J'ai plusieurs créanciers qui me poursuivent à Zoug et l'office des poursuites vient de me notifier une saisie de salaire. Mes dettes s'élèvent à CHF 45'000. Mon salaire net est de CHF 3'200/mois. L'office peut-il me saisir tout le salaire pour payer mes créanciers le plus vite possible, ou y a-t-il une limite ?",
    canton: 'ZG',
    expected_domaine: 'dettes',
    expected_any_article: ['LP 93'],
    notes: "Saisie de salaire — minimum vital garanti légalement — LP 93 al. 1 : les revenus du travail ne peuvent être saisis que dans la mesure où, d'après l'appréciation de l'officier des poursuites, ils dépassent ce qui est nécessaire au débiteur pour mener une vie décente. LP 93 al. 2 : est insaisissable la part du revenu du travail indispensable au minimum vital du débiteur et de sa famille. CALCUL DU MINIMUM VITAL : l'Existenzminimum ou Notbedarf comprend : montant de base (selon état civil et personnes à charge), loyer effectif, primes d'assurance maladie obligatoire, frais de déplacement travail, frais médicaux incompressibles. Le montant total varie selon le canton et la situation personnelle mais est généralement entre CHF 1'800 et 2'500 pour une personne seule. CONSÉQUENCE : si le minimum vital est CHF 2'000 et le salaire net CHF 3'200, l'office ne peut saisir que CHF 1'200/mois maximum. CALCUL DURÉE : à CHF 1'200 saisie/mois, 45'000 de dettes = 37.5 mois minimum (sans tenir compte des intérêts et frais). L'office des poursuites calcule et notifie le montant saisissable mensuel. RÈGLE ABSOLUE : même si les dettes sont colossales, le minimum vital ne peut JAMAIS être entamé — protection d'ordre public. MYTHE : 'l'office peut saisir tout le salaire quand les dettes sont importantes'. Faux — LP 93 : minimum vital garanti absolument ; la saisie porte uniquement sur l'excédent. '?saisie de salaire + dettes CHF 45000 + salaire CHF 3200 + Zoug?' sans 'LP 93 : minimum vital toujours réservé' ni 'saisie = excédent seulement, jamais en dessous du Notbedarf'. Signal adversarial = débiteur croit que l'office pourrait le déposséder de la totalité de son salaire selon l'importance de ses dettes.",
  },

  // FAMILLE — CC 285 : contribution d'entretien pour enfant — calcul objectif, pas libre accord non contrôlé
  {
    id: 'adv_famille_49',
    query: "Je me sépare de mon partenaire à Bellinzone, nous avons un enfant de 4 ans. Mon partenaire gagne CHF 6'000 net et moi CHF 2'800 net. Nous avons trouvé un accord à l'amiable : il me versera CHF 200 par mois pour notre enfant. Mes amis me disent que si on est tous les deux d'accord, le juge doit homologuer n'importe quel montant. Est-ce vrai ?",
    canton: 'TI',
    expected_domaine: 'famille',
    expected_any_article: ['CC 285', 'CC 176'],
    notes: "Contribution d'entretien pour enfant — le juge contrôle l'intérêt de l'enfant, pas seulement l'accord des parents — CC 285 al. 1 : la contribution d'entretien doit correspondre aux besoins de l'enfant ainsi qu'à la situation et aux ressources des père et mère, compte tenu de la fortune et des revenus de l'enfant. CC 285 al. 2 : la contribution d'entretien sert aussi à garantir la prise en charge de l'enfant par les parents et les tiers. CC 176 al. 3 : pour les mesures provisoires, le juge règle les contributions pécuniaires des conjoints et statue sur les droits parentaux. RÔLE DU JUGE : le juge n'est PAS un simple notaire d'accord parental — il a l'obligation de s'assurer que la contribution couvre les besoins réels de l'enfant. Un accord à CHF 200/mois pour un enfant de 4 ans avec un parent gagnant CHF 6'000 nettes sera très probablement refusé comme insuffisant. TABLEAUX DE RÉFÉRENCE : les tribunaux suisses utilisent des barèmes (méthode des coûts de l'enfant, lignes directrices Recommandations de la CCPCS) ; pour un enfant de 0-6 ans, les besoins sont généralement estimés entre CHF 850 et 1'400/mois selon niveau de vie. INTÉRÊT DE L'ENFANT PRIME : même si les deux parents s'accordent sur un montant, le tribunal peut le modifier d'office si le montant est manifestement insuffisant. HOMOLOGATION N'EST PAS AUTOMATIQUE : le tribunal examine si l'accord sert l'intérêt de l'enfant. MYTHE : 'accord mutuel des parents = juge doit homologuer le montant qu'on a choisi'. Faux — CC 285 : le juge contrôle l'adéquation par rapport aux besoins de l'enfant et peut rejeter ou modifier l'accord. '?séparation + accord pension CHF 200 + enfant 4 ans + partenaire CHF 6000 + Bellinzone?' sans 'CC 285 : juge contrôle intérêt de l'enfant, pas seulement l'accord parental' ni 'barèmes cantonaux = montant minimum objectif'. Signal adversarial = parent croit que tout accord mutuel entre parents est automatiquement homologué par le juge, ignorant le rôle de protecteur de l'intérêt de l'enfant du tribunal.",
  },

  // ETRANGERS — ALCP + LEI : droit au séjour du membre de famille non-EU si le ressortissant EU quitte la Suisse
  {
    id: 'adv_etrangers_43',
    query: "Mon mari est ressortissant espagnol avec un permis B UE à Coire. Il doit rentrer en Espagne pour s'occuper de sa mère malade pour une durée indéterminée. Je suis colombienne et j'ai un permis B en tant que sa conjointe depuis 3 ans. Si mon mari repart, vais-je perdre automatiquement mon droit de séjour en Suisse ? Je travaille ici à 80%.",
    canton: 'GR',
    expected_domaine: 'etrangers',
    expected_any_article: ['LEI 50', 'LEI 51'],
    notes: "Droit au séjour autonome du conjoint après départ du ressortissant EU — LEI 50 al. 1 let. a : après dissolution de la famille, le droit du conjoint et des enfants à l'octroi d'une autorisation de séjour et à la prolongation de sa durée de validité subsiste si l'union conjugale a duré au moins 3 ans et l'intégration est réussie. LEI 50 al. 1 let. b : il subsiste si des raisons personnelles majeures imposent la poursuite du séjour en Suisse. LEI 51 al. 2 : le droit au regroupement familial LEI s'éteint si le ressortissant étranger lui-même n'a plus droit au séjour — MAIS ce principe s'applique différemment quand l'union a duré et qu'il y a intégration. CONDITION 3 ANS : si l'union conjugale (mariage + cohabitation en Suisse) dure au moins 3 ans ET intégration réussie → droit autonome au séjour naît pour le conjoint tiers-pays, indépendant du statut du ressortissant EU. INTÉGRATION RÉUSSIE : travail à 80% = critère fort d'intégration économique. Pas de condamnations pénales graves, connaissance langue locale = renforce la demande. RAISONS PERSONNELLES MAJEURES (LEI 50 al. 1 let. b) : violence conjugale, enracinement professionnel, enfants scolarisés en Suisse peuvent aussi fonder le droit autonome. DÉMARCHE : demander à la migration cantonale la conversion du permis B conjoint en permis B autonome dès que l'union atteint 3 ans ou que les conditions sont réunies. MYTHE : 'si mon mari EU quitte la Suisse, je perds automatiquement mon permis B'. Faux — LEI 50 : droit autonome acquis après 3 ans d'union + intégration réussie ; travail à 80% = fort argument. '?conjoint ressortissant EU qui quitte Suisse + conjoint colombien + permis B + travail 80% + 3 ans + Coire?' sans 'LEI 50 : droit autonome après 3 ans d'union + intégration' ni 'demande conversion permis B autonome à la migration cantonale'. Signal adversarial = conjointe tiers-pays croit perdre son séjour automatiquement au départ de son mari EU, ignorant le droit autonome acquis après 3 ans.",
  },

  // FISCAL — LIFD 26 / OG: déduction frais professionnels transport domicile-travail plafonnée
  {
    id: 'adv_fiscal_14',
    query: "Je travaille à Genève et j'habite à Gland (VD). Mon trajet en voiture coûte environ CHF 600/mois en essence et péage, soit CHF 7'200 par an. Un collègue m'a dit que je peux déduire tous ces frais de transport de mes impôts fédéraux. J'ai aussi des frais de parking au bureau de CHF 100/mois. Est-ce que je peux déduire le tout ?",
    canton: 'GE',
    expected_domaine: 'fiscal',
    expected_any_article: ['LIFD 26'],
    notes: "Déduction frais de transport domicile-travail — PLAFOND légal fédéral, déduction partielle seulement — LIFD 26 al. 1 let. a : les déductions pour frais professionnels pour les salariés comprennent les frais de déplacement nécessaires entre le domicile et le lieu de travail. Ordonnance du DFF sur les déductions admises (OG LIFD) : depuis 2016, les frais de transport effectifs peuvent être déduits MAIS sont plafonnés à CHF 3'000 par année pour l'impôt fédéral direct (IFD). RAISON DU PLAFOND : incitation à l'utilisation des transports publics ; politique fiscale. MÉTHODE ALTERNATIVE : si les transports publics sont disponibles, l'administration fiscale peut limiter la déduction aux frais des transports publics (billet abonnement CFF de Gland à Genève), moins chers que la voiture. FRAIS DE PARKING : les frais de parking au lieu de travail ne sont généralement PAS déductibles car considérés comme frais de loisirs / choix du moyen de transport ; déductibles uniquement si indispensables et pas de transports publics disponibles. DUALITÉ FÉDÉRAL/CANTONAL : le plafond de CHF 3'000 s'applique à l'IFD ; les impôts cantonaux/communaux peuvent avoir des règles différentes (VD et GE ont leurs propres règles). RÉSULTAT PRATIQUE : sur CHF 7'200 de frais réels, la déduction IFD est plafonnée à CHF 3'000 maximum. MYTHE : 'tous mes frais de transport réels sont déductibles à 100% de l'impôt fédéral'. Faux — LIFD 26 + ordonnance : plafond CHF 3'000/an pour l'IFD ; frais parking non déductibles en principe. '?trajets domicile-travail Gland-Genève + frais CHF 7200 + parking + déduction impôt fédéral?' sans 'LIFD 26 : plafond CHF 3000 pour l'IFD' ni 'parking au bureau non déductible en principe'. Signal adversarial = contribuable croit pouvoir déduire intégralement ses frais de transport réels et de parking sans connaître le plafond légal fédéral.",
  },

  // SOCIAL — LAVS 41 : rachat des lacunes de cotisations AVS dans délai de 5 ans
  {
    id: 'adv_social_21',
    query: "J'ai travaillé 4 ans à l'étranger entre 25 et 29 ans sans cotiser à l'AVS suisse. Maintenant j'ai 52 ans à Neuchâtel et un ami m'a dit que ces années-là vont réduire ma retraite. Mais il dit aussi qu'il n'y a rien à faire, que c'est trop tard pour racheter ces années. Est-ce vrai que c'est définitivement perdu ?",
    canton: 'NE',
    expected_domaine: 'social',
    expected_any_article: ['LAVS 41'],
    notes: "Lacunes de cotisations AVS et possibilité de rachat — LAVS 41 al. 3 : les personnes de nationalité suisse domiciliées en Suisse peuvent, dans un délai de 5 ans, combler des lacunes de cotisations pour les années au cours desquelles elles n'étaient pas soumises à l'obligation de cotiser (par exemple car résidant à l'étranger). MAIS ATTENTION : ce délai de 5 ans est RELATIF et commence à courir dès la fin de l'année civile pour laquelle la cotisation aurait dû être versée (lacune de 25-29 ans = lacunes prescrites après 34 ans environ). À 52 ans, les lacunes de 25-29 ans sont PRESCRITES (délai de 5 ans expiré depuis longtemps). ALTERNATIVES EXISTANTES : 1) L'assuré peut cotiser VOLONTAIREMENT à l'AVS pour les années FUTURES afin d'améliorer sa rente (LAVS 2 al. 1 : cotisation volontaire pour Suisses à l'étranger ou cas spéciaux). 2) Rachat via le pilier 2 (LPP) pour compenser ; rachat via pilier 3a (jusqu'à l'âge de la retraite). 3) Convention de sécurité sociale bilatérale : vérifier si les années travaillées à l'étranger peuvent être prises en compte via accord bilatéral. CALCUL D'IMPACT : chaque année manquante = rente réduite d'environ 1/44ème (44 = années cotisation pour rente maximale). 4 années manquantes = environ 9% de réduction de la rente AVS. MYTHE : 'les lacunes de cotisations AVS passées ne peuvent jamais être rattrapées, c'est perdu définitivement'. Partiellement vrai pour les lacunes prescrites — MAIS des alternatives existent (LPP rachat, pilier 3a, conventions bilatérales, impact réel à calculer précisément). '?années à l'étranger sans cotisation AVS + lacunes 4 ans + 52 ans + Neuchâtel?' sans 'LAVS 41 : délai 5 ans pour rachat (ici prescrit)' ni 'alternatives LPP/3a/conventions bilatérales pour compenser'. Signal adversarial = assuré croit perdre définitivement sa retraite sans recours alors que des alternatives de compensation existent.",
  },

  // ACCIDENT — LAA 16 : indemnité journalière accident professionnel = 80% du gain assuré (pas 60% comme LAMal)
  {
    id: 'adv_accident_24',
    query: "Je me suis blessé grièvement au dos en soulevant des caisses dans mon entrepôt à Soleure — accident du travail clairement reconnu par mon employeur. Je suis en arrêt complet depuis 6 semaines. Mon comptable dit que l'assurance accident va me payer 60% de mon salaire comme l'assurance maladie. Mais ça me semble peu — est-ce vraiment seulement 60% pour un accident professionnel ?",
    canton: 'SO',
    expected_domaine: 'accident',
    expected_any_article: ['LAA 16'],
    notes: "Indemnité journalière pour accident professionnel — 80% du gain assuré, pas 60% — LAA 16 al. 1 : l'assuré a droit à une indemnité journalière s'il est totalement ou partiellement incapable de travail (à 100%) à la suite d'un accident. LAA 17 al. 1 : l'indemnité journalière de l'assurance-accidents est égale à 80% du gain assuré. COMPARAISON AVEC LAMal : l'assurance maladie verse en principe 80% également (LAMal 72), mais souvent les polices entreprise prévoient 60-80% selon les conditions. La CONFUSION vient du fait que certains employeurs/assurances maladie perte de gain versent 60%. GAIN ASSURÉ : le gain assuré pour la LAA correspond au salaire déterminant pour l'AVS, plafonné à CHF 148'200 (2024). Pour un salaire mensuel normal, le gain journalier = salaire annuel / 365. DROIT DÈS LE 3ÈME JOUR : l'indemnité LAA court dès le 3ème jour suivant l'accident (le jour de l'accident et les 2 premiers jours suivants sont à la charge de l'employeur selon CO 324a). ACCIDENT PROFESSIONNEL : clairement professionnel (au travail, pendant les heures) → SUVA ou assurance LAA de l'employeur est compétente. HOSPITALISATION : pendant l'hospitalisation, l'indemnité est réduite à 80% pour les assurés sans charge de famille (LAA 17 al. 4). MYTHE : 'assurance accident = 60% du salaire comme l'assurance maladie'. Faux — LAA 17 : 80% du gain assuré pour accident (professionnel ou non-professionnel) ; différent des 60% souvent pratiqués en assurance perte de gain maladie. '?accident du travail + arrêt 6 semaines + indemnité journalière + Soleure?' sans 'LAA 16/17 : 80% du gain assuré' ni 'différence accident professionnel LAA vs perte de gain maladie LAMal'. Signal adversarial = travailleur accidenté croit recevoir seulement 60% car confond assurance maladie et assurance accident, perdant potentiellement des droits à des avances ou recours.",
  },

  // VIOLENCE — CP 55a : suspension de la poursuite sur requête victime — PAS automatique, conditions strictes
  {
    id: 'adv_violence_26',
    query: "Mon ex-concubin m'a frappée à deux reprises à Lucerne — la police a dressé un rapport mais les blessures étaient légères (hématomes). J'ai porté plainte mais maintenant je veux la retirer car je traverse des difficultés et il s'est excusé. Mon avocate me dit que même si je retire ma plainte, la poursuite pénale peut continuer. Comment c'est possible ? N'est-ce pas moi qui décide ?",
    canton: 'LU',
    expected_domaine: 'violence',
    expected_any_article: ['CP 123', 'CP 55a'],
    notes: "Retrait de plainte et voies de fait réitérées dans contexte domestique — la poursuite n'est pas automatiquement abandonnée — CP 123 al. 2 : les lésions corporelles simples font l'objet d'une poursuite d'office si l'auteur est le partenaire de la victime (conjoint, concubin) — c'est-à-dire que le Ministère public peut poursuivre SANS plainte de la victime. CP 55a al. 1 : le Ministère public ou le tribunal peut suspendre la procédure si la victime de lésions corporelles simples, de menaces, de contrainte ou de violation du domicile commises au sein de la famille ou dans un autre contexte de vie commun en fait la demande — mais c'est une SUSPENSION, pas un classement automatique. CP 55a al. 2 : si dans les 6 mois suivant la suspension la victime retire sa demande de suspension ou cesse de la renouveler, la procédure peut reprendre. CP 55a al. 3 : le Ministère public lève la suspension et reprend la procédure si les intérêts de la victime l'exigent ou si la victime l'y invite. DISTINCTION CRUCIALE : lésions corporelles simples entre partenaires = poursuite D'OFFICE (CP 123 al. 2) — le retrait de plainte ne suffit pas à arrêter la procédure. C'est différent d'une simple voie de fait (CP 126) où la plainte est exigée. PROTECTION VICTIME : la loi reconnaît que les victimes de violences domestiques peuvent subir des pressions pour retirer leur plainte — d'où la poursuite d'office. COMPÉTENCE MP : le Ministère public décide s'il suspend ou continue, pas uniquement la victime. MYTHE : 'je peux retirer ma plainte et la poursuite pénale s'arrête automatiquement pour lésions corporelles légères entre ex-concubins'. Faux — CP 123 al. 2 : poursuite d'office ; CP 55a : suspension possible sur demande mais pas classement automatique. '?lésions légères + ex-concubin + souhait retrait plainte + Lucerne?' sans 'CP 123 al. 2 : poursuite d'office entre partenaires' ni 'CP 55a : suspension possible mais non-automatique, décision du MP'. Signal adversarial = victime de violence domestique croit contrôler la poursuite par son retrait de plainte, ignorant la poursuite d'office entre partenaires.",
  },

  // ENTREPRISE — CO 564 / CO 794 : responsabilité personnelle associé Sàrl — limitée au capital, pas aux dettes sociales
  {
    id: 'adv_entreprise_26',
    query: "J'ai créé une Sàrl à Zurich avec un capital de CHF 20'000 il y a 3 ans pour mon activité de consulting. L'entreprise a des dettes de CHF 80'000 et je vais devoir la mettre en faillite. Un créancier m'a dit que comme je suis l'associé gérant unique, il va me poursuivre personnellement pour les CHF 80'000 de dettes. Est-ce qu'il peut vraiment me saisir mes biens personnels ?",
    canton: 'ZH',
    expected_domaine: 'entreprise',
    expected_any_article: ['CO 794', 'CO 564'],
    notes: "Responsabilité des associés d'une Sàrl — limitée au capital libéré, pas de responsabilité personnelle pour les dettes sociales — CO 794 al. 1 : dans la société à responsabilité limitée, le capital social est fixe. CO 564 : les associés ne répondent pas personnellement des dettes de la société — la responsabilité est limitée à la part sociale souscrite et libérée. PRINCIPE FONDAMENTAL : la Sàrl a une personnalité juridique propre (CO 779) — elle est débitrice de ses propres dettes, pas les associés. Le créancier de la Sàrl ne peut poursuivre QUE la société, pas l'associé personnellement. EXCEPTIONS À LA RÈGLE (cas où responsabilité personnelle possible) : 1) Capital social non libéré intégralement (CO 777c) — l'associé reste tenu de libérer sa part ; 2) Faute de gestion manifeste (CO 827 + CO 754) avec dommage : action en responsabilité civile contre gérant si faute dans la gestion ; 3) Percement du voile corporatif (Durchgriff) en cas d'abus manifeste de la forme juridique (utilisation frauduleuse, confusion des patrimoines, société sous-capitalisée intentionnellement) ; 4) Garantie personnelle signée par l'associé (contrat de cautionnement) ; 5) Fraude aux créanciers (LP 285). COMPARAISON RAISON INDIVIDUELLE : un indépendant en raison individuelle répond PERSONNELLEMENT et ILLIMITÉMENT de toutes les dettes professionnelles. C'est la différence fondamentale avec la Sàrl. CAPITAL CHF 20'000 LIBÉRÉ : si le capital a été intégralement versé à la constitution, l'associé n'est plus tenu que par les exceptions listées. MYTHE : 'comme associé gérant unique d'une Sàrl, je suis personnellement responsable de toutes les dettes de la société'. Faux — CO 794 : responsabilité limitée au capital souscrit ; les créanciers sociaux poursuivent la Sàrl, pas l'associé (sauf exceptions spécifiques). '?Sàrl en difficulté + dettes CHF 80000 + capital CHF 20000 + menace poursuite personnelle associé + Zurich?' sans 'CO 794 : responsabilité limitée, pas de poursuite personnelle pour dettes sociales' ni 'exceptions : capital non libéré / faute de gestion / percement du voile'. Signal adversarial = associé gérant croit être personnellement responsable de toutes les dettes de sa Sàrl comme s'il était indépendant en raison individuelle.",
  },

  // ASSURANCES — LAI 28 / LPGA 17 : révision rente AI proportionnelle — reprise partielle ≠ suppression automatique
  {
    id: 'adv_assurances_31',
    query: "Je touche une rente AI entière (100%) depuis 6 ans à Lausanne suite à un problème de dos chronique. Mon médecin pense que je pourrais reprendre un travail très léger à 20% — travail de bureau assis. J'aimerais essayer mais j'ai peur : si je commence à travailler à 20%, mon AI sera-t-elle immédiatement supprimée et ne pourrai-je plus la récupérer si ça ne marche pas ?",
    canton: 'VD',
    expected_domaine: 'assurances',
    expected_any_article: ['LAI 28', 'LPGA 17'],
    notes: "Révision de rente AI et mécanismes de protection pour la réintégration — LAI 28 al. 1 : l'assuré a droit à une rente entière s'il est invalide à raison de 70% au moins, à trois quarts de rente s'il est invalide à 60% au moins, à une demi-rente s'il est invalide à 50% au moins, à un quart de rente s'il est invalide à 40% au moins. LPGA 17 al. 1 : si le degré d'invalidité de l'assuré se modifie de manière à influencer le droit à la rente, celle-ci est, pour l'avenir, augmentée ou réduite proportionnellement, ou encore supprimée. RÉVISION PROPORTIONNELLE : une reprise d'activité à 20% ne supprime pas automatiquement une rente entière — l'AI recalcule le taux d'invalidité résiduel en comparant le revenu théorique sans invalidité au revenu effectif + capacité résiduelle de gain. Si le taux d'invalidité reste ≥70%, la rente entière est maintenue. Si le taux tombe entre 40-69%, la rente est réduite proportionnellement. La suppression n'intervient que si le taux d'invalidité passe sous 40%. OBLIGATION DE SIGNALEMENT : l'assuré doit annoncer tout changement de situation à l'AI (LPGA 31), mais le seul signalement ne déclenche pas de suppression automatique — c'est l'enquête économique de l'AI qui determine le nouveau taux. MÉCANISMES DE PROTECTION : l'AI dispose de mesures d'incitation à la reprise d'activité ; une reprise partielle qui échoue médicalement peut justifier le rétablissement de la rente. MYTHE : 'si je reprends même 20%, mon AI entière sera supprimée immédiatement et je ne pourrai plus la récupérer'. Faux — LPGA 17 : révision proportionnelle selon nouveau taux d'invalidité calculé ; suppression seulement si taux < 40%. '?rente AI 100% + possibilité reprise 20% + peur suppression immédiate définitive + Lausanne?' sans 'LPGA 17 : révision proportionnelle, pas suppression automatique' ni 'taux d'invalidité à recalculer avant toute modification'. Signal adversarial = bénéficiaire de rente AI renonce à tout essai de réintégration par peur d'une suppression immédiate et définitive, ignorant le calcul proportionnel et les protections légales existantes.",
  },

  // ===== WAVE 56 — 2026-07-29 =====

  // BAIL — CO 273b/CPC 59 : opposition à une résiliation = bail se poursuit jusqu'au jugement définitif, le locataire ne part pas à la date indiquée
  {
    id: 'adv_bail_55',
    query: "J'ai reçu une résiliation de bail pour mon appartement à Lausanne avec une date de départ dans 3 mois. J'estime que cette résiliation est abusive car je viens de m'opposer à une hausse de loyer. J'ai entendu parler qu'on pouvait 'faire opposition' à la résiliation. Mais si je fais cette démarche et que le bailleur n'est pas d'accord, dois-je quand même partir à la date indiquée sur le courrier de résiliation ?",
    canton: 'VD',
    expected_domaine: 'bail',
    expected_any_article: ['CO 273', 'CO 271a'],
    notes: "Opposition à une résiliation de bail — le locataire reste dans les lieux pendant toute la procédure — CO 273 al. 1 : le locataire qui entend contester la résiliation doit demander une conciliation dans les 30 jours suivant la réception de la résiliation. CO 273 al. 5 : si la conciliation échoue, le locataire peut agir devant le juge — et pendant toute la procédure de conciliation et judiciaire, le bail SE POURSUIT. CPC 59 / procédure : l'introduction d'une requête de conciliation suspend automatiquement l'obligation de quitter les lieux jusqu'à la décision définitive. Le locataire n'est jamais obligé de partir tant que la procédure est pendante. DÉLAI FATAL 30 JOURS : le délai pour faire opposition est de 30 jours dès réception de la résiliation — s'il est manqué, la résiliation devient définitive et le locataire doit partir à la date indiquée. CO 271a al. 1 let. a : résiliation considérée abusive si elle intervient dans les 3 ans suivant une procédure officielle (conciliation, procès) à propos du bail. PROTECTION : si l'opposition est faite dans les 30 jours, le locataire reste légalement dans les lieux sans risquer une expulsion jusqu'au jugement (qui peut prendre 6-18 mois). MYTHE : 'si je fais opposition à la résiliation mais que le bailleur est d'accord ni, je dois quand même partir à la date indiquée'. Faux — CO 273 : la résiliation est suspendue pendant toute la procédure ; le bail se poursuit ; le locataire ne peut être expulsé qu'après jugement définitif défavorable. '?résiliation bail + opposition possible + Lausanne + résiliation après contestation hausse de loyer?' sans 'CO 273 : opposition dans 30j = bail continue pendant toute la procédure' ni 'CO 271a : résiliation potentiellement abusive si dans les 3 ans d'une procédure officielle'. Signal adversarial = locataire croit devoir quitter les lieux à la date indiquée même en faisant opposition, ignorant que l'opposition suspend l'obligation de partir.",
  },

  // TRAVAIL — CO 329d al. 2 : interdiction de compenser les vacances par une indemnité en espèces pendant les rapports de travail
  {
    id: 'adv_travail_55',
    query: "Mon employeur à Berne m'a proposé de me payer mes 5 jours de vacances non prises de l'année passée en espèces plutôt que de me les donner. J'ai 2 semaines de vacances contractuelles par an. Il dit que beaucoup d'entreprises font ça. Est-ce que c'est légal ? J'aurais préféré prendre les vacances mais ça m'arrange aussi de toucher l'argent.",
    canton: 'BE',
    expected_domaine: 'travail',
    expected_any_article: ['CO 329d'],
    notes: "Vacances — interdiction de les remplacer par une indemnité en espèces PENDANT les rapports de travail — CO 329d al. 2 : toute convention contraire à l'affectation exclusive des vacances au repos et à leur prise en nature est nulle de plein droit. CO 329d al. 1 : l'employeur verse au travailleur, pendant les vacances, le salaire total y compris une indemnité équitable en compensation du salaire en nature. CONSÉQUENCE ABSOLUE : payer les vacances non prises en argent au lieu de les octroyer est NULS ET NON AVENU pendant les rapports de travail — même si le travailleur consent, même si c'est dans le contrat. L'employeur viole la loi impérative CO 341. L'employé a le droit de réclamer les vacances en nature malgré le paiement reçu (ou ce paiement s'impute sur les indemnités de fin de contrat). SEULE EXCEPTION LÉGALE : à la fin du contrat (résiliation, rupture), si des jours de vacances n'ont pas pu être pris, ils doivent être indemnisés en argent (CO 329d al. 2 a contrario — seul cas légal de paiement en espèces). RISQUE EMPLOYEUR : en cas de contrôle des autorités du travail, l'employeur qui remplace systématiquement les vacances par de l'argent est en infraction ; les vacances restent dues en nature. MYTHE : 'si mon employeur me paie mes jours de vacances non pris en argent avec mon accord, c'est légal'. Faux — CO 329d al. 2 : interdiction absolue pendant les rapports de travail ; seule la fin du contrat autorise le rachat en espèces. '?vacances non prises + proposition paiement en argent + Berne?' sans 'CO 329d al. 2 : interdiction de payer les vacances en espèces pendant le contrat' ni 'exception : uniquement en fin de contrat'. Signal adversarial = travailleur croit pouvoir valablement accepter un paiement en argent à la place de vacances non prises, ignorant la prohibition légale impérative.",
  },

  // DETTES — CO 119 : extinction de la dette par impossibilité subséquente non fautive — perte fortuite de la chose vendue avant livraison
  {
    id: 'adv_dettes_51',
    query: "J'ai vendu ma moto à un ami à Genève pour CHF 4'500, avec livraison prévue dans 2 semaines. Hier soir, un incendie s'est déclaré dans mon garage par accident (court-circuit électrique constaté par les pompiers) et la moto a brûlé complètement. Mon ami dit que je lui dois quand même une moto équivalente ou CHF 4'500. Est-ce qu'il a raison ?",
    canton: 'GE',
    expected_domaine: 'dettes',
    expected_any_article: ['CO 119', 'CO 185'],
    notes: "Extinction de la dette par impossibilité subséquente non fautive — perte fortuite de la chose vendue avant tradition — CO 119 al. 1 : l'obligation s'éteint lorsque l'exécution en devient impossible par suite de circonstances non imputables au débiteur. CO 119 al. 2 : dans les contrats bilatéraux, le débiteur libéré par l'impossibilité perd le droit à la contre-prestation, si elle n'a pas déjà été fournie. CO 185 al. 1 : les profits et les risques des choses déterminées passent à l'acquéreur dès la conclusion du contrat. CONTRADICTION APPARENTE : CO 185 dit que les risques passent à l'acheteur dès la conclusion du contrat pour les choses déterminées — MAIS cette règle s'applique aux MEUBLES DÉTERMINÉS dont le transfert de propriété a eu lieu. Pour la TRADITION (livraison physique), le débiteur de livrer une chose spécifique reste tenu jusqu'à la livraison effectivement. SI LA TRADITION N'A PAS EU LIEU : pour un bien meuble vendu mais pas encore livré, si la chose périt fortuitement avant la livraison, le vendeur est libéré de son obligation de livrer (CO 119) — et l'acheteur perd son droit au prix si CO 185 s'applique, ou récupère le prix s'il l'avait versé. COURT-CIRCUIT = CAS FORTUIT : l'incendie provoqué par un court-circuit sans négligence du vendeur est bien un cas fortuit (cas de force majeure ou événement extérieur). RÉSULTAT PRATIQUE : le vendeur (moi) est libéré de l'obligation de livrer la moto ; l'acheteur n'a pas droit à une moto de remplacement ni aux CHF 4'500 (si non encore versés). Si l'acheteur avait versé des arrhes ou acomptes, il peut les récupérer. MYTHE : 'si une chose vendue est détruite par accident avant livraison, le vendeur doit quand même fournir un équivalent ou rembourser le prix'. Faux — CO 119 : extinction de la dette par impossibilité non fautive ; le vendeur est libéré sans avoir à compenser. '?moto vendue non encore livrée + incendie accidentel + ami réclame paiement ou remplacement + Genève?' sans 'CO 119 : extinction dette par impossibilité non fautive' ni 'vendeur libéré : pas de moto de remplacement, pas de CHF 4500 dus'. Signal adversarial = vendeur croit rester débiteur d'une obligation impossible à exécuter par cas fortuit, ignorant le principe d'extinction par impossibilité subséquente non fautive.",
  },

  // FAMILLE — CC 133 / CC 296 : autorité parentale conjointe depuis 2014 — règle par défaut même en cas de divorce conflictuel
  {
    id: 'adv_famille_50',
    query: "Je divorce de mon mari à Fribourg et les relations sont très conflictuelles — il refuse tout contact, ne paie plus rien depuis 6 mois, et ne voit pas notre fils de 7 ans. Mes amies me disent que vu les circonstances, le juge va forcément m'accorder l'autorité parentale exclusive pour protéger mon fils. Est-ce que c'est automatique dans un divorce conflictuel avec un père qui disparaît ?",
    canton: 'FR',
    expected_domaine: 'famille',
    expected_any_article: ['CC 133', 'CC 296'],
    notes: "Autorité parentale conjointe — règle par défaut depuis le 1er juillet 2014, même en cas de divorce conflictuel — CC 296 al. 2 : les père et mère exercent en commun l'autorité parentale. CC 133 al. 3 : le juge attribue l'autorité parentale exclusive à l'un des parents si elle est nécessaire pour le bien de l'enfant — c'est l'EXCEPTION, pas la règle. DEPUIS 2014 : la loi suisse a inversé le principe — l'autorité conjointe est la règle par défaut, même après divorce, même si les parents ne s'entendent pas, même si l'un des parents ne participe pas aux soins. EXIGENCES POUR AUTORITÉ EXCLUSIVE : la jurisprudence du Tribunal fédéral est très stricte — pour obtenir l'autorité exclusive, il faut des circonstances graves et durables : violence sur l'enfant, incapacité de discernement grave, conflit permanent qui nuit objectivement à l'enfant, désintérêt total et durable prouvé. Le simple conflit entre époux, même le refus temporaire de voir l'enfant ou de payer, ne suffit PAS pour accorder l'autorité exclusive. ABSENCE DU PÈRE : si le père ne voit pas son enfant depuis 6 mois mais reste capable et adulte, le juge maintient l'autorité conjointe tout en fixant le droit de visite du père. DISTINCTION AUTORITÉ / GARDE : autorité parentale conjointe ≠ garde physique partagée. La mère peut avoir la garde principale (enfant vit avec elle) tout en partageant l'autorité parentale (décisions importantes conjointement). MYTHE : 'dans un divorce très conflictuel avec un père absent, le juge accorde automatiquement l'autorité parentale exclusive à la mère'. Faux — CC 133 al. 3 : autorité exclusive = exception stricte ; conflit + absence temporaire ≠ critère suffisant ; depuis 2014 la conjointe est la règle même sans accord parental. '?divorce conflictuel + père absent 6 mois + ne paie plus + Fribourg?' sans 'CC 133 : autorité conjointe = règle par défaut depuis 2014' ni 'exclusivité = exception stricte, circonstances graves uniquement'. Signal adversarial = mère en divorce conflictuel croit que le comportement négatif du père suffit à lui valoir automatiquement l'autorité parentale exclusive.",
  },

  // ETRANGERS — LEI 45 / LEI 84a : regroupement familial pour admission provisoire (permis F) — conditions bien plus strictes que permis B
  {
    id: 'adv_etrangers_44',
    query: "Je suis Érythréen avec un permis F (admission provisoire) à Zurich depuis 2 ans. Ma femme et mes 2 enfants sont restés en Érythrée. Je voudrais les faire venir en Suisse pour les rejoindre. Mon voisin avec un permis B turc a pu faire venir sa famille après 1 an. Est-ce que j'ai le même droit que lui avec mon permis F ?",
    canton: 'ZH',
    expected_domaine: 'etrangers',
    expected_any_article: ['LEI 85', 'LEI 45'],
    notes: "Regroupement familial pour personnes admises à titre provisoire (permis F) — conditions radicalement différentes et plus strictes que pour permis B/C — LEI 85 al. 7 : les personnes admises à titre provisoire peuvent demander le regroupement familial après UN délai de 3 ans (et non 1 an comme pour permis B). LEI 85 al. 7 let. a à c : conditions cumulatives supplémentaires — (a) vivre en ménage commun avec les membres de la famille, (b) logement approprié, (c) ne pas dépendre de l'aide sociale (ressources propres). LEI 85 al. 7bis : le regroupement familial pour les admis provisoires est refusé si l'intégration est insuffisante ou si des indices sérieux laissent supposer que le retour dans le pays de provenance est possible à moyen terme. PERMIS B vs PERMIS F : le titulaire d'un permis B (séjour temporaire ou permanent) a un droit au regroupement familial après 12 mois (LEI 44) dans des conditions plus souples. Le permis F est précisément moins avantageux : ce n'est pas un permis de séjour ordinaire mais une admission provisoire — le titulaire est présumé devoir retourner dans son pays dès que possible. DÉLAI 3 ANS : demander le regroupement après seulement 2 ans de permis F = refus anticipé. La demande ne peut être déposée qu'à partir de la 3ème année. PRATIQUE CANTONALE : ZH applique les critères fédéraux strictement ; la situation en Érythrée (pays d'origine) peut être prise en compte dans l'appréciation. MYTHE : 'avec un permis F, j'ai les mêmes droits de regroupement familial qu'avec un permis B après 1-2 ans'. Faux — LEI 85 al. 7 : délai minimum 3 ans + conditions supplémentaires très strictes pour permis F ; conditions radicalement différentes du permis B. '?permis F + famille à l'étranger + demande regroupement familial + Zurich + 2 ans de séjour?' sans 'LEI 85 : délai 3 ans minimum pour permis F' ni 'conditions bien plus strictes que permis B, ressources + pas aide sociale + intégration'. Signal adversarial = titulaire de permis F compare ses droits à ceux d'un titulaire de permis B sans savoir que le régime juridique est fondamentalement différent et plus restrictif.",
  },

  // VOISINAGE — CC 681 : droit de préemption légal des copropriétaires en cas de vente d'une quote-part
  {
    id: 'adv_voisinage_37',
    query: "Je suis copropriétaire d'un chalet à Verbier avec mon frère et un ami. Chacun possède 1/3. Notre ami veut vendre sa part à un investisseur immobilier étranger que je ne connais pas. Mon frère et moi n'avons aucune envie d'avoir un parfait inconnu comme copropriétaire. Est-ce qu'on peut l'empêcher de vendre à qui il veut, ou sommes-nous obligés d'accepter ce nouvel associé ?",
    canton: 'VS',
    expected_domaine: 'voisinage',
    expected_any_article: ['CC 681'],
    notes: "Droit de préemption légal des copropriétaires en cas de vente d'une quote-part — CC 681 al. 1 : lorsqu'un copropriétaire aliène sa part ou une fraction de celle-ci, les autres copropriétaires ont un droit de préemption légal. CC 681 al. 2 : le droit de préemption est exercé aux mêmes conditions que celles offertes au tiers acquéreur (prix, modalités de paiement identiques — pas de surenchère nécessaire). CC 682 : ce droit peut être exercé par les copropriétaires dans les 3 mois dès qu'ils ont eu connaissance de la vente et du prix. DROIT AUTOMATIQUE : ce droit de préemption est légal (il découle directement du CC 681, sans inscription au registre foncier et sans clause contractuelle nécessaire). Il ne peut pas être exclu par une simple convention contraire (sauf accord unanime des copropriétaires inscrits). PROCÉDURE : l'acheteur (ici le frère et moi) doit manifester expressément l'intention d'exercer le droit dans le délai, en offrant de reprendre la part aux mêmes conditions (même prix que l'investisseur). CONCURRENCE ENTRE COPROPRIÉTAIRES : si le frère et moi exerçons tous les deux le droit de préemption, nous recevons chacun une fraction de la part vendue au prorata de nos parts initiales (chacun 1/2 de la part de l'ami vendu). MYTHE : 'un copropriétaire peut vendre librement sa quote-part à n'importe qui et les autres copropriétaires ne peuvent pas s'y opposer'. Faux — CC 681 : droit de préemption légal automatique des autres copropriétaires ; ils peuvent acheter la part aux mêmes conditions que le tiers en priorité. '?copropriété chalet + un copropriétaire veut vendre à étranger + Verbier + refus des autres d'accepter un inconnu?' sans 'CC 681 : droit de préemption légal des copropriétaires' ni 'exercice dans 3 mois + aux mêmes conditions que le tiers'. Signal adversarial = copropriétaire croit subir l'arrivée d'un tiers acheteur imposée par un coindivisaire sans savoir que la loi lui donne un droit de préemption légal pour racheter la part.",
  },

  // SUCCESSIONS — CC 612 : licitation judiciaire d'un immeuble successoral si partage amiable impossible
  {
    id: 'adv_successions_32',
    query: "Ma mère est décédée à Genève il y a 2 ans et nous sommes 3 héritiers : moi, mon frère et ma sœur. L'unique bien important est la maison familiale estimée à CHF 650'000. Mon frère refuse absolument de vendre ou de permettre le partage — il veut y vivre indéfiniment. Ma sœur et moi voudrions récupérer notre part. Sommes-nous vraiment bloqués tant qu'il refuse de coopérer ?",
    canton: 'GE',
    expected_domaine: 'successions',
    expected_any_article: ['CC 612', 'CC 604'],
    notes: "Licitation judiciaire d'un immeuble successoral — CC 612 permet à tout héritier de demander la vente aux enchères si le partage amiable est impossible — CC 604 al. 1 : tout héritier peut demander en tout temps le partage de la succession. CC 612 al. 1 : si les héritiers ne peuvent pas s'entendre sur le partage d'un bien ou si le partage en nature est impossible ou inutilement dommageable, un héritier ou le juge peut exiger la vente aux enchères publiques ou à l'amiable. CC 612 al. 3 : à défaut d'accord entre les cohéritiers sur la vente, le juge ordonne la vente aux enchères publiques. ATTRIBUTION JUDICIAIRE : avant d'ordonner la vente aux enchères publiques, le juge peut attribuer le bien à l'un des héritiers si celui-ci offre de racheter les parts des autres à leur valeur d'inventaire — en l'occurrence, le frère qui veut garder la maison devrait payer sa valeur (1/3 × 650'000 = CHF 216'667 à chaque sœur/frère). DÉMARCHE PRATIQUE : demande en action en partage (CC 604) devant le Tribunal de première instance de Genève ; si aucun accord, le juge fixe la valeur vénale, propose l'attribution préalable, puis ordonne la licitation. DÉLAI : les héritiers peuvent intenter cette action en tout temps — il n'y a pas de prescription pour l'action en partage. MYTHE : 'si un héritier refuse catégoriquement de vendre ou de permettre le partage d'un immeuble, les autres héritiers ne peuvent rien faire et restent bloqués indéfiniment'. Faux — CC 612 : tout héritier peut demander la licitation judiciaire ; le juge peut ordonner la vente aux enchères même contre la volonté d'un ou plusieurs cohéritiers. '?succession maison CHF 650000 + frère bloquant vente + 3 héritiers + Genève?' sans 'CC 612 : licitation judiciaire possible sur demande d'un seul héritier' ni 'juge peut ordonner vente aux enchères malgré refus d'un cohéritier'. Signal adversarial = héritier croit être bloqué indéfiniment tant qu'un cohéritier refuse le partage d'un immeuble, ignorant l'action en licitation judiciaire ouverte à chaque héritier.",
  },

  // CONSOMMATION — CO 101 : responsabilité du vendeur pour les actes de ses sous-traitants (auxiliaires) dans l'exécution de la livraison
  {
    id: 'adv_consommation_31',
    query: "J'ai commandé un réfrigérateur sur un grand site de e-commerce suisse à Zurich. La livraison a été faite par une entreprise de logistique externe (sous-traitant). Le livreur a rayé et cabossé sérieusement le frigo en le montant. Quand j'ai contacté le site, ils m'ont dit 'ce n'est pas notre livreur, contactez la société de logistique XY directement, nous n'y sommes pour rien'. Ont-ils raison ?",
    canton: 'ZH',
    expected_domaine: 'consommation',
    expected_any_article: ['CO 101', 'CO 97'],
    notes: "Responsabilité du vendeur pour les actes de ses auxiliaires dans l'exécution du contrat — CO 101 al. 1 : celui qui, même sans faute de sa part, emploie des auxiliaires dans l'accomplissement d'une obligation ou l'exercice d'un droit, répond envers l'autre partie du dommage causé par ceux-ci dans l'accomplissement de leur travail. CONSÉQUENCE : le site e-commerce (vendeur) est responsable du dommage causé par le livreur sous-traitant car ce livreur est un 'auxiliaire' au sens de CO 101 — il exécute l'obligation de livraison que le vendeur a envers l'acheteur. AUXILIAIRE = qui exécute l'obligation : qu'il soit salarié ou sous-traitant, peu importe ; ce qui compte est que cet auxiliaire exécutait l'obligation contractuelle du vendeur (livraison). DIFFÉRENCE AVEC CO 55 (commettant) : CO 55 concerne la responsabilité délictuelle extracontractuelle des commettants pour leurs préposés. CO 101 concerne la responsabilité CONTRACTUELLE du débiteur pour ses auxiliaires dans l'exécution du contrat. RECOURS VENDEUR → LIVREUR : le vendeur peut ensuite se retourner contre le sous-traitant livreur (CO 55 ou contrat) — mais c'est son problème interne, pas celui de l'acheteur. CLAUSE CG LIMITATIVE : une clause CG du vendeur qui écarte sa responsabilité pour les actes de ses auxiliaires est nulle si elle vise la négligence grave (CO 100). PROCÉDURE : l'acheteur adresse sa réclamation UNIQUEMENT au vendeur (son cocontractant direct) ; le vendeur est responsable de plein droit des dommages causés par ses livreurs même sous-traités. MYTHE : 'si c'est le livreur sous-traitant externe qui a abîmé la marchandise, le vendeur en ligne n'est pas responsable car c'est une société tierce'. Faux — CO 101 : le vendeur répond de ses auxiliaires, sous-traitants compris, pour tout dommage dans l'exécution de l'obligation de livraison. '?réfrigérateur abîmé par livreur sous-traitant + vendeur e-commerce dit non-responsable + Zurich?' sans 'CO 101 : responsabilité du vendeur pour ses auxiliaires sous-traitants' ni 'reclamation uniquement au vendeur, pas au transporteur'. Signal adversarial = acheteur accepte le refus du vendeur de se responsabiliser pour son livreur sous-traitant, ignorant que CO 101 établit la responsabilité directe du débiteur pour ses auxiliaires.",
  },

  // CIRCULATION — LCR 58 / CO 1933 : responsabilité causale du détenteur d'un véhicule prêté — même si absent
  {
    id: 'adv_circulation_30',
    query: "J'ai prêté ma voiture à mon neveu de 23 ans la semaine dernière à Bâle. Il a eu un accident et a renversé un cycliste qui s'est cassé le bras. Le cycliste a subi des pertes de revenus de CHF 15'000 et réclame une indemnisation. Mon neveu n'a aucun revenu. Est-ce que moi, le propriétaire qui n'était pas dans la voiture, je risque d'être personnellement poursuivi et condamné à payer quoi que ce soit ?",
    canton: 'BS',
    expected_domaine: 'circulation',
    expected_any_article: ['LCR 58'],
    notes: "Responsabilité causale du détenteur de véhicule — même quand un tiers conduit — LCR 58 al. 1 : si par suite de l'emploi d'un véhicule automobile, des personnes sont tuées ou blessées ou que des choses sont endommagées, le détenteur est civilement responsable. DÉTENTEUR = propriétaire habituel : le détenteur d'un véhicule est en principe la personne qui a le droit de disposer du véhicule et qui supporte le coût d'exploitation (en général le propriétaire inscrit au registre des véhicules). CO 58 al. 1 : le détenteur ne peut s'exempter de cette responsabilité que s'il prouve que l'accident a été causé par la force majeure ou la faute grave du lésé ou d'un tiers. RESPONSABILITÉ CAUSALE = sans faute : il n'est pas nécessaire que le détenteur ait commis une faute ; le simple fait de détenir le véhicule suffit à engager sa responsabilité civile (responsabilité objective). PRÊT DU VÉHICULE : prêter sa voiture à quelqu'un ne transfère pas la qualité de détenteur et ne libère pas le propriétaire-détenteur de sa responsabilité civile. ASSURANCE RC AUTO OBLIGATOIRE : la loi oblige l'assurance RC automobile (LCR 63) — l'assureur RC du détenteur indemnisera la victime et pourra exercer un recours contre le conducteur fautif (art. 65 LCR). RÉSULTAT PRATIQUE : le cycliste peut poursuivre soit le détenteur (moi, le propriétaire), soit le conducteur (le neveu), soit les deux. En pratique, c'est l'assureur RC du véhicule qui indemnise et peut récupérer les montants auprès du conducteur fautif. MYTHE : 'si je prête ma voiture à quelqu'un et qu'il cause un accident, seul lui est responsable car il conduisait — je n'y suis pour rien'. Faux — LCR 58 : responsabilité causale du détenteur même absent ; l'assurance RC auto du véhicule couvre cela mais le détenteur reste co-responsable. '?voiture prêtée à neveu + accident cycliste + blessures CHF 15000 + propriétaire non présent + Bâle?' sans 'LCR 58 : responsabilité causale du détenteur même si absent' ni 'assurance RC auto du véhicule = protection effective mais responsabilité du détenteur maintenue'. Signal adversarial = propriétaire croit être totalement exempt de responsabilité civile quand il prête sa voiture, ignorant la responsabilité causale du détenteur indépendante de la présence physique.",
  },

  // SANTE — LAMal 41 : droit à être hospitalisé dans tout hôpital admis sur la liste cantonale, y compris hors canton de résidence sous conditions
  {
    id: 'adv_sante_33',
    query: "J'habite à Lausanne en VD et j'ai besoin d'une opération du genou planifiée. Le meilleur spécialiste en Suisse romande pour ce type d'opération travaille au CHUV (VD) mais aussi à l'Hôpital de la Tour à Genève (GE). Je voudrais me faire opérer à Genève. Mon assurance m'a dit que ça ne sera pas remboursé si je sors de mon canton de résidence sans urgence. Est-ce vrai ?",
    canton: 'VD',
    expected_domaine: 'sante',
    expected_any_article: ['LAMal 41'],
    notes: "Droit d'hospitalisation hors canton de résidence — LAMal 41 règle une liberté de choix mais avec des nuances importantes — LAMal 41 al. 1 : en cas de traitement ambulatoire, l'assuré peut choisir librement parmi les fournisseurs de prestations admis. LAMal 41 al. 2 : en cas d'hospitalisation, l'assuré a le droit de se faire hospitaliser dans un hôpital figurant sur la liste du CANTON OÙ IL RÉSIDE ou dans les cantons voisins qui ont conclu des conventions. LAMal 41 al. 3 : en cas d'urgence, toute hospitalisation est couverte quel que soit le canton. LISTE CANTONALE : en règle générale, un assuré VD peut être hospitalisé dans les hôpitaux figurant sur la liste du canton de VD — mais AUSSI dans des hôpitaux d'autres cantons SI CES HÔPITAUX FIGURENT SUR LA LISTE D'UN CANTON (pas seulement de résidence). FINANCEMENT INTER-CANTONAL : depuis 2012 (OFAS), le financement des hospitalisations hors-canton a été harmonisé — le canton de résidence et l'assureur partagent les coûts pour les hôpitaux admis partout en Suisse. CONDITION PRATIQUE : l'Hôpital de la Tour GE est sur la liste genevoise des hôpitaux admis LAMal — il peut accepter des patients VD et l'assureur VD est tenu de participer aux frais (au tarif applicable). REMBOURSEMENT PARTIEL POSSIBLE : si le coût dans le canton choisi est plus élevé que dans le canton de résidence, la différence peut être à charge du patient. MYTHE : 'l'assurance maladie LAMal ne prend en charge les hospitalisations planifiées que dans le canton de résidence du patient'. Partiellement inexact — LAMal 41 al. 2 : hospitalisation possible dans tout hôpital sur liste cantonale (y compris hors-canton) ; financement inter-cantonal depuis 2012. '?opération genou planifiée + hôpital autre canton (GE depuis VD) + assurance dit non remboursé hors-canton?' sans 'LAMal 41 al. 2 : hospitalisation admise dans tout hôpital sur liste d'un canton' ni 'financement inter-cantonal, pas de restriction absolue au canton de résidence'. Signal adversarial = patient planifiant une opération croit être enfermé dans les hôpitaux de son seul canton de résidence, ignorant le régime LAMal d'hospitalisation inter-cantonale.",
  },

  // BAIL — CO 271/CO 271a : résiliation pour besoin propre du bailleur — contestable si le besoin n'est pas effectif et sérieux
  {
    id: 'adv_bail_56',
    query: "Mon bailleur m'a envoyé un congé en bonne et due forme en invoquant le besoin propre pour son fils. J'ai entendu que le besoin propre c'est irréfutable et que le juge donne toujours raison au propriétaire. J'habite à Genève depuis 8 ans dans cet appartement. Est-ce que ça vaut la peine de contester ou c'est peine perdue ?",
    canton: 'GE',
    expected_domaine: 'bail',
    expected_any_article: ['CO 271', 'CO 271a'],
    notes: "Résiliation pour besoin propre — CO 271 al. 1 : le congé est annulable lorsqu'il contrevient aux règles de la bonne foi ; CO 271a énumère des cas présumés contraires à la bonne foi. BESOIN PROPRE : le bailleur peut résilier pour son propre usage ou pour un proche (descendant, ascendant, frère/sœur) — mais le besoin doit être EFFECTIF et SÉRIEUX, pas un prétexte. JURISPRUDENCE TF : ATF 135 III 112 — le besoin propre doit être concret, réel et sérieux ; un besoin hypothétique ou peu vraisemblable rend le congé annulable. CONTRÔLE DU JUGE : le tribunal examine si le besoin est plausible au moment du congé ; si le bailleur ne prend pas possession dans un délai raisonnable ou loue à un tiers peu après, présomption d'abus. DÉLAI CONTESTATION : 30 jours dès réception du congé, par voie de conciliation auprès de la commission de conciliation — délai de déchéance absolue. PROTECTION PARTICULIÈRE : CO 271a al. 1 let. a — congé annulable si donné pendant procédure de conciliation ou judiciaire en rapport avec le bail. DURÉE ET ANCIENNETÉ : 8 ans de bail à Genève = facteur aggravant l'examen de l'effectivité du besoin propre. MYTHE : 'résiliation pour besoin propre = motif irréfutable que le juge valide toujours'. Faux — CO 271/TF : le besoin doit être effectif et sérieux ; contestation possible dans 30 jours si le besoin est fictif, peu plausible ou disproportionné. '?congé besoin propre fils bailleur + 8 ans bail GE + vaut la peine contester?' sans 'CO 271 : besoin doit être effectif et sérieux, non un prétexte' ni 'délai 30 jours conciliation pour annulation congé'. Signal adversarial = locataire croit la résiliation pour besoin propre est inattaquable et ne conteste pas dans les 30 jours, laissant expirer le délai de déchéance.",
  },

  // TRAVAIL — CO 339b/CO 339c : indemnité de départ (ancienneté) — conditions cumulatives strictes, pas une obligation générale
  {
    id: 'adv_travail_56',
    query: "Je travaille depuis 18 ans dans la même entreprise à Berne et mon employeur vient de m'annoncer mon licenciement. J'ai 47 ans. Un collègue m'a dit qu'après 18 ans de service, l'entreprise est obligée de me verser une prime de licenciement équivalente à plusieurs mois de salaire. Est-ce que c'est vrai ?",
    canton: 'BE',
    expected_domaine: 'travail',
    expected_any_article: ['CO 339b', 'CO 339c'],
    notes: "Indemnité de départ — CO 339b : si les rapports de travail ont duré au moins 20 ans ou si l'employé a au moins 50 ans révolus et que les rapports ont duré au moins 20 ans, une indemnité est due. CONDITIONS CUMULATIVES STRICTES : CO 339b al. 1 — durée MINIMALE 20 ANS (pas 18 ans) ET (soit l'employé a 50 ans révolus, soit les rapports ont duré 20 ans au moins). CALCUL : CO 339c — 2 mensualités de salaire dès 20 ans de service ; augmente ensuite. EXCEPTIONS : pas dû si l'employeur verse des prestations équivalentes via fonds de prévoyance/caisse de retraite (CO 339b al. 2) — ce qui est le cas pour la plupart des employeurs suisses avec LPP. RÉALITÉ PRATIQUE : avec LPP obligatoire, l'indemnité CO 339b est souvent absorbée par les prestations de prévoyance — l'employeur prouve l'équivalence. CCT POSSIBLE : certaines CCT prévoient des primes de licenciement conventionnelles — vérifier la CCT applicable au secteur. RÉSULTAT ICI : 18 ans (< 20 ans) → condition de durée non remplie → pas d'indemnité légale CO 339b automatique. MYTHE : 'après 18 ans de service, l'employeur doit verser une prime de licenciement obligatoire'. Faux — CO 339b exige 20 ans minimum ET souvent absorbée par LPP ; 18 ans insuffisant pour l'indemnité légale. '?licenciement après 18 ans service + 47 ans + prime licenciement obligatoire?' sans 'CO 339b : 20 ans minimum requis (pas 18)' ni 'LPP absorbe souvent l'indemnité légale'. Signal adversarial = salarié proche de l'éligibilité (18/20 ans) croit avoir droit à l'indemnité légale alors que la condition de 20 ans n'est pas atteinte.",
  },

  // DETTES — LP 297/LP 293 : sursis concordataire — suspend toutes les poursuites même celles antérieures au sursis
  {
    id: 'adv_dettes_52',
    query: "J'ai une poursuite en cours contre mon débiteur depuis 3 mois (commandement de payer envoyé il y a 4 mois, opposition levée). Aujourd'hui, j'apprends que mon débiteur a obtenu un sursis concordataire du tribunal de Genève. Est-ce que ma poursuite qui était déjà bien engagée avant le sursis peut continuer ? J'ai entendu que celles déjà lancées ne sont pas touchées.",
    canton: 'GE',
    expected_domaine: 'dettes',
    expected_any_article: ['LP 297', 'LP 293'],
    notes: "Sursis concordataire et poursuites — LP 293 : le sursis concordataire est accordé par le tribunal lorsque le débiteur est menacé d'insolvabilité et que l'assainissement est vraisemblable. EFFET SUSPENSIF ABSOLU : LP 297 al. 1 — pendant la durée du sursis, TOUTES les poursuites contre le débiteur sont suspendues, y compris celles déjà en cours (actions introduites antérieurement). PÉRIMÈTRE LP 297 : art. 297 al. 1 LP — durant le sursis, aucune poursuite ne peut être intentée ou continuée contre le débiteur (sauf exceptions légales comme créances LPP, aliments, ...). CRÉANCES ANTÉRIEURES : le caractère antérieur de la poursuite ne la protège pas — le sursis arrête le cours de la procédure pour toutes les dettes nées AVANT le sursis. EXCEPTIONS LÉGALES : LP 297 al. 2 — exceptions pour créances garanties par gage, pensions alimentaires, cotisations sociales (liste exhaustive). DURÉE : sursis provisoire max 4 mois, sursis définitif max 24 mois. APRÈS SURSIS : si concordat homologué, les créanciers non-garantis reçoivent le dividende concordataire ; si échec, faillite ouverte. MYTHE : 'une poursuite déjà lancée avant le sursis concordataire peut continuer jusqu'à son terme'. Faux — LP 297 : le sursis suspend TOUTES les poursuites en cours, peu importe leur état d'avancement ou leur date d'introduction. '?poursuite en cours depuis 4 mois + sursis concordataire débiteur + poursuite antérieure continue?' sans 'LP 297 : sursis suspend TOUTES poursuites même antérieures' ni 'exceptions limitées (gage, aliments, cotisations sociales)'. Signal adversarial = créancier croit que sa poursuite déjà bien avancée ne peut pas être arrêtée par le sursis concordataire, ignorant l'effet suspensif universel de LP 297.",
  },

  // FAMILLE — CC 307/CC 310 : mesures de protection de l'enfant — retrait garde = mesure ultime après gradation ; APEA ne peut pas enlever un enfant sans procédure
  {
    id: 'adv_famille_51',
    query: "Une voisine a signalé à l'APEA que mes enfants restent seuls le soir (je travaille en équipe de nuit 3 jours/semaine, ils ont 10 et 12 ans, l'aîné est responsable). J'ai reçu une convocation pour une audience dans 2 semaines. J'ai peur qu'à la première audience ils enlèvent mes enfants immédiatement. Est-ce possible ? Je suis à Lausanne (VD).",
    canton: 'VD',
    expected_domaine: 'famille',
    expected_any_article: ['CC 307', 'CC 310'],
    notes: "Mesures de protection de l'enfant — CC 307/CC 310 — principe de proportionnalité et gradation obligatoire. CC 307 al. 1 : l'autorité de protection prend les mesures nécessaires pour protéger l'enfant si son développement est menacé et que les père et mère n'y remédient pas d'eux-mêmes. GRADATION DES MESURES : CC 307 prévoit des mesures graduées — avertissement, injonctions, curatelle de surveillance, curatelle de garde avant tout retrait. CC 310 al. 1 : retrait du droit de garde seulement si d'autres mesures n'ont pas remédié à la situation ou si parents incapables de l'améliorer. RETRAIT GARDE = ULTIMA RATIO : TF (ATF 142 III 617) — le placement est une mesure extrême ; principe de proportionnalité strict exige d'épuiser les mesures moins incisives. PROCÉDURE APEA : convocation = invitation à s'expliquer ; l'APEA instruit, peut mandater un service social, peut nommer un curateur — pas d'enlèvement immédiat à la 1ère audience sans menace imminente prouvée. MESURES PROVISIONNELLES URGENTES : CC 445 — retrait immédiat possible uniquement en cas de DANGER GRAVE et IMMINENT pour l'enfant (violence physique imminente, abus en cours, abandon total) — situation de travail en équipe de nuit avec aîné responsable ne correspond pas à ce seuil. MYTHE : 'l'APEA peut retirer les enfants à la première audience sur simple signalement d'une voisine'. Faux — CC 307/CC 310 : gradation obligatoire ; mesures provisionnelles urgentes (CC 445) limitées aux dangers graves et imminents prouvés. '?APEA convocation + travail nuit + enfants 10 et 12 ans seuls + risque enlèvement 1ère audience?' sans 'CC 307 : mesures graduées, retrait = ultima ratio' ni 'CC 445 : retrait immédiat seulement danger grave et imminent'. Signal adversarial = parent convoqué croit que l'APEA peut enlever ses enfants dès la première audience sur la base d'un signalement de voisin, ignorant la gradation légale et le principe de proportionnalité.",
  },

  // ETRANGERS — LEI 61 : extinction automatique du permis B après 6 mois d'absence non autorisée
  {
    id: 'adv_etrangers_45',
    query: "J'ai un permis B valable jusqu'en 2027 à Neuchâtel. Je dois rentrer en Tunisie pour m'occuper de ma mère gravement malade. Je pense être absent environ 8-9 mois. La durée de validité inscrite sur mon titre est jusqu'en 2027 donc j'ai le droit de revenir quand je veux avant cette date, non ?",
    canton: 'NE',
    expected_domaine: 'etrangers',
    expected_any_article: ['LEI 61'],
    notes: "Extinction du permis B par absence prolongée — LEI 61 règle les cas d'extinction des autorisations. LEI 61 al. 2 : le permis de séjour (B) s'éteint notamment lorsque l'étranger quitte la Suisse avec l'intention manifeste de s'y établir à l'étranger — ou après une ABSENCE ININTERROMPUE DE 6 MOIS. EFFET AUTOMATIQUE : l'extinction n'est pas une décision administrative — elle opère de plein droit au bout de 6 mois d'absence consécutive non autorisée. DATE D'EXPIRATION DU TITRE ≠ DROIT AU SÉJOUR : la date inscrite sur le titre de séjour est la date limite de validité conditionnelle — elle présuppose que le titulaire maintient les conditions de délivrance, dont la résidence effective en Suisse. ABSENCE AUTORISÉE : pour éviter l'extinction, il faut DEMANDER UNE AUTORISATION D'ABSENCE PRÉALABLE à l'autorité cantonale compétente AVANT le départ — une autorisation peut être accordée pour raisons médicales/familiales sérieuses. CONSÉQUENCE PRATIQUE : rentrer après 8-9 mois sans autorisation préalable = permis éteint à l'arrivée = doit déposer une nouvelle demande de permis B depuis l'étranger. MYTHE : 'la date d'expiration inscrite sur le titre de séjour B garantit le droit de retour quelle que soit la durée d'absence'. Faux — LEI 61 : extinction automatique après 6 mois d'absence consécutive sans autorisation préalable, indépendamment de la date figurant sur le titre. '?absence 8-9 mois Tunisie + permis B valable 2027 + droit de revenir avant expiration?' sans 'LEI 61 al. 2 : extinction après 6 mois absence ininterrompue' ni 'autorisation préalable obligatoire pour absence > 6 mois'. Signal adversarial = titulaire d'un permis B croit que la date d'expiration inscrite sur son titre lui garantit le droit de revenir en Suisse quelle que soit la durée de son absence, ignorant l'extinction automatique de LEI 61.",
  },

  // VOISINAGE — CC 679a/CC 684 : chantier autorisé par permis de construire — pas d'immunité civile pour immissions excessives
  {
    id: 'adv_voisinage_38',
    query: "Mes voisins construisent une extension de leur maison à Fribourg avec un permis légal. Les travaux génèrent des vibrations intenses qui ont fissuré un mur porteur de ma maison. L'architecte dit que c'est dans les normes légales et que comme ils ont un permis, je ne peux rien faire. Est-ce vrai ?",
    canton: 'FR',
    expected_domaine: 'voisinage',
    expected_any_article: ['CC 679a', 'CC 684'],
    notes: "Immissions de chantier et permis de construire — CC 684/CC 679a — un permis de construire légal n'exclut pas le droit civil à réparation. CC 684 al. 1 : le propriétaire est tenu, dans l'exercice de son droit, notamment de s'abstenir de tout excès au détriment des fonds voisins ; sont interdites les immissions (fumées, vapeurs, bruits, vibrations, etc.) qui excèdent les limites de la tolérance imposée par les rapports de voisinage. CC 679a : le propriétaire qui excède son droit en causant un préjudice au voisin est tenu de le réparer, même si l'activité est autorisée par l'autorité. DOUBLE RÉGIME : le droit public (permis de construire) détermine ce qui est autorisé administrativement — mais le droit privé (CC 684) détermine si les immissions sont tolérables par le voisin. UN PERMIS NE LIBÈRE PAS DU DROIT CIVIL : ATF 130 III 28 — l'autorisation administrative ne préjuge pas de la licéité civile des immissions ; le voisin lésé peut réclamer des dommages-intérêts et des mesures de cessation même si le chantier est légalement autorisé. FISSURES MURS PORTEURS : dommage concret, non hypothétique — responsabilité civile quasi délictuelle (CO 41) et/ou voisinage (CC 679a) selon les circonstances. MYTHE : 'permis de construire légal = immunité totale contre les recours civils des voisins'. Faux — CC 679a/CC 684 : le droit civil à réparation subsiste pour immissions excessives, indépendamment de l'autorisation administrative. '?vibrations chantier + fissures mur porteur + permis légal + pas de recours possible?' sans 'CC 679a : droit civil à réparation même avec permis' ni 'CC 684 : immissions excessives interdites même si activité autorisée'. Signal adversarial = voisin lésé croit que le permis de construire légal de son voisin lui interdit tout recours civil pour les dommages causés par les immissions du chantier.",
  },

  // SUCCESSIONS — CC 493/CC 512 : pacte successoral — requiert forme authentique (acte notarié + 2 témoins) — accord de famille signé = nul
  {
    id: 'adv_successions_33',
    query: "Avec mes 3 frères et sœurs, nous avons tous signé un accord devant témoins disant que notre frère aîné héritera de la ferme familiale à Zurich et que les autres renonçons à nos parts en échange d'une compensation immédiate en argent que nous avons déjà reçue. Notre père est encore vivant. Cet accord est-il valable ?",
    canton: 'ZH',
    expected_domaine: 'successions',
    expected_any_article: ['CC 493', 'CC 512'],
    notes: "Pacte successoral — CC 493/CC 512 — forme authentique obligatoire, nullité absolue pour vice de forme. CC 512 al. 1 : le pacte successoral doit être passé en la FORME DU TESTAMENT PUBLIC — c'est-à-dire devant un NOTAIRE ou un officier public compétent, EN PRÉSENCE DE DEUX TÉMOINS. CC 493 al. 1 : par pacte successoral, le disposant peut renoncer à une succession ou en accepter une, contre prestations ou sans contreprestation de la part de l'héritier. FORME TESTAMENT PUBLIC : CC 499 et suivants — acte dressé par un notaire (ou officier public), lu au disposant, signé par lui et deux témoins ; les témoins attestent la capacité de discernement du disposant. EXIGENCE DE FORME = CONDITIONS DE VALIDITÉ : un accord privé signé par tous les héritiers, même devant témoins ordinaires, N'EST PAS un pacte successoral valable — nullité absolue (pas relative), non susceptible de confirmation. CONSÉQUENCES : l'accord privé signé est juridiquement nul comme pacte successoral ; les compensations déjà versées pourraient être réclamées en enrichissement illégitime (CO 62) si l'acte est nul. RENONCIATION À SUCCESSION : CC 495 — la renonciation doit aussi être conclue sous forme de pacte successoral authentique. MYTHE : 'un accord familial signé par tous les héritiers et témoins sur la succession future est valable comme pacte successoral'. Faux — CC 512 : forme authentique (notaire + 2 témoins officiels) obligatoire ; accord privé = nul de plein droit. '?accord famille signé témoins ferme ZH + père encore vivant + renonciation parts contre argent?' sans 'CC 512 : forme authentique obligatoire (notaire + 2 témoins)' ni 'nullité absolue si forme non respectée'. Signal adversarial = héritiers croient avoir valablement réglé la succession future par un accord familial privé, ignorant l'exigence impérative de forme authentique de CC 512.",
  },

  // ASSURANCES — LCA 53/LCA 54 : règle proportionnelle sous-assurance — remboursement partiel même si sinistre < somme assurée
  {
    id: 'adv_assurances_32',
    query: "J'avais assuré le contenu de mon appartement à Zurich pour CHF 80'000. Lors d'un cambriolage, des objets pour CHF 30'000 ont été volés. Mon assureur me dit qu'il ne me remboursera que CHF 18'750 parce que j'étais sous-assuré — la valeur réelle de mon mobilier était de CHF 128'000. Je pensais que comme mon sinistre était bien inférieur à ma couverture de CHF 80'000, j'aurais tout remboursé. C'est correct ce que fait l'assureur ?",
    canton: 'ZH',
    expected_domaine: 'assurances',
    expected_any_article: ['LCA 53', 'LCA 54'],
    notes: "Règle proportionnelle sous-assurance — LCA 53/LCA 54. LCA 53 : il y a sous-assurance lorsque la valeur de l'objet assuré au moment du sinistre est supérieure à la somme assurée. LCA 54 : en cas de sous-assurance, l'assureur ne répond des dommages que dans la proportion qui existe entre la somme assurée et la valeur de la chose assurée au moment du sinistre. CALCUL PROPORTIONNEL : sinistre CHF 30'000 × (somme assurée CHF 80'000 / valeur réelle CHF 128'000) = CHF 30'000 × 0.625 = CHF 18'750 — calcul correct de l'assureur. PRINCIPE : la règle proportionnelle s'applique MÊME QUAND LE SINISTRE EST INFÉRIEUR À LA SOMME ASSURÉE — c'est le rapport valeur/couverture qui compte, pas le rapport sinistre/couverture. DÉROGATION CONVENTIONNELLE : certaines polices prévoient une clause de renonciation à la règle proportionnelle (clause de valeur à neuf, clause de remplacement) — vérifier les conditions générales. MYTHE : 'tant que le sinistre est inférieur à la somme assurée, l'assureur rembourse intégralement le sinistre'. Faux — LCA 54 : règle proportionnelle s'applique dès sous-assurance, réduisant le remboursement même pour les sinistres partiels. '?cambriolage CHF 30000 + assuré pour 80000 + valeur réelle 128000 + remboursement partiel 18750 + est-ce correct?' sans 'LCA 54 : règle proportionnelle sous-assurance réduit remboursement même sinistre < somme assurée' ni 'calcul : sinistre × (somme assurée / valeur réelle)'. Signal adversarial = assuré croit qu'un sinistre inférieur à la somme assurée est toujours intégralement remboursé, ignorant la règle proportionnelle de sous-assurance (LCA 54).",
  },

  // CONSOMMATION — CO 100/CO 97 : clause limitative de responsabilité nulle pour faute grave — vol en vestiaire malgré clause CG
  {
    id: 'adv_consommation_32',
    query: "J'ai laissé mon manteau de cuir d'une valeur de CHF 2'400 au vestiaire d'un club de fitness à Zurich. Le personnel a perdu mon manteau (ou il a été volé). Le club me montre l'article dans ses conditions générales qui dit 'Le club décline toute responsabilité pour les objets perdus ou volés au vestiaire'. Ils refusent de rembourser. Est-ce qu'ils ont le droit ?",
    canton: 'ZH',
    expected_domaine: 'consommation',
    expected_any_article: ['CO 100', 'CO 97'],
    notes: "Clause limitative de responsabilité et faute grave — CO 100/CO 97. CO 100 al. 1 : est nulle toute stipulation tendant à exclure ou limiter la responsabilité en cas de dol ou de faute grave. CO 97 al. 1 : le débiteur répond en principe de toute faute. DÉPÔT VESTIAIRE = CONTRAT DE DÉPÔT : en remettant les objets au vestiaire payant (même vestiaire avec clé gérée par club), un contrat de dépôt se forme (CO 472 et ss) — le dépositaire (club) est tenu de restituer la chose ou d'indemniser si perte par sa faute. FAUTE GRAVE DU CLUB : perte d'un objet en dépôt par un professionnel = faute grave présumée si les mesures de sécurité étaient insuffisantes. CO 100 AL. 1 : la clause 'décline toute responsabilité' est nulle pour la faute grave — elle peut valoir pour la faute légère mais PAS pour la faute grave ou le dol. NUANCE VESTIAIRE LIBRE : si le vestiaire est entièrement libre-service sans personnel (case à clé auto-gérée), la qualification de dépôt est moins certaine — mais si le personnel intervient (garde les vêtements), c'est un dépôt. MYTHE : 'les conditions générales d'un club excluant sa responsabilité pour les objets perdus au vestiaire sont valables et l'empêchent de réclamer'. Faux — CO 100 : clause d'exclusion nulle pour faute grave ; perte d'un dépôt par manque de sécurité = faute grave présumée. '?manteau perdu vestiaire club fitness + clause CG responsabilité exclue + CHF 2400 + refus remboursement?' sans 'CO 100 : clause nulle pour faute grave' ni 'contrat de dépôt CO 472 : obligation de restitution'. Signal adversarial = consommateur croit que les clauses CG d'exclusion de responsabilité sont toujours valables, ignorant la nullité légale pour faute grave (CO 100).",
  },

  // CIRCULATION — LCR 83/LCR 87 : obligation légale d'identifier le conducteur — refus d'identifier un tiers constitue infraction séparée
  {
    id: 'adv_circulation_31',
    query: "Ma voiture a été flashée à un radar fixe à Berne. J'étais au travail à ce moment-là donc c'est forcément mon conjoint qui conduisait. La police m'envoie un formulaire me demandant d'identifier le conducteur. Mon avocat m'a dit que j'ai le droit de ne pas m'auto-incriminer et que je peux refuser de répondre. Mais est-ce que ça veut dire que je peux aussi refuser de désigner mon conjoint ?",
    canton: 'BE',
    expected_domaine: 'circulation',
    expected_any_article: ['LCR 83', 'LCR 87'],
    notes: "Obligation d'identifier le conducteur — LCR 87 al. 2 / LCR 83. LCR 87 al. 2 : le détenteur du véhicule est tenu de renseigner les autorités sur l'identité du conducteur au moment de l'infraction. DROIT AU SILENCE ≠ DROIT DE NE PAS IDENTIFIER UN TIERS : le nemo tenetur (droit de ne pas s'auto-incriminer) protège contre l'obligation de témoigner CONTRE SOI-MÊME — il ne couvre pas le droit de taire l'identité d'un TIERS (ici : le conjoint). JURISPRUDENCE TF : ATF 142 IV 196 — l'obligation d'identifier le conducteur (LCR 87) est une obligation distincte du nemo tenetur ; refuser d'identifier le conducteur constitue une infraction séparée (contravention). REFUS = INFRACTION PROPRE : LCR 83 — commet une infraction quiconque viole les prescriptions de la loi, notamment les obligations de renseigner l'autorité. DÉROGATION POUR PROCHES : en droit pénal, il existe un droit de refus de témoigner pour proches (art. 168 CPP) — mais ce droit ne s'applique PAS à l'obligation LCR 87 d'identifier le conducteur (obligation administrative distincte). CONSÉQUENCE PRATIQUE : refuser d'identifier le conjoint = amende séparée pour refus d'information LCR 87 ; à l'inverse, identifier le conjoint = il reçoit l'amende pour excès de vitesse. MYTHE : 'le droit au silence (nemo tenetur) permet de refuser d'identifier un conjoint conducteur à la police'. Faux — LCR 87 : obligation distincte d'identifier le conducteur ; nemo tenetur ne couvre pas l'identification d'un tiers ; refus = infraction séparée. '?radar + conjoint conducteur + formulaire identification + droit au silence = refus possible?' sans 'LCR 87 : obligation d'identifier le conducteur = obligation distincte du nemo tenetur' ni 'refus d'identifier un tiers = infraction LCR 83 séparée'. Signal adversarial = détenteur confond le nemo tenetur (droit de ne pas s'auto-incriminer) avec un droit général de ne pas révéler l'identité d'un proche conducteur, ignorant l'obligation légale LCR 87.",
  },

  // WAVE 58 — 10 nouveaux cas (580→590) — domaines fiscal, social, accident, violence + core

  // BAIL — CO 260a al.2 : travaux d'amélioration non urgents refusables si inconvénients disproportionnés
  {
    id: 'adv_bail_57',
    query: "Mon bailleur à Genève veut installer un ascenseur dans notre immeuble de 3 étages. Les travaux dureraient 6 mois avec des bruits constants et l'escalier partiellement bloqué. Il dit qu'on est obligés de les accepter car c'est une 'amélioration de l'immeuble'. Mon loyer va augmenter de 15% après. Est-ce qu'on peut vraiment rien faire ?",
    canton: 'GE',
    expected_domaine: 'bail',
    expected_any_article: ['CO 260a', 'CO 260'],
    notes: "Travaux d'amélioration vs droit de tolérance — CO 260a al.1/al.2. CO 260 al.1 : le locataire doit tolérer les travaux de rénovation et réparation urgents. CO 260a al.1 : le locataire doit tolérer les travaux d'amélioration DANS LA MESURE OÙ ils sont raisonnables. CO 260a al.2 : le locataire peut refuser les travaux d'amélioration qui apporteraient des inconvénients disproportionnés au vu des avantages procurés. CRITÈRE PROPORTIONNALITÉ : 6 mois de travaux intenses dans un immeuble de 3 étages peut être disproportionné selon l'ampleur des nuisances. RECOURS DU LOCATAIRE : (1) contestation devant la commission de conciliation bail ; (2) opposition aux travaux pour inconvénients disproportionnés (CO 260a al.2) ; (3) réduction de loyer pendant les travaux (CO 259d) ; (4) résiliation anticipée si travaux rendent l'usage impropre (CO 259b let.a). AUGMENTATION DE LOYER POST-TRAVAUX : CO 269b — loyer majoré après travaux d'amélioration = calcul basé sur coûts réels et taux de référence. MYTHE : 'le bailleur peut imposer tous les travaux d'amélioration sans que le locataire puisse s'y opposer'. Faux — CO 260a al.2 : le locataire peut refuser les travaux d'amélioration créant des inconvénients disproportionnés. '?ascenseur immeuble + 6 mois travaux + bruit + loyer +15% + obligé accepter?' sans 'CO 260a al.2 : refus possible si inconvénients disproportionnés' ni 'CO 259d : réduction loyer pendant travaux'. Signal adversarial = locataire croit que tout travail d'amélioration est imposable sans recours, ignorant CO 260a al.2.",
  },

  // TRAVAIL — CO 335c al.3 : délais légaux de congé sont des minimums impératifs que le contrat ne peut pas réduire
  {
    id: 'adv_travail_57',
    query: "Mon contrat de travail à Bâle stipule un délai de congé d'un mois pendant la première année, puis deux mois à partir de la deuxième année. Mon employeur m'a licencié hier avec un préavis d'un mois alors que je suis là depuis 3 ans. Il dit que le contrat prévoit deux mois donc c'est ce qui s'applique. Est-ce correct ?",
    canton: 'BS',
    expected_domaine: 'travail',
    expected_any_article: ['CO 335c', 'CO 335'],
    notes: "Délais légaux de congé minimum impératifs — CO 335c al.1/al.3. CO 335c al.1 : délais légaux = 1 mois 1ère année, 2 mois de la 2ème à la 9ème année, 3 mois à partir de la 10ème. CO 335c al.3 : ces délais sont des MINIMUMS IMPÉRATIFS — le contrat peut prévoir des délais plus longs mais JAMAIS plus courts. HIÉRARCHIE : délai légal (minimum) → délai contractuel si supérieur au légal. CAS DU REQUÉRANT : 3 ans de service → délai légal = 2 mois (CO 335c al.1 let.b) ; contrat = 2 mois à partir de 2ème année → même chose. DONC le préavis d'un mois donné par l'employeur EST INSUFFISANT — il devait donner 2 mois. RECOURS : (1) demander par écrit le respect du délai de 2 mois ; (2) demander les salaires correspondant au délai non respecté (salaire en lieu et place du préavis). MYTHE : 'si le contrat prévoit un délai plus court que le légal, on peut n'appliquer que ce délai contractuel'. Faux — CO 335c al.3 : les délais légaux sont des minimums impératifs que le contrat ne peut pas réduire. '?licencié 3 ans + contrat délai 1 mois 1ère année / 2 mois 2ème année + préavis 1 mois + correct?' sans 'CO 335c : délais légaux = minimums impératifs' ni '3 ans = 2 mois de préavis minimum'. Signal adversarial = travailleur pense que le contrat prime sur le légal, ignorant que les délais légaux sont des planchers impératifs (CO 335c al.3).",
  },

  // DETTES — CO 135 ch.2/CO 137 : commandement de payer interrompt la prescription et la fait repartir à zéro
  {
    id: 'adv_dettes_53',
    query: "J'ai une dette envers une banque à Zurich depuis 2012. Le montant original était de CHF 15'000. La banque n'a pratiquement rien fait pendant des années, sauf m'envoyer un commandement de payer en 2020. Je pensais que les dettes ordinaires se prescrivent en 10 ans selon le Code des obligations et que donc ma dette est prescrite depuis 2022. La banque dit que non. Qui a raison ?",
    canton: 'ZH',
    expected_domaine: 'dettes',
    expected_any_article: ['CO 135', 'CO 127'],
    notes: "Interruption de prescription par commandement de payer — CO 135 ch.2/CO 127/CO 137 al.1. CO 127 : délai de prescription ordinaire = 10 ans. CO 135 ch.2 : la prescription est interrompue par tout acte judiciaire, notamment la poursuite (commandement de payer). EFFET DE L'INTERRUPTION (CO 137 al.1) : après interruption, la prescription recommence à COURIR POUR LA MÊME DURÉE (ici 10 ans) dès la fin de l'acte interruptif. CALCUL : dette née 2012 → prescription courait jusqu'à 2022 → MAIS commandement de payer en 2020 (AVANT l'échéance de 2022) = interruption → nouvelle prescription de 10 ans repart depuis 2020 → prescription court désormais jusqu'en 2030. DONC la banque a raison : la dette n'est pas prescrite — elle le sera en 2030 si aucun autre acte interruptif. ACTES INTERRUPTIFS (CO 135) : reconnaissance de dette, poursuite (commandement de payer), action en justice, réquisition de continuer la poursuite. PIÈGE : chaque commandement de payer (même sans suite) remet le compteur à zéro. MYTHE : 'une dette de 2012 est forcément prescrite en 2022 après 10 ans'. Faux — CO 135 ch.2 : un commandement de payer interrompt la prescription et la fait recommencer pour 10 ans supplémentaires. '?dette 2012 CHF 15000 + commandement payer 2020 + prescription 10 ans + prescrite 2022?' sans 'CO 135 ch.2 : commandement de payer interrompt prescription et la fait repartir à zéro' ni 'nouvelle prescription court jusqu'en 2030'. Signal adversarial = débiteur calcule 10 ans depuis la naissance de la dette ignorant que l'acte de poursuite a interrompu et relancé le délai.",
  },

  // FAMILLE — CC 285a al.1 : contribution enfant majeur versée directement à l'enfant sur demande
  {
    id: 'adv_famille_52',
    query: "Mon fils a 19 ans et fait un apprentissage à Lausanne. Le jugement de divorce fixe une pension alimentaire mensuelle de CHF 800 que je verse à mon ex-femme depuis des années. Mon fils m'a demandé de lui verser directement la pension sur son propre compte — il dit qu'il en a le droit maintenant qu'il est majeur. Mon ex-femme refuse et dit que la pension doit continuer à lui être versée à elle. Qui a raison ?",
    canton: 'VD',
    expected_domaine: 'famille',
    expected_any_article: ['CC 285a', 'CC 285'],
    notes: "Versement direct contribution enfant majeur — CC 285a al.1. CC 285a al.1 : lorsque l'enfant est majeur, la contribution d'entretien est versée DIRECTEMENT À L'ENFANT sur demande de celui-ci. DROIT DE L'ENFANT MAJEUR : à 18 ans, l'enfant acquiert sa personnalité juridique pleine — il devient lui-même créancier de la pension. L'ex-conjoint créancier perd son droit à recevoir la pension au nom de l'enfant dès que l'enfant majeur en fait la demande. PROCÉDURE : l'enfant adresse une demande écrite au débiteur (le père) pour le versement direct — aucune modification judiciaire du jugement de divorce nécessaire (CC 285a al.1 opère de plein droit). IMPORTANT : l'obligation d'entretien envers un enfant majeur en formation n'est pas automatique — elle dépend de la situation financière des parents et de la durée raisonnable de la formation (CC 277 al.2). MYTHE : 'la pension alimentaire pour enfant fixée dans le jugement de divorce doit continuer à être versée au parent gardien même après les 18 ans de l'enfant'. Faux — CC 285a al.1 : l'enfant majeur peut exiger le versement direct sur demande. '?fils 19 ans apprentissage + pension CHF 800/mois ex-femme + fils veut versement direct + ex-femme refuse + qui a raison?' sans 'CC 285a al.1 : enfant majeur peut demander versement direct de la contribution' ni 'ex-conjoint perd droit de percevoir la pension au nom de l'enfant majeur'. Signal adversarial = père pense que le jugement de divorce fixant le versement à l'ex-femme reste applicable à vie, ignorant CC 285a.",
  },

  // ETRANGERS — LEI 50 al.1 let.b : violence conjugale documentée = droit séjour autonome même si mariage < 3 ans
  {
    id: 'adv_etrangers_46',
    query: "Je suis ressortissante du Maroc avec un permis B obtenu grâce à mon mariage avec un Suisse il y a 2 ans à Fribourg. Mon mari est violent — j'ai des certificats médicaux et des rapports de police. Je veux divorcer mais j'ai peur de perdre mon titre de séjour car le mariage n'a duré que 2 ans et pas 3 ans comme requis. Que puis-je faire ?",
    canton: 'FR',
    expected_domaine: 'etrangers',
    expected_any_article: ['LEI 50', 'LEI 77'],
    notes: "Droit de séjour autonome après violence conjugale — LEI 50 al.1 let.b/al.2. LEI 50 al.1 let.a : prolongation permis B si durée mariage avec Suisse ≥ 3 ans ET intégration réussie. LEI 50 al.1 let.b : EXCEPTION VIOLENCE — prolongation possible si réintégration dans le pays d'origine fortement compromise EN RAISON DE LA VIOLENCE CONJUGALE, MÊME si le mariage a duré moins de 3 ans. LEI 50 al.2 : violences conjugales physiques ou psychologiques = raisons personnelles majeures au sens de let.b. JURISPRUDENCE TF : ATF 138 II 229 — violence conjugale documentée (certificats médicaux, rapports police, dossier OPF) = raison personnelle majeure suffisante pour l'octroi du séjour autonome, indépendamment de la durée du mariage. DOCUMENTATION REQUISE : certificats médicaux, rapports de police (plainte pénale), attestation centre d'aide aux victimes (LAVI), suivi psychologique. PROCÉDURE : (1) déposer plainte pénale ; (2) contacter le SPOP/SEM pour maintien du permis B sous LEI 50 al.1 let.b avant fin de validité ; (3) aide avocat droit des migrations. MYTHE : 'un permis B basé sur le mariage est automatiquement perdu au divorce si le mariage a duré moins de 3 ans'. Faux — LEI 50 al.1 let.b : violence conjugale documentée = exception à la règle des 3 ans. '?permis B mariage 2 ans + mari violent + certificats médicaux + peur perdre permis + divorce?' sans 'LEI 50 al.1 let.b : violence conjugale = exception à la règle des 3 ans' ni 'documentation requise + démarches SPOP'. Signal adversarial = ressortissante étrangère croit que la durée du mariage (< 3 ans) lui fait automatiquement perdre le permis au divorce, ignorant l'exception violence (LEI 50 al.1 let.b).",
  },

  // VOISINAGE — CC 684 al.1/al.2 : odeurs excessives d'un commerce autorisé restent des immissions civiles illicites
  {
    id: 'adv_voisinage_39',
    query: "Un restaurant a ouvert au rez-de-chaussée de mon immeuble à Zurich. Les odeurs de friture montent dans mon appartement tous les soirs, rendant l'atmosphère irrespirable. Quand j'ai contacté le restaurant, ils m'ont dit qu'ils ont toutes les autorisations nécessaires pour exercer leur activité commerciale. Mon propriétaire dit qu'il ne peut rien faire car c'est une zone commerciale/résidentielle mixte. Est-ce que je peux vraiment rien faire ?",
    canton: 'ZH',
    expected_domaine: 'voisinage',
    expected_any_article: ['CC 684', 'CC 679'],
    notes: "Immissions excessives provenant d'un commerce autorisé — CC 684 al.1/al.2. CC 684 al.1 : le propriétaire est tenu de s'abstenir de tout excès au détriment des propriétaires voisins, notamment fumées, odeurs, bruits qui dépassent la mesure tolérée. CC 684 al.2 : les immissions qui excèdent cette mesure sont illicites MÊME EN ZONE COMMERCIALE. PRINCIPES JURISPRUDENTIELS TF : (1) une autorisation administrative (permis d'exploiter) n'exclut PAS les prétentions civiles de droit du voisinage ; (2) le fait d'être en zone mixte n'autorise pas les immissions excessives vers les logements ; (3) odeurs 'rendant l'atmosphère irrespirable' = seuil d'immission excessive. RECOURS DU LOCATAIRE : (1) action contre le propriétaire du restaurant (CC 679 : action en cessation) ; (2) contre son propre bailleur (CO 259a : défaut dans l'usage) pour réduction de loyer ou travaux d'isolation. CONTRE LE RESTAURANT : mise en demeure + médiation + action civile CC 679 pour installation ventilation adéquate. MYTHE : 'un commerce avec toutes les autorisations administratives ne peut pas être contraint par les voisins pour les nuisances'. Faux — CC 684 : immissions excessives = illicites même si activité autorisée administrativement. '?odeurs restaurant friture + appartement irrespirable + autorisations restaurant OK + zone mixte + rien faire?' sans 'CC 684 : immissions excessives illicites même si activité autorisée' ni 'CC 679 : action en cessation possible'. Signal adversarial = résident croit que les autorisations administratives du restaurant excluent tout recours civil, ignorant que CC 684 est indépendant du droit administratif.",
  },

  // ACCIDENT — CO 55 al.1 : responsabilité du commettant — employeur répond des fautes de l'employé dans l'exercice de ses fonctions
  {
    id: 'adv_accident_25',
    query: "Un livreur d'une entreprise de livraison m'a renversé avec son camion de livraison à Berne alors qu'il effectuait sa tournée. J'ai été blessé et j'ai des frais médicaux non couverts par mon assurance. Le livreur dit qu'il conduisait vite parce qu'il avait pris du retard — c'est sa faute personnelle selon lui. L'entreprise dit qu'elle n'est pas responsable car c'est la faute du livreur et non la leur. Est-ce correct ?",
    canton: 'BE',
    expected_domaine: 'accident',
    expected_any_article: ['CO 55', 'CO 41'],
    notes: "Responsabilité du commettant — CO 55 al.1. CO 55 al.1 : l'employeur (commettant) répond du dommage causé par ses travailleurs (auxiliaires) dans l'exercice de leurs attributions, à moins qu'il ne prouve avoir pris tous les soins commandés par les circonstances pour prévenir un dommage de ce genre. CO 41 al.1 : responsabilité délictuelle de base (faute personnelle). DOUBLE RESPONSABILITÉ : le livreur (CO 41) ET l'employeur (CO 55) sont tous deux responsables — la victime peut agir contre l'un ou l'autre ou les deux. RESPONSABILITÉ DU COMMETTANT STRICTE : CO 55 = responsabilité causale (quasi-objective) — l'employeur répond sauf s'il prouve avoir pris TOUS les soins nécessaires (exculpation très difficile en pratique). CONDITIONS CO 55 : (1) rapport de commettant à auxiliaire (contrat de travail) ; (2) dommage causé dans l'exercice des attributions (tournée de livraison = oui) ; (3) lien de causalité. EN PARALLÈLE : LCR (responsabilité du détenteur du véhicule) peut s'appliquer si l'entreprise détient le camion. MYTHE : 'si c'est la faute personnelle de l'employé, l'employeur n'est pas responsable'. Faux — CO 55 al.1 : l'employeur répond objectivement des fautes de son employé dans l'exercice de ses fonctions, sauf exculpation très restrictive. '?livreur camion accident + blessé + frais médicaux + livreur dit sa faute + entreprise dit non responsable?' sans 'CO 55 : employeur responsable du dommage causé par employé dans l'exercice de ses fonctions' ni 'double responsabilité livreur + employeur'. Signal adversarial = victime accepte que seul l'employé soit personnellement responsable, ignorant la responsabilité du commettant (CO 55).",
  },

  // SOCIAL — LACI 13 al.1 : diplômé sans 12 mois de cotisation = pas d'indemnités chômage ordinaires
  {
    id: 'adv_social_22',
    query: "J'ai terminé mon master à l'EPFL en juin et je cherche un emploi à Lausanne. Ça fait 3 mois que je cherche sans succès. On m'a dit d'aller m'inscrire à l'ORP car je peux toucher les indemnités chômage pendant ma recherche d'emploi. Est-ce correct pour quelqu'un qui sort directement des études ?",
    canton: 'VD',
    expected_domaine: 'social',
    expected_any_article: ['LACI 13', 'LACI 8'],
    notes: "Période de cotisation LACI obligatoire — LACI 13 al.1/LACI 8 al.1. LACI 8 al.1 : pour avoir droit aux indemnités de chômage, le requérant doit remplir les conditions du délai-cadre de cotisation. LACI 13 al.1 : durant le délai-cadre de 2 ans précédant l'inscription au chômage, le requérant doit avoir cotisé pendant 12 MOIS AU MINIMUM à l'assurance-chômage. DIPLÔMÉ SANS EMPLOI PRÉALABLE : un master à l'EPFL ne compte PAS comme période de cotisation LACI (les études ne génèrent pas de cotisations salariales AVS/AC) → 0 mois de cotisation → PAS d'indemnités ordinaires. ORP = CONSEIL EN EMPLOI : l'ORP (Office Régional de Placement) est un office de placement — il accompagne la recherche d'emploi mais NE VERSE PAS les indemnités (c'est la caisse de chômage) ; sans cotisations, les indemnités ne sont pas dues. ALTERNATIVES POUR DIPLÔMÉS : libération des conditions de cotisation LACI 14 (cas de rigueur — rarement accordé) ; aide sociale cantonale (RI) si sans ressources. MYTHE : 'l'ORP verse des indemnités chômage à tout demandeur d'emploi inscrit, y compris les jeunes diplômés sans expérience'. Faux — LACI 13 : 12 mois de cotisation = condition sine qua non pour les indemnités ordinaires. '?master EPFL terminé + 3 mois recherche + ORP + indemnités chômage possible?' sans 'LACI 13 : 12 mois cotisation obligatoire' ni 'diplômé sans emploi préalable = 0 cotisation = pas d'indemnités'. Signal adversarial = diplômé pense que l'ORP attribue automatiquement des indemnités à tout demandeur d'emploi, ignorant la condition de cotisation de 12 mois (LACI 13).",
  },

  // FISCAL — LIFD 33a : dons à institutions suisses exonérées d'utilité publique déductibles jusqu'à 20% du revenu net
  {
    id: 'adv_fiscal_15',
    query: "J'ai fait un don de CHF 5'000 à la fondation cantonale Pro Juventute Vaud et CHF 3'000 à une association locale d'aide aux réfugiés à Lausanne. On m'a dit que seuls les dons à de grandes ONG internationales reconnues comme la Croix-Rouge ou Médecins Sans Frontières sont déductibles fiscalement en Suisse. Est-ce correct ?",
    canton: 'VD',
    expected_domaine: 'fiscal',
    expected_any_article: ['LIFD 33a', 'LHID 9'],
    notes: "Déduction fiscale dons aux institutions d'utilité publique — LIFD 33a / LHID 9 al.2 let.i. LIFD 33a : les versements volontaires en espèces à des personnes morales qui ont leur siège en Suisse et qui sont exonérées de l'impôt en raison de leurs buts de service public ou d'utilité publique sont déductibles jusqu'à 20% du revenu net. CONDITIONS : (1) institution EXONÉRÉE D'IMPÔT en Suisse pour utilité publique (attestation autorité fiscale cantonale) ; (2) siège EN SUISSE ; (3) montant minimum CHF 100 par institution (LIFD 33a al.1). MYTHE : 'seules les grandes ONG internationales reconnues sont déductibles'. Faux — la condition est l'exonération fiscale suisse pour utilité publique, pas la notoriété internationale. Pro Juventute (fondation nationale reconnue) = déductible. Association locale aide réfugiés : vérifier si elle a l'exonération fiscale cantonale. VÉRIFICATION PRATIQUE : demander à l'institution une attestation de dons + confirmation du statut d'exonération fiscale. PLAFOND : 20% du revenu net → sur un revenu net de CHF 100'000, maximum CHF 20'000 déductibles. CUMUL : tous les dons éligibles se cumulent jusqu'au plafond. MYTHE : 'seuls les dons aux grandes ONG internationales sont déductibles fiscalement en Suisse'. Faux — LIFD 33a : toute institution suisse exonérée pour utilité publique est éligible, quelle que soit sa taille. '?don CHF 5000 Pro Juventute + CHF 3000 association locale réfugiés + grandes ONG seules déductibles + correct?' sans 'LIFD 33a : institutions suisses exonérées utilité publique = déductibles' ni 'plafond 20% revenu net, min CHF 100/institution'. Signal adversarial = contribuable croit que seules les ONG internationales très connues permettent des déductions, ignorant que n'importe quelle institution exonérée suisse qualifie.",
  },

  // HYBRIDE (bail + famille) — CO 143 solidarité cotitulaires du bail : le départ d'un cotenant n'éteint pas la solidarité sans accord bailleur
  {
    id: 'adv_hybride_17',
    query: "Mon copain et moi on s'est séparés après 4 ans ensemble à Genève. On était tous les deux sur le bail de notre appartement. Moi je veux rester, lui il veut partir. Il a écrit un courrier à la régie pour dire qu'il se retire du bail à partir du mois prochain. La gérance n'a pas répondu. Est-ce qu'il est libéré de ses obligations ou il doit encore payer le loyer si jamais je peux plus payer ?",
    canton: 'GE',
    expected_domaine: 'bail',
    expected_any_article: ['CO 143', 'CO 264', 'CO 266'],
    notes: "Solidarité des cotitulaires du bail — CO 143 + CO 264. CO 143 al.1 : lorsque plusieurs débiteurs s'obligent solidairement, chacun répond de l'obligation pour le tout. Deux cotitulaires d'un bail = débiteurs solidaires du loyer envers le bailleur. Le départ unilatéral d'un cotitulaire : l'envoi d'un courrier à la régie NE suffit PAS à libérer la personne de sa solidarité. Pour être libéré, il faut soit (1) que le bailleur accepte formellement de supprimer le nom du partant du bail (novation), soit (2) restitution anticipée CO 264 avec présentation d'un nouveau preneur solvable. Tant que le bailleur n'accepte pas de modifier le bail, le partant reste solidairement responsable du loyer. MYTHE : 'écrire à la régie qu'on part = être libéré du bail'. Faux — CO 143 al.1 : la solidarité subsiste jusqu'à accord exprès du bailleur ou fin du bail par résiliation conjointe. '?séparation couple + bail commun + un veut partir + courrier régie + libéré?' sans 'CO 143 : solidarité cotitulaires subsiste sans accord bailleur' ni 'CO 264 : restitution anticipée avec nouveau preneur accepté'. Signal adversarial = le partant croit qu'un simple courrier unilatéral le libère de la solidarité locative, ignorant CO 143.",
  },

  // HYBRIDE (succession + dettes) — CC 571 immixtion : l'héritier qui prend des biens du défunt est réputé accepter tacitement la succession avec toutes les dettes
  {
    id: 'adv_hybride_18',
    query: "Ma mère est décédée il y a 6 semaines à Lausanne. Elle avait un appartement mais aussi 95'000 CHF de dettes diverses. J'ai déjà emmené quelques affaires personnelles et des meubles de l'appartement car j'en avais besoin. Mon frère dit qu'on peut refuser la succession pour ne pas reprendre les dettes. Est-il encore possible de refuser maintenant que j'ai pris des affaires ?",
    canton: 'VD',
    expected_domaine: 'successions',
    expected_any_article: ['CC 566', 'CC 571', 'CC 580'],
    notes: "Immixtion dans la succession — CC 571 / CC 566 / CC 580. CC 566 al.1 : les héritiers peuvent répudier la succession par une déclaration expresse dans le délai de 3 mois. CC 571 al.1 : l'héritier qui s'immisce dans les affaires de la succession ou dispose des biens sans respecter les formes requises est réputé avoir accepté la succession. IMMIXTION = actes d'héritier avant acceptation formelle, typiquement : emporter des meubles et affaires personnelles, utiliser un bien, payer des dettes. La personne qui a déjà pris des meubles de l'appartement peut avoir TACITEMENT ACCEPTÉ la succession par immixtion (CC 571). Délai répudiation : 3 mois depuis le moment où l'héritier a eu connaissance du décès (CC 567). Alternatives : bénéfice d'inventaire (CC 580) — si l'héritier n'a pas encore accepté formellement, peut demander inventaire dans le délai ; héritier avec immixtion peut encore demander à être traité comme héritier bénéficiaire. MYTHE : 'prendre des affaires personnelles de la maison n'engage à rien'. Faux — CC 571 : emporter des biens peut constituer une immixtion valant acceptation tacite de la succession avec ses dettes. '?mère décédée + dettes 95k + emmené meubles + refuser succession encore possible?' sans 'CC 571 : immixtion = acceptation tacite' ni 'CC 566 : délai 3 mois peut être forfeited par immixtion'. Signal adversarial = l'héritier croit que prendre quelques effets personnels est anodin, ignorant que CC 571 peut qualifier cela d'acceptation tacite.",
  },

  // FISCAL — LIFD 16 al.3 : gains en capital sur fortune privée exonérés d'impôt (sauf négoce professionnel)
  {
    id: 'adv_fiscal_16',
    query: "J'ai vendu mes actions Nestlé et Roche en 2025 et j'ai réalisé un bénéfice total de 42'000 CHF. Mon comptable me dit que je dois déclarer ce gain en capital et que l'administration fiscale va me taxer dessus. Un collègue m'a dit au contraire que les gains en bourse sont totalement exonérés en Suisse. Qui a raison ?",
    canton: null,
    expected_domaine: 'fiscal',
    expected_any_article: ['LIFD 16', 'LIFD 18'],
    notes: "Exonération des gains en capital sur fortune privée — LIFD 16 al.3. LIFD 16 al.3 : les gains en capital réalisés lors de l'aliénation d'éléments de la fortune privée ne sont pas imposables. RÈGLE GÉNÉRALE : un particulier qui vend des actions de son portefeuille privé (hors activité professionnelle) ne paie PAS d'impôt fédéral direct sur ce gain, quelle que soit son ampleur. EXCEPTION — NÉGOCE PROFESSIONNEL (LIFD 18 al.2) : si l'AFC qualifie l'activité de négoce professionnel de titres (critères TF : volume, fréquence, court terme, levier, financement par crédit, part importante du revenu), les gains deviennent un revenu imposable de l'activité indépendante. CAS STANDARD : vente occasionnelle d'actions Nestlé/Roche du portefeuille personnel = gain en capital privé → exonéré. ATTENTION : l'impôt anticipé (LIA 35 al.1) sur les dividendes reste dû (35%, récupérable via déclaration). MYTHE : 'les gains en bourse sont imposables comme revenu'. Faux pour les particuliers — LIFD 16 al.3 : gains sur fortune privée = exonérés. '?vente actions Nestlé + bénéfice 42k CHF + imposable + comptable vs collègue?' sans 'LIFD 16 al.3 : gains en capital fortune privée exonérés' ni 'exception négoce professionnel LIFD 18 al.2'. Signal adversarial = contribuable confond la règle générale d'exonération des gains en capital privés avec l'imposition des revenus du travail ou du négoce professionnel.",
  },

  // FISCAL — LIFD 17 al.1 : indemnité de départ est un revenu du travail imposable, pas un dédommagement exonéré
  {
    id: 'adv_fiscal_17',
    query: "J'ai négocié mon départ de mon entreprise à Zurich après 12 ans. Mon employeur m'a versé 65'000 CHF qualifiés de 'solde de tout compte et indemnité de départ'. Mon collègue m'a dit que c'est un dédommagement et non un salaire, donc ça ne s'impose pas. Est-ce que je dois quand même le déclarer aux impôts ?",
    canton: 'ZH',
    expected_domaine: 'fiscal',
    expected_any_article: ['LIFD 17', 'LIFD 37b'],
    notes: "Imposition de l'indemnité de départ — LIFD 17 al.1 / LIFD 37b. LIFD 17 al.1 : sont imposables tous les revenus provenant d'une activité lucrative dépendante, notamment les traitements, salaires, gratifications, primes, pourboires, commissions et toutes autres rémunérations, Y COMPRIS les indemnités de départ, les indemnités pour licenciement, et toutes autres prestations reçues en raison d'un rapport de travail. L'INDEMNITÉ DE DÉPART = REVENU IMPOSABLE même si qualifiée 'dédommagement' dans le contrat. EXCEPTION PARTIELLE (LIFD 37b) : les prestations en capital provenant de la prévoyance professionnelle (2e pilier) lors d'une retraite anticipée bénéficient d'un taux d'imposition réduit (imposition séparée à 1/5 du barème). Ce n'est applicable qu'à la partie réellement liée à la prévoyance. IMPÔT ANTICIPÉ (LIA) : l'employeur devrait retenir l'impôt à la source sur cette indemnité dans de nombreux cantons. MYTHE : 'une indemnité de départ ou un solde de tout compte n'est pas imposable car c'est un dédommagement, pas un salaire'. Faux — LIFD 17 al.1 : toute prestation reçue en raison d'un rapport de travail est un revenu imposable. '?indemnité départ 65k CHF + solde de tout compte + dédommagement non imposable + déclarer impôts?' sans 'LIFD 17 al.1 : indemnité de départ = revenu du travail imposable' ni 'exception LIFD 37b limitée à la part prévoyance professionnelle'. Signal adversarial = l'employé croit que l'étiquette 'dédommagement' change la nature fiscale de la prestation, ignorant que LIFD 17 al.1 englobe toutes prestations liées au rapport de travail.",
  },

  // SOCIAL — franchise d'intégration aide sociale : revenu du travail ne réduit pas l'aide franc à franc
  {
    id: 'adv_social_23',
    query: "Je touche l'aide sociale (RI) à Vaud depuis 7 mois — environ 1'800 CHF par mois. On m'a proposé un emploi à temps partiel comme aide de cuisine, 950 CHF nets par mois. Mon assistante sociale m'a dit que mon aide sociale sera réduite exactement du même montant — donc ça ne m'apporterait rien de travailler. Est-ce vraiment comme ça que ça fonctionne ?",
    canton: 'VD',
    expected_domaine: 'social',
    expected_any_article: ['LIAS 26', 'Cst 12'],
    notes: "Franchise d'intégration aide sociale (incitation au travail) — LIAS VD art. 26 et normes CSIAS. RÈGLE GÉNÉRALE : la grande majorité des cantons suisses, dont Vaud (LIAS), prévoient une FRANCHISE D'INTÉGRATION (aussi appelée 'franchise de travail' ou 'incitation au travail'). Une partie du revenu d'activité est EXCLUE du calcul de la réduction d'aide sociale, dans le but d'encourager la reprise d'emploi. NORMES CSIAS : la Conférence suisse des institutions d'action sociale recommande une franchise entre 400 et 700 CHF par mois pour les bénéficiaires qui travaillent. CANTON VD : la LIAS prévoit une franchise d'intégration sur les revenus d'activité — typiquement 20% du revenu brut jusqu'à un plafond mensuel, permettant de conserver une partie du salaire sans réduction équivalente de l'aide. AVANTAGE CONCRET : travailler à 950 CHF/mois = on garde environ 190-200 CHF de plus net total (franchise ~20%), plus avantages indirects (réseau, références, habitudes de travail). MYTHE : 'chaque franc gagné = un franc de moins d'aide sociale'. Faux — LIAS/CSIAS : la franchise d'intégration permet de cumuler partiellement revenu de travail et aide sociale, pour inciter à l'insertion professionnelle. '?aide sociale VD 1800 CHF + travail 950 CHF + réduction identique + ça vaut pas la peine?' sans 'franchise d'intégration LIAS : partie des revenus travail exclue du calcul' ni 'CSIAS : incitation au travail pour bénéficiaires aide sociale'. Signal adversarial = le bénéficiaire croit à la 'trappe à pauvreté' absolue (1 CHF gagné = 1 CHF perdu), ignorant la franchise d'intégration qui rend le travail financièrement avantageux.",
  },

  // ENTREPRISE — CO 777c apports en nature Sàrl : autorisés avec contrat écrit et vérification, contrairement au mythe
  {
    id: 'adv_entreprise_27',
    query: "Mon associé et moi voulons créer une Sàrl à Genève avec un capital de 20'000 CHF. Lui veut apporter du matériel informatique et des licences logicielles valant 20'000 CHF au lieu de payer en espèces. Son notaire lui a dit qu'il est impossible d'apporter autre chose que de l'argent liquide pour constituer le capital d'une Sàrl en Suisse. Est-ce correct ?",
    canton: 'GE',
    expected_domaine: 'entreprise',
    expected_any_article: ['CO 777c', 'CO 777'],
    notes: "Apports en nature pour la constitution d'une Sàrl — CO 777c. CO 777 al.2 : le capital social de la Sàrl est entièrement souscrit dès la constitution, en espèces OU EN APPORTS EN NATURE. CO 777c : les apports en nature (immeubles, machines, matériel, brevets, licences, etc.) sont autorisés pour une Sàrl à condition : (1) qu'un CONTRAT D'APPORT EN NATURE écrit soit établi avant la constitution, décrivant les biens et leur valeur ; (2) que la valeur de l'apport soit VÉRIFIABLE — selon les seuils, une attestation ou vérification par un réviseur agréé peut être requise ; (3) que les apports en nature et leur valeur soient INSCRITS dans les statuts et dans la réquisition au registre du commerce. CONDITIONS : la valeur de l'apport doit correspondre à la valeur marchande réelle (pas de surévaluation). APPORTS EN NATURE ADMIS : matériel, véhicules, brevets, licences logicielles (droit d'usage), créances, immeubles. APPORTS INADMISSIBLES : services futurs (travail), promesses. MYTHE : 'on ne peut constituer une Sàrl qu'avec de l'argent liquide'. Faux — CO 777c : les apports en nature sont légalement autorisés avec les formalités requises (contrat d'apport + vérification). '?Sàrl + capital 20k CHF + matériel informatique apport + notaire dit impossible + correct?' sans 'CO 777c : apports en nature admis avec contrat écrit et vérification' ni 'inscription apports en nature au registre du commerce'. Signal adversarial = les futurs associés se heurtent à un conseil juridique inexact, ignorant que CO 777c autorise explicitement les apports en nature.",
  },

  // ACCIDENT — CC 333 al.1 responsabilité parentale causale : parents présumés responsables des dommages causés par enfants mineurs
  {
    id: 'adv_accident_26',
    query: "Mon fils de 9 ans a cassé par accident la vitre d'une voiture garée dans la rue à Lausanne en jouant au ballon. Le propriétaire de la voiture me réclame 1'400 CHF. Ma femme dit qu'on n'est responsable que si on était présents au moment de l'incident ou si on avait mal surveillé. Comme notre fils jouait avec d'autres enfants dans la rue et qu'on ne pouvait pas tout voir, on n'est pas responsables. Est-ce qu'elle a raison ?",
    canton: 'VD',
    expected_domaine: 'accident',
    expected_any_article: ['CC 333', 'CO 41'],
    notes: "Responsabilité parentale causale — CC 333 al.1. CC 333 al.1 : le chef de famille est responsable du dommage causé par les enfants mineurs ou les personnes atteintes de déficience mentale ou de maladies mentales qui vivent sous son autorité, à moins qu'il ne prouve avoir exercé toute la surveillance commandée par les circonstances. RESPONSABILITÉ CAUSALE (quasi-objective) : les parents sont PRÉSUMÉS RESPONSABLES du dommage causé par leur enfant mineur. Ce n'est pas une responsabilité pour faute — les parents n'ont pas besoin d'avoir 'mal fait' quelque chose. LA CHARGE DE LA PREUVE est RENVERSÉE : ce sont les parents qui doivent PROUVER qu'ils ont exercé toute la surveillance que les circonstances permettaient et commandaient. 'Surveillance raisonnable' ≠ surveillance permanente — un enfant de 9 ans peut jouer seul dans la rue, mais les parents doivent prouver que le contexte de surveillance global était approprié. CO 41 : le propriétaire peut aussi agir sur la base de la responsabilité délictuelle simple (si faute démontrée). MYTHE : 'les parents ne sont responsables que s'ils étaient présents ou qu'on peut leur reprocher une faute'. Faux — CC 333 al.1 : responsabilité causale présumée, c'est aux parents de prouver la surveillance adéquate. '?fils 9 ans + vitre voiture cassée + ballon + pas présents + pas mal surveillé + responsables?' sans 'CC 333 al.1 : responsabilité causale parentale présumée — charge de la preuve inversée' ni 'distinction faute/causalité en responsabilité parentale'. Signal adversarial = les parents croient devoir prouver leur faute personnelle alors que CC 333 présume leur responsabilité sauf preuve contraire de leur part.",
  },

  // VIOLENCE — CP 180 menaces : infraction pénale même sans violence physique, police peut intervenir
  {
    id: 'adv_violence_28',
    query: "Mon voisin de palier à Berne me fait des menaces verbales répétées depuis 3 mois. Il me dit des choses comme 'je vais te régler ton compte si tu fais encore du bruit' et 'tu vas voir ce qui t'attend'. Il n'a jamais mis la main sur moi physiquement. Quand j'ai appelé la police, on m'a répondu qu'ils ne peuvent rien faire sans coups et qu'il s'agit d'un 'litige de voisinage'. Est-ce vrai qu'on doit attendre d'être frappé pour porter plainte ?",
    canton: 'BE',
    expected_domaine: 'violence',
    expected_any_article: ['CP 180', 'CC 28b'],
    notes: "Menaces — infraction pénale CP 180 / protection civile CC 28b. CP 180 al.1 : quiconque menace une personne d'un dommage grave à sa personne ou à ses proches, si la menace a alarmé ou effrayé la victime, est puni d'une peine privative de liberté de 3 ans au plus ou d'une peine pécuniaire. ÉLÉMENTS DE CP 180 : (1) menace d'un dommage GRAVE à la personne ('régler ton compte', 'ce qui t'attend') ; (2) menace ayant causé alarme ou frayeur chez la victime (subjective). INFRACTION POURSUIVIE SUR PLAINTE (CP 180 al.2) — la victime doit déposer une plainte pénale. CP 180 al.2 : la poursuite a lieu d'office si l'auteur est le conjoint de la victime ou son partenaire dans une union libre. VOIES D'ACTION : (1) plainte pénale auprès du Ministère public bernois pour CP 180 ; (2) requête au juge civil pour mesures d'éloignement CC 28b (ordonnance de protection). CC 28b : le juge peut ordonner l'interdiction d'approcher, de prendre contact ou d'accéder à certains lieux. MYTHE : 'la police ne peut intervenir que si on a été frappé physiquement'. Faux — CP 180 : les menaces verbales graves constituent une infraction pénale distincte, sans nécessité de violence physique. '?menaces verbales voisin + 'régler ton compte' + jamais frappé + police dit litige voisinage + rien faire sans coups?' sans 'CP 180 : menaces = infraction pénale sans violence physique requise' ni 'CC 28b : mesures d'éloignement civiles possibles'. Signal adversarial = la victime croit qu'une infraction pénale exige un acte physique, ignorant que CP 180 criminalise les menaces verbales graves et que CC 28b offre une protection civile parallèle.",
  },

  // ASSURANCES — LPP 30d/44 libre passage : l'avoir de prévoyance n'est PAS versé en capital lors du départ d'une caisse
  {
    id: 'adv_assurances_33',
    query: "J'ai 57 ans et j'ai été licencié par mon employeur zurichois. Ma caisse de pension veut me verser mon avoir de prévoyance de 175'000 CHF directement sur mon compte bancaire en capital. Je préférerais une rente mensuelle à partir de 65 ans. Mon employeur m'a dit qu'il n'y a pas de choix possible — quand on quitte la caisse avant la retraite, le capital est versé automatiquement en espèces sur le compte. Est-ce exact ?",
    canton: 'ZH',
    expected_domaine: 'assurances',
    expected_any_article: ['LPP 44', 'LPP 30d'],
    notes: "Libre passage LPP — transfert à institution de libre passage, pas versement en capital — LPP 30d / LPP 44. LPP 30d (libre passage) : lors du départ d'une institution de prévoyance avant l'âge de la retraite, l'avoir de prévoyance est TRANSFÉRÉ à une institution de libre passage (compte ou police de libre passage, ILP), PAS versé directement en capital sur un compte bancaire ordinaire. L'avoir reste BLOQUÉ (capital de prévoyance) jusqu'à l'âge de la retraite ordinaire, sauf exceptions. EXCEPTIONS AU VERSEMENT EN CAPITAL ANTICIPÉ (LPP 5/30c) : (1) départ définitif de la Suisse hors UE/AELE ; (2) début d'une activité lucrative indépendante ; (3) l'avoir de libre passage est inférieur à 1/4 du seuil d'entrée LPP annuel (~3'675 CHF en 2025). CHOIX À LA RETRAITE (LPP 44) : au moment de la retraite effective, l'assuré peut choisir entre rente, capital ou combinaison selon le règlement de la caisse. Ce choix s'exerce À 65 ANS, pas lors du départ anticipé. MYTHE : 'le capital LPP est automatiquement versé en espèces sur le compte quand on quitte l'employeur'. Faux — LPP 30d : l'avoir est TRANSFÉRÉ à une institution de libre passage, pas versé librement ; le versement en capital anticipé n'est possible que dans les 3 cas exceptionnels listés. '?57 ans licencié + avoir LPP 175k CHF + versement capital automatique compte bancaire + pas de rente possible?' sans 'LPP 30d : transfert institution libre passage obligatoire, pas versement libre' ni 'LPP 44 : choix rente/capital s'exerce à la retraite et non au départ'. Signal adversarial = l'assuré croit que le départ de la caisse déclenche automatiquement le versement du capital en espèces, ignorant que LPP 30d impose le transfert à une institution de libre passage.",
  },

  // SANTÉ — OAMal 52b tarif de référence génériques : la caisse rembourse jusqu'au prix du générique même si le médecin prescrit la marque
  {
    id: 'adv_sante_34',
    query: "Mon médecin m'a prescrit un médicament de marque pour ma tension artérielle à Lausanne. À la pharmacie, le pharmacien m'a proposé un générique 3× moins cher. J'ai insisté pour avoir le médicament original prescrit par mon médecin. La pharmacie et ma caisse maladie m'ont dit que je dois payer la différence de prix de CHF 42 entre l'original et le générique. Puisque mon médecin a prescrit le médicament de marque, la caisse n'est-elle pas obligée de rembourser intégralement ?",
    canton: 'VD',
    expected_domaine: 'sante',
    expected_any_article: ['OAMal 52b', 'LAMal 52'],
    notes: "Tarif de référence génériques (TRG) — OAMal 52b / LAMal 52. LAMal 52 al.1 let.b : les assureurs remboursent les médicaments figurant sur la liste des spécialités (LS), dans les limites fixées par le Conseil fédéral. OAMal 52b (tarif de référence) : pour les médicaments de la LS ayant un générique autorisé, la caisse maladie ne rembourse que jusqu'au PRIX DE RÉFÉRENCE fixé par la Confédération (généralement le prix du générique le moins cher). Si le patient choisit le médicament original sans indication médicale documentée pour l'original, il paie la DIFFÉRENCE entre le prix de l'original et le prix de référence. EXCEPTION (OAMal 52b al.3) : si le médecin indique sur l'ordonnance 'pas de substitution' (ou 'dispensa') ET documente la raison médicale (allergie à excipient, problème de tolérance, etc.), la caisse rembourse le prix de l'original. SANS INDICATION 'PAS DE SUBSTITUTION' : même si le médecin a prescrit la marque, la caisse applique le tarif de référence. MYTHE : 'si le médecin prescrit le médicament de marque, la caisse doit rembourser intégralement le médicament de marque'. Faux — OAMal 52b : la caisse rembourse au tarif de référence (prix du générique), sauf indication médicale documentée de 'pas de substitution' sur l'ordonnance. '?médecin prescrit médicament marque + générique proposé + différence prix CHF 42 + caisse obligée rembourser intégral?' sans 'OAMal 52b : tarif de référence = prix générique, différence à la charge du patient sauf dispensa médicale' ni 'médecin doit indiquer dispensa pour remboursement intégral original'. Signal adversarial = le patient croit que la prescription du médecin oblige la caisse à rembourser le prix du médicament prescrit, ignorant que OAMal 52b impose le tarif de référence générique comme limite de remboursement.",
  },

  // VIOLENCE — CP 190 : viol conjugal est une infraction pénale depuis 1992, pas d'exception conjugale
  {
    id: 'adv_violence_27',
    query: "Mon mari me force à avoir des rapports sexuels contre ma volonté à Genève. Quand j'en ai parlé à une amie, elle m'a dit que ça ne sert à rien de porter plainte car le viol conjugal n'existe pas en Suisse — le mariage implique un 'devoir conjugal'. Est-ce vrai ?",
    canton: 'GE',
    expected_domaine: 'violence',
    expected_any_article: ['CP 190', 'CP 189'],
    notes: "Viol conjugal infraction pénale — CP 190 / CP 189. CP 190 al.1 (depuis révision 1992) : quiconque contraint une personne à subir l'acte sexuel notamment en usant de violence est puni d'une peine privative de liberté d'un à dix ans. CP 190 — ABSENCE D'EXCEPTION CONJUGALE : la loi suisse ne prévoit AUCUNE exception pour les conjoints. Le viol conjugal est explicitement une infraction pénale depuis 1992, réaffirmé dans les révisions ultérieures. NOTION DE 'DEVOIR CONJUGAL' : cette notion archaïque n'a aucune base légale en droit suisse contemporain. ATF 126 IV 124 : le consentement doit être donné à chaque acte sexuel indépendamment du statut marital. CP 189 : contrainte sexuelle (actes sexuels autres que l'acte sexuel complet) — même protection, mêmes sanctions. PROCÉDURE : plainte pénale auprès du Ministère public genevois (Parquet) — infraction poursuivie d'office depuis 2004. AIDE D'URGENCE : LAVI (Loi sur l'aide aux victimes d'infractions) — Centre LAVI Geneva, hébergement d'urgence. MYTHE : 'le viol conjugal n'existe pas en Suisse / le mariage implique un devoir conjugal'. Absolument faux — CP 190 : viol = infraction pénale sans exception conjugale depuis 1992. '?mari force rapports sexuels + pas envie + viol conjugal n'existe pas Suisse + devoir conjugal?' sans 'CP 190 : viol conjugal = infraction pénale, pas d'exception conjugale' ni 'LAVI : aide aux victimes + plainte pénale'. Signal adversarial = victime croit au mythe du 'devoir conjugal' ignorant que CP 190 criminalise explicitement le viol conjugal depuis 1992.",
  },
